...
def test_current_head_0efa339_extractor_implementation_is_pinned() -> None:
    text = IMPLEMENTATION_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")

    for needle in [
        "status=fallback_risk_ranking_default_off_extractor_implementation_current_head_0efa339_revalidated",
        "implementation_gate_complete=True",
        "implementation_change_required=False",
        "existing_extractor_revalidated=True",
        "script=scripts/integrations/extract_diffusion_planner_dp_native_fallback_risk_records.py",
        ...
        "contract_tests=camp_core/tests/test_dp_native_fallback_risk_ranking_default_off_contract.py",
        "authorization_test=camp_core/tests/test_dp_native_fallback_risk_ranking_extractor_implementation_authorization.py",
        "camp_head_at_revalidation=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "camp_origin_main_at_revalidation=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "github_refs_heads_main_at_revalidation=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "autodl_CAMP_HEAD_at_revalidation=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "autodl_CAMP_origin_main_at_revalidation=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_authorization_status=fallback_risk_ranking_default_off_extractor_implementation_authorized_current_head_47860dc",
        "prior_authorization_head_at_revalidation=47860dca0835af5588eec95e5eb16cde13938cf1",
        "prior_authorization_tail_verified=True",
        "prior_authorization_autodl_verified=True",
        "default_off_required=True",
        "enabled_default=False",
    ...
    for needle in [
        "status=fallback_risk_ranking_default_off_extractor_implementation_current_head_0efa339_revalidated",
        "current_camp_head=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "github_refs_heads_main=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "autodl_CAMP_HEAD=0efa3397d0b99deb4b35fdf0b8f25494bd98fd82",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_authorization_status=fallback_risk_ranking_default_off_extractor_implementation_authorized_current_head_47860dc",
        "prior_authorization_head_at_revalidation=47860dca0835af5588eec95e5eb16cde13938cf1",
        "implementation_gate_complete=True",
...
def test_current_head_2d31bbe_extractor_implementation_is_pinned() -> None:
    ...
    for needle in [
        ...
        "contract_tests=camp_core/tests/test_dp_native_fallback_risk_ranking_default_off_contract.py",
        "authorization_test=camp_core/tests/test_dp_native_fallback_risk_ranking_extractor_implementation_authorization.py",
        "camp_head_at_revalidation=2d31bbedbda115547611a33cd04aacf21155d071",
        "camp_origin_main_at_revalidation=2d31bbedbda115547611a33cd04aacf21155d071",
        "github_refs_heads_main_at_revalidation=2d31bbedbda115547611a33cd04aacf21155d071",
        "autodl_CAMP_HEAD_at_revalidation=2d31bbedbda115547611a33cd04aacf21155d071",
        "autodl_CAMP_origin_main_at_revalidation=2d31bbedbda115547611a33cd04aacf21155d071",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_authorization_status=fallback_risk_ranking_default_off_extractor_implementation_authorized_current_head_d26eb75",
        "prior_authorization_head_at_revalidation=d26eb75b1a8ff52219d0f5bb95d11e9c1ffcdc67",
        "prior_authorization_tail_verified=True",
        "prior_authorization_autodl_verified=True",
        "default_off_required=True",
        "enabled_default=False",
        ...
        "local_related_target_pytest=88 passed",
        "autodl_py_compile_exit=0",
        "autodl_related_target_pytest=88 passed",
        "fallback_risk_training_authorized_now=False",
        "fallback_risk_smoke_authorized_now=False",
        "replay_execution_authorized=False",
        "candidate_generation_authorized=False",
    ...
    for needle in [
        "status=fallback_risk_ranking_default_off_extractor_implementation_current_head_2d31bbe_revalidated",
        "current_camp_head=2d31bbedbda115547611a33cd04aacf21155d071",
        "github_refs_heads_main=2d31bbedbda115547611a33cd04aacf21155d071",
        "autodl_CAMP_HEAD=2d31bbedbda115547611a33cd04aacf21155d071",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_authorization_status=fallback_risk_ranking_default_off_extractor_implementation_authorized_current_head_d26eb75",
        "prior_authorization_head_at_revalidation=d26eb75b1a8ff52219d0f5bb95d11e9c1ffcdc67",
        "implementation_gate_complete=True",
