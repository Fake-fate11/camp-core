...
def test_current_head_a067ccd_plan_revalidation_is_pinned() -> None:
    text = _plan()
    audit_tail = ITERATION_AUDIT.read_text(encoding="utf-8")[-24000:]
    combined = text + audit_tail
    status = "status=fallback_risk_training_data_training_sufficiency_plan_current_head_a067ccd_revalidated"
