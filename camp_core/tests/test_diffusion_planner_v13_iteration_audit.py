...
def test_v13_current_source_default_off_shadow_selector_runtime_shadow_replay_preflight() -> None:
    ...
    assert (
        latest_status
        == "current_source_retraining_promotion_evidence_package_preflight_complete"
    )
...
def test_v13_current_source_retraining_execution_is_audited_without_promotion() -> None:
    ...
    latest_status = text.rsplit("current_v13_status=", maxsplit=1)[1].splitlines()[0]
    assert latest_status == "current_source_retraining_promotion_evidence_package_preflight_complete"
