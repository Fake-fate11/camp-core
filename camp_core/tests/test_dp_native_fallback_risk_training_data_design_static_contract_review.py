...
def test_static_review_records_current_head_revalidation() -> None:
    text = _review()
    tail = text.split(
        "## Current-Head Revalidation After eeac566 Training-Data Design Plan"
    )[-1]

    current_head = "eeac566d64e06eb0ff729e8eb2e84ed7f79d0004"
    for needle in [
        ...
        "prior_design_commit_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
...
def test_iteration_audit_records_design_static_contract_review() -> None:
    ...
    for needle in [
        ...
        "review_doc=docs/dp_native_training_sufficiency_development_base_plus_addon_static_dp_reward_fixed_artifact_fallback_risk_training_data_design_static_contract_review.md",
        "review_test=camp_core/tests/test_dp_native_fallback_risk_training_data_design_static_contract_review.py",
        "camp_head_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "camp_origin_main_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "github_refs_heads_main_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "autodl_CAMP_HEAD_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "autodl_CAMP_origin_main_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_design_status=fallback_risk_training_data_design_plan_current_head_revalidated_latest",
        "prior_design_commit_at_revalidation=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "prior_design_tail_verified=True",
        ...
        "local_target_pytest=85 passed",
        "local_diff_check=0 findings",
        "autodl_CAMP_HEAD=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "autodl_CAMP_origin_main=eeac566d64e06eb0ff729e8eb2e84ed7f79d0004",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "autodl_py_compile_exit=0",
        "autodl_target_pytest=85 passed",
        "autodl_diff_check=0 findings",
