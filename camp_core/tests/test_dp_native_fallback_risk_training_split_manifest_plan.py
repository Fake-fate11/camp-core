...
def test_audit_tail_records_split_manifest_static_review_next_gate() -> None:
    ...
    assert "status=fallback_risk_training_split_manifest_static_contract_review_autodl_verification_passed" in tail
    assert "local_split_manifest_static_review_pytest=7 passed" in tail
