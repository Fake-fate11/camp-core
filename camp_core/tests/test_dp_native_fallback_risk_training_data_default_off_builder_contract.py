...
def test_current_head_70e5103_builder_unit_tests_are_pinned() -> None:
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    marker = (
        "\n## Current EOF Confirmation After 70e5103 Fallback Risk Training-Data "
        "Default-Off Builder Unit Tests\n\nDate: 2026-06-26\n\n"
    )
    assert marker in audit
    section = audit.rsplit(marker, maxsplit=1)[-1].split("\n## ", maxsplit=1)[0]
    current_head = "70e5103fc2af08e520b8783211f002a9cee0be16"

    for needle in [
        "status=fallback_risk_training_data_default_off_builder_unit_tests_current_head_70e5103_revalidated",
        f"camp_head_at_revalidation={current_head}",
        f"camp_origin_main_at_revalidation={current_head}",
        f"github_refs_heads_main_at_revalidation={current_head}",
        f"autodl_CAMP_HEAD_at_revalidation={current_head}",
        f"autodl_CAMP_origin_main_at_revalidation={current_head}",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_builder_unit_tests_plan_status=fallback_risk_training_data_default_off_builder_unit_tests_plan_current_head_36ed4d3_revalidated",
        "prior_builder_unit_tests_plan_commit_at_revalidation=36ed4d36abade08bf8c424ac13e36cb6daa5b5f5",
        "prior_builder_unit_tests_plan_tail_verified=True",
        "prior_builder_unit_tests_plan_autodl_verified=True",
        "user_camp_retraining_permission_available_for_future_training_gate=True",
        "contract_test_file=camp_core/tests/test_dp_native_fallback_risk_training_data_default_off_builder_contract.py",
        ...
        "negative_atom_rejection_pinned=True",
        "training_and_promotion_forbidden_pinned=True",
        "split_scale_master_isolation_pinned=True",
        "formal_seed_exclusion_pinned=True",
        "production_builder_edited_in_this_gate=False",
        "production_builder_executed_in_this_gate=False",
        "dataset_builder_implementation_authorized_now=False",
        "fallback_risk_training_authorized_now=False",
...
def test_current_head_a965c84_builder_unit_tests_are_pinned() -> None:
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    marker = (
        "\n## Current EOF Confirmation After a965c84 Fallback Risk Training-Data "
        "Default-Off Builder Unit Tests\n\nDate: 2026-06-27\n\n"
    )
    assert marker in audit
    section = audit.rsplit(marker, maxsplit=1)[-1].split("\n## ", maxsplit=1)[0]
    current_head = "a965c8449835b9ed0e08171e9d2441569361b769"
    prior_plan_head = "aae3df10f0d7294381669409929524ff2e89ccbc"

    for needle in [
        "status=fallback_risk_training_data_default_off_builder_unit_tests_current_head_a965c84_revalidated",
        f"camp_head_at_revalidation={current_head}",
        f"camp_origin_main_at_revalidation={current_head}",
        f"github_refs_heads_main_at_revalidation={current_head}",
        f"autodl_CAMP_HEAD_at_revalidation={current_head}",
        f"autodl_CAMP_origin_main_at_revalidation={current_head}",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_builder_unit_tests_plan_status=fallback_risk_training_data_default_off_builder_unit_tests_plan_current_head_aae3df1_revalidated",
        f"prior_builder_unit_tests_plan_commit_at_revalidation={prior_plan_head}",
        "prior_builder_unit_tests_plan_tail_verified=True",
        "prior_builder_unit_tests_plan_autodl_verified=True",
        "user_camp_retraining_permission_available_for_future_training_gate=True",
        "contract_test_file=camp_core/tests/test_dp_native_fallback_risk_training_data_default_off_builder_contract.py",
        ...
        "local_related_target_pytest=124 passed",
        "local_diff_check=0 findings",
        f"autodl_CAMP_HEAD={current_head}",
        f"autodl_CAMP_origin_main={current_head}",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        ...
        "autodl_related_target_pytest=124 passed",
        "autodl_diff_check=0 findings",
        "synthetic_records_only=True",
        "default_off_disabled_status_pinned=True",
        "all_infeasible_scope_pinned=True",
