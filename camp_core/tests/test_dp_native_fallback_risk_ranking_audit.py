...
def test_current_head_b84d64e_ranking_audit_is_pinned() -> None:
    text = AUDIT_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    ...
    for needle in [
        "status=dp_native_fixed_artifact_fallback_risk_ranking_audit_current_head_b84d64e_complete",
        "remote_audit_json_sha256=6761a3a2bc2e39e5697af9492b67bb3f280068754a1f7ddfd108adde92c1aae5",
        "records_without_feasible_candidate=15",
        "lower_risk_fixed_candidate_exists_under_logged_costs=True",
        "candidate_generation_authorized=False",
...
def test_current_head_ad52f74_ranking_audit_is_pinned() -> None:
    text = AUDIT_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    ...
    for needle in [
        "status=dp_native_fixed_artifact_fallback_risk_ranking_audit_current_head_ad52f74_complete",
        "remote_audit_json_sha256=149c70556a3b6e55ac05c99fd26d1b3aa33ab7e57acbebd9e0d8aa56da55756a",
        "records_without_feasible_candidate=15",
        "lower_risk_fixed_candidate_exists_under_logged_costs=True",
        "candidate_generation_authorized=False",
...
def test_current_head_da28e28_ranking_audit_is_pinned() -> None:
    text = AUDIT_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    ...
    for needle in [
        "status=dp_native_fixed_artifact_fallback_risk_ranking_audit_current_head_da28e28_complete",
        "remote_audit_json_sha256=6a3bcb84a508b740d9bd777b45ee13c21b3418e29de06a5741256149aec82c42",
        "records_without_feasible_candidate=15",
        "lower_risk_fixed_candidate_exists_under_logged_costs=True",
        "candidate_generation_authorized=False",
