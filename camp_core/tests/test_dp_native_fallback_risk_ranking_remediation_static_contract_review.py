...
def test_current_head_e96fcc7_static_contract_review_is_pinned() -> None:
    text = REVIEW_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
...
def test_current_head_08b1a6f_static_contract_review_is_pinned() -> None:
    text = REVIEW_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    ...
    for needle in [
        "status=fallback_risk_ranking_remediation_static_contract_review_current_head_08b1a6f_passed_default_off_tests_plan_next",
        "current_camp_head=08b1a6f365f8c3f6915b1a0f8c1565cae215a5ab",
        "github_refs_heads_main=08b1a6f365f8c3f6915b1a0f8c1565cae215a5ab",
        "autodl_CAMP_HEAD=08b1a6f365f8c3f6915b1a0f8c1565cae215a5ab",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_design_status=fallback_risk_ranking_remediation_design_plan_current_head_c0201ee_ready_static_contract_review",
        "prior_design_head_at_revalidation=c0201ee26a30e72916a2118251cf857baa316431",
        "blocking_contract_findings=0",
...
def test_current_head_013378c_static_contract_review_is_pinned() -> None:
    text = REVIEW_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")

    for needle in [
        "camp_head_at_revalidation=013378cbd94d001ce7657163342d92d805cb2da6",
        "camp_origin_main_at_revalidation=013378cbd94d001ce7657163342d92d805cb2da6",
        "github_refs_heads_main_at_revalidation=013378cbd94d001ce7657163342d92d805cb2da6",
        "autodl_CAMP_HEAD_at_revalidation=013378cbd94d001ce7657163342d92d805cb2da6",
        "autodl_CAMP_origin_main_at_revalidation=013378cbd94d001ce7657163342d92d805cb2da6",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_design_status=fallback_risk_ranking_remediation_design_plan_current_head_0a5d1af_ready_static_contract_review",
        "prior_design_head_at_revalidation=0a5d1af8b8de26361f079bebf52ffdbfb26fbd67",
        "status=fallback_risk_ranking_remediation_static_contract_review_current_head_013378c_passed_default_off_tests_plan_next",
        "blocking_contract_findings=0",
        "current_head_static_contract_revalidated=True",
        "fixed_candidate_boundary_passed=True",
        "affine_score_boundary_passed=True",
    ...
    for needle in [
        "status=fallback_risk_ranking_remediation_static_contract_review_current_head_013378c_passed_default_off_tests_plan_next",
        "current_camp_head=013378cbd94d001ce7657163342d92d805cb2da6",
        "github_refs_heads_main=013378cbd94d001ce7657163342d92d805cb2da6",
        "autodl_CAMP_HEAD=013378cbd94d001ce7657163342d92d805cb2da6",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_design_status=fallback_risk_ranking_remediation_design_plan_current_head_0a5d1af_ready_static_contract_review",
        "prior_design_head_at_revalidation=0a5d1af8b8de26361f079bebf52ffdbfb26fbd67",
        "blocking_contract_findings=0",
...
def test_current_head_4995778_static_contract_review_is_pinned() -> None:
    ...
    for needle in [
        ...
        "camp_origin_main_at_revalidation=49957782ca737b2370b82f5b4f725dcaf031989b",
        "github_refs_heads_main_at_revalidation=49957782ca737b2370b82f5b4f725dcaf031989b",
        "autodl_CAMP_HEAD_at_revalidation=49957782ca737b2370b82f5b4f725dcaf031989b",
        "autodl_CAMP_origin_main_at_revalidation=49957782ca737b2370b82f5b4f725dcaf031989b",
        "autodl_DP_HEAD_at_revalidation=7a1d33da277a1992ec474b5383a0c963c72e04e4",
    ...
    assert audit_tail.rstrip().endswith(NEXT_UNIT_TESTS_PLAN_GATE + "\n```")
