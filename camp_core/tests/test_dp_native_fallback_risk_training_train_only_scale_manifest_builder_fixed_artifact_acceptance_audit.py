...
AUDIT_DOC = (
    REPO_ROOT
    / "docs"
    / "dp_native_training_sufficiency_development_base_plus_addon_static_dp_reward_fixed_artifact_fallback_risk_training_train_only_scale_manifest_builder_fixed_artifact_acceptance_audit.md"
)
...
def test_scale_acceptance_audit_records_inputs_and_output_hashes() -> None:
    text = _audit()
...
def test_scale_acceptance_audit_records_complete_train_only_manifest() -> None:
    text = _audit()
...
def test_scale_acceptance_audit_records_train_only_preflight_scope() -> None:
    text = _audit()
...
def test_scale_acceptance_audit_keeps_forbidden_boundaries() -> None:
    text = _audit()
...
def test_scale_acceptance_audit_next_gate_is_master_command_plan_only() -> None:
    text = _audit()
    ...
    for needle in [
        ...
        "may only plan the fallback-only master config",
