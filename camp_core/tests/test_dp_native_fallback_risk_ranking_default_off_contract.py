...
def test_current_head_f6381dd_default_off_unit_tests_are_pinned() -> None:
    text = UNIT_TESTS_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    ...
    for needle in [
        "status=fallback_risk_ranking_default_off_unit_tests_current_head_f6381dd_revalidated",
        "current_camp_head=f6381dd743c47aaa07aaeff3c6372453b69da445",
        "github_refs_heads_main=f6381dd743c47aaa07aaeff3c6372453b69da445",
        "autodl_CAMP_HEAD=f6381dd743c47aaa07aaeff3c6372453b69da445",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_unit_tests_plan_status=fallback_risk_ranking_default_off_unit_tests_plan_current_head_af2f6e9_ready_tests_only_gate",
        "prior_unit_tests_plan_head_at_revalidation=af2f6e9231f76206e593a6f9b2aa23d0a1c9d023",
        "tests_only=True",
...
def test_current_head_088ee39_default_off_unit_tests_are_pinned() -> None:
    text = UNIT_TESTS_DOC.read_text(encoding="utf-8")
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")
    ...
    for needle in [
        "status=fallback_risk_ranking_default_off_unit_tests_current_head_088ee39_revalidated",
        "current_camp_head=088ee3948c43d238d346729f802e3946f3830f3a",
        "github_refs_heads_main=088ee3948c43d238d346729f802e3946f3830f3a",
        "autodl_CAMP_HEAD=088ee3948c43d238d346729f802e3946f3830f3a",
        "autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4",
        "prior_unit_tests_plan_status=fallback_risk_ranking_default_off_unit_tests_plan_current_head_1921ccc_ready_tests_only_gate",
        "prior_unit_tests_plan_head_at_revalidation=1921ccca4feef7c9ccfaab5416a920913b3cbaaa",
        "tests_only=True",
...
def test_current_head_c574b9e_default_off_unit_tests_are_pinned() -> None:
    ...
    assert audit_tail.rstrip().endswith(NEXT_AUTHORIZATION_GATE + "\n```")
