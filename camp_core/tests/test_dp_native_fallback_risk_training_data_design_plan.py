...
def test_training_data_design_plan_records_current_head_revalidation() -> None:
    ...
    current_head = "0906dc9dbfd1279edb80996acafed86540c28b05"
    for needle in [
...
def test_current_head_7593108_training_data_design_plan_is_pinned() -> None:
    text = _text()
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")

    current_head = "759310803b80479acd86412e1aecb99a9dc93a5c"
    prior_contract_head = "6c6b5ac1904e9553525e663856cfcb9fcbcb7088"
    status = "status=fallback_risk_training_data_design_plan_current_head_7593108_revalidated"
    ...
    for needle in [
        ...
        f"prior_extractor_contract_head_at_revalidation={prior_contract_head}",
        "prior_extractor_contract_tail_verified=True",
        "prior_extractor_contract_autodl_verified=True",
...
def test_current_head_35d8d2e_training_data_design_plan_is_pinned() -> None:
    text = _text()
    audit = ITERATION_AUDIT.read_text(encoding="utf-8")

    current_head = "35d8d2e875db6a14f52f219c0de4d4c156f33769"
    prior_contract_head = "861bf972e92c75160952d8f91496014ab9137843"
    status = "status=fallback_risk_training_data_design_plan_current_head_35d8d2e_revalidated"
