...
with the fixed TiERIV Diffusion Planner. It replaces v9 for new current-state
writes so the oversized v8 log and earlier short-form v9 record stay historical.
