...
Executed on AutoDL at 2026-07-04 01:53 CST after the EOF authorized only static
review of the read-only promotion-readiness evaluation runbook/preflight plan:
...
and source surface. It verified fixed-DP provenance, artifact hashes, EOF
authorization, no-promotion/no-deployment/no-claim boundaries, and the
case-insensitive `HEADS` parsing surface. It did not run evaluation, replay,
training, candidate generation, promotion, deployment, online selector
activation, DP modification, or safety/CAMP-over-DP claims. It authorizes only
a read-only promotion-readiness evaluation runbook/preflight gate.
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_plan_static_review_41539b4bed_20260704T015353CST
...
Executed on AutoDL at 2026-07-04 02:07 CST after the EOF authorized only a
read-only promotion-readiness evaluation runbook/preflight gate:

- Runbook/preflight artifact:
...
- Local verification before audit update:
  `py_compile` exit `0`; target pytest exit `0`, `134 passed`;
  `git diff --check` exit `0`
- AutoDL verification after audit update sync:
  `py_compile` exit `0`; target pytest exit `0`, `134 passed`;
  `git diff --check` exit `0`
- Preflight JSON / MD / preflight SHA256SUMS SHA256:
...
and source plan artifacts. It verified fixed-DP provenance, artifact hashes,
EOF authorization, no-promotion/no-deployment/no-claim boundaries, and the
read-only preflight manifest requirements for future review. It did not run
evaluation, replay, training, candidate generation, promotion, deployment,
online selector activation, DP modification, or safety/CAMP-over-DP claims. It
authorizes only static review of this runbook/preflight artifact.
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_local_pytest_passed=134
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_autodl_pytest_passed=134
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_3062b4f4a5_20260704T020713CST
...
Executed on AutoDL at 2026-07-04 02:27 CST after the EOF authorized only static
review of the read-only promotion-readiness evaluation runbook/preflight
artifact:
...
- Local verification before AutoDL review:
  `py_compile` exit `0`; target pytest exit `0`, `143 passed`;
  `git diff --check` exit `0`
- AutoDL verification before review:
  `py_compile` exit `0`; target pytest exit `0`, `142 passed`;
  `git diff --check` exit `0`
- AutoDL verification after audit update sync:
  `py_compile` exit `0`; target pytest exit `0`, `143 passed`;
  `git diff --check` exit `0`
...
source surface. It verified fixed-DP provenance, artifact hashes, EOF
authorization, no-promotion/no-deployment/no-claim boundaries, and the
read-only preflight requirements for future runbook planning. It did not
execute the future evaluation runbook, replay, training, candidate generation,
promotion, deployment, online selector activation, DP modification, or
safety/CAMP-over-DP claims. It authorizes only a follow-on read-only
promotion-readiness evaluation runbook plan.
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_static_review_autodl_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_preflight_static_review_c2443f45ef_20260704T022733CST
...
Executed on AutoDL at 2026-07-04 02:39 CST after the EOF authorized only a
read-only promotion-readiness evaluation runbook plan:
...
- Local verification before AutoDL plan:
  `py_compile` exit `0`; target pytest exit `0`, `152 passed`;
  `git diff --check` exit `0`
- AutoDL verification before plan:
  `py_compile` exit `0`; target pytest exit `0`, `151 passed`;
  `git diff --check` exit `0`
- AutoDL verification after audit update sync:
  `py_compile` exit `0`; target pytest exit `0`, `152 passed`;
  `git diff --check` exit `0`
...
preflight artifacts. It verified fixed-DP provenance, artifact hashes, EOF
authorization, no-promotion/no-deployment/no-claim boundaries, and the planned
read-only evaluation runbook content. It did not execute the future evaluation
runbook, replay, training, candidate generation, promotion, deployment, online
selector activation, DP modification, or safety/CAMP-over-DP claims. It
authorizes only static review of this runbook plan.
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_local_pytest_passed=152
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_autodl_pytest_passed=152
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_c83a4bdc90_20260704T023923CST
...
Executed on AutoDL at 2026-07-04 02:52 CST after the EOF authorized only
static review of the read-only promotion-readiness evaluation runbook plan:
...
- Local verification before AutoDL review:
  `py_compile` exit `0`; target pytest exit `0`, `159 passed`;
  `git diff --check` exit `0`
- AutoDL verification before review:
  `py_compile` exit `0`; target pytest exit `0`, `159 passed`;
  `git diff --check` exit `0`
- AutoDL verification after audit update sync:
  `py_compile` exit `0`; target pytest exit `0`, `160 passed`;
  `git diff --check` exit `0`
- Review JSON / MD / review SHA256SUMS SHA256:
...
surface. It verified fixed-DP provenance, artifact hashes, EOF authorization,
no-promotion/no-deployment/no-claim boundaries, and the planned read-only
evaluation runbook content. It did not execute the future evaluation runbook,
replay, training, candidate generation, promotion, deployment, online selector
activation, DP modification, or safety/CAMP-over-DP claims. It authorizes only
a follow-on read-only execution preflight.
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_local_pytest_passed=160
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_autodl_pytest_passed=160
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_plan_static_review_dc6b804a9d_20260704T025255CST
...
Executed on AutoDL at 2026-07-04 03:03 CST after the EOF authorized only a
read-only promotion-readiness evaluation runbook execution preflight:
...
- Failure attribution:
  the execution-preflight contract expected the source runbook-plan static
  review artifact root `SHA256SUMS` to include `review/SHA256SUMS`, but the
  existing source artifact root manifest excludes nested `SHA256SUMS`; it also
  required an explicit `evaluation_runbook_execution=False` analysis key that
  the existing source static-review artifact did not emit.
- stdout tail:
  final decision JSON reported `passed=false`, the two failed checks above,
  `authorized_next_work=null`, and all promotion/deployment/claim/execution
  flags false.
- stderr tail:
  empty
- Local verification before AutoDL preflight:
  `py_compile` exit `0`; target pytest exit `0`, `167 passed`;
  `git diff --check` exit `0`
- AutoDL verification before preflight:
  `py_compile` exit `0`; target pytest exit `0`, `167 passed`;
  `git diff --check` exit `0`
- AutoDL verification after failure audit update sync:
  `py_compile` exit `0`; target pytest exit `0`, `168 passed`;
  `git diff --check` exit `0`
- Preflight JSON / MD / preflight SHA256SUMS SHA256:
...
This failed preflight did not execute the future evaluation runbook, replay,
training, candidate generation, promotion, deployment, online selector
activation, DP modification, or safety/CAMP-over-DP claims. It authorizes no
next execution or static-review work. A user decision is required before any
contract fix or rerun of the same preflight gate.
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_camp_origin_main=e015b6b57be6d0dfffd0aa6b14546bd9c92e9e4f
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_passed=False
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_authorized_next_work=None
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_recommendation=static_review_this_runbook_execution_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_immediate_action=static_review_promotion_readiness_evaluation_runbook_execution_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_local_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_autodl_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_e015b6b57b_20260704T030343CST
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_camp_origin_main=12cd3dc982ef2099fb04aa2914cd459062955cdb
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_passed=True
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failure_class=None
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_recommendation=static_review_this_runbook_execution_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_immediate_action=static_review_promotion_readiness_evaluation_runbook_execution_preflight_only
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_local_pytest_passed=172
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_autodl_pytest_passed=172
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_12cd3dc982_20260704T104156CST
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_camp_origin_main=92fab539101db586877d2685f1d99b758d24037c
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_passed=False
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_authorized_next_work=None
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_recommendation=execute_read_only_promotion_readiness_evaluation_runbook_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_immediate_action=execute_promotion_readiness_evaluation_runbook_only
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_source_artifact_manifest_requirement_count=7
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_source_no_go_condition_count=8
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_source_future_review_requirement_count=4
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_local_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_autodl_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_92fab53910_20260704T105546CST
...
After explicit user authorization, the execution-preflight static-review
contract was updated to accept the audited source preflight layout where
`analysis.evaluation_runbook_execution` is absent and therefore treated as
audited false, to accept the passing preflight audit marker
`post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_passed=True`,
and to accept only the recorded failed/user-decision EOF pair for this rerun.
AutoDL reran the same read-only static-review gate:
...
- Local verification before AutoDL rerun:
  `py_compile` exit `0`; target pytest exit `0`, `185 passed`;
  `git diff --check` exit `0`
- AutoDL verification before rerun:
  `py_compile` exit `0`; target pytest exit `0`, `185 passed`;
  `git diff --check` exit `0`
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_camp_origin_main=39e05a250c515708ced4db44db38cc2d90232d44
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_passed=True
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_failed_checks=
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_recommendation=execute_read_only_promotion_readiness_evaluation_runbook_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_immediate_action=execute_promotion_readiness_evaluation_runbook_only
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_source_artifact_manifest_requirement_count=7
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_source_no_go_condition_count=8
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_source_future_review_requirement_count=4
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_local_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_autodl_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_preflight_static_review_39e05a250c_20260704T112434CST
...
AutoDL executed the read-only promotion-readiness evaluation runbook. This gate
materialized the predeclared non-claim metrics manifest, no-go summary, and
evidence matrix from existing audited artifacts. It did not run replay, train
CAMP, generate candidates, modify Diffusion Planner, promote, deploy, activate
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; target pytest exit `0`, `191 passed`;
  `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; target pytest exit `0`, `191 passed`;
  `git diff --check` exit `0`
...
This runbook execution materialized only read-only, non-claim promotion
readiness evidence. It does not authorize promotion, deployment, online selector
activation, DP modification, replay/candidate generation/training, or any
safety/CAMP-over-DP claim. It authorizes only static review of this execution
artifact.
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_camp_origin_main=705f669eb548ed945a62bfeff299fc4fe20c2cc3
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_passed=True
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_recommendation=static_review_this_promotion_readiness_evaluation_runbook_execution_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_immediate_action=static_review_promotion_readiness_evaluation_runbook_execution_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_local_pytest_passed=191
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_autodl_pytest_passed=191
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_705f669eb5_20260704T114256CST
...
evaluation runbook execution artifact. This gate reviewed the already-materialized
execution artifact and did not run replay, train CAMP, generate candidates,
modify Diffusion Planner, promote, deploy, activate an online selector, or make
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; target pytest exit `0`, `197 passed`;
  `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; target pytest exit `0`, `197 passed`;
  `git diff --check` exit `0`
...
This static review authorizes only the read-only result review of the runbook
execution artifact. It does not authorize promotion, deployment, online selector
activation, DP modification, replay/candidate generation/training, or any
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_camp_origin_main=f5d5b4cbf4990b982c97e4b0d7885141a0f911d1
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_passed=True
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_recommendation=review_read_only_promotion_readiness_evaluation_runbook_execution_result_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_immediate_action=review_promotion_readiness_evaluation_runbook_execution_result_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_local_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_autodl_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_static_review_f5d5b4cbf4_20260704T115712CST
...
evaluation runbook execution artifact and its static review. This gate reviewed
existing artifacts only. It did not run replay, train CAMP, generate candidates,
modify Diffusion Planner, promote, deploy, activate an online selector, or make
any safety/CAMP-over-DP claim:
...
- Direct promotion recommendation / promotion-decision plan authorized next:
  `False / False`
- Follow-up requires explicit user decision:
  `True`
- Authorized next work:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; target pytest exit `0`, `204 passed`;
  `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; target pytest exit `0`, `204 passed`;
  `git diff --check` exit `0`
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_camp_origin_main=b7853716a3731ada094b30837692b6e081469726
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_passed=True
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_only
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_authorized_next_work=user_decision_required_before_public_simulator_post_closeout_promotion_readiness_evaluation_followup_or_promotion_authorization
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_recommendation=do_not_promote_from_current_runbook_execution_result_alone
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_immediate_action=stop_for_user_decision_before_any_promotion_deployment_online_selector_or_claim
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_local_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_autodl_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_evaluation_runbook_execution_result_review_b7853716a3_20260704T120906CST
...
planning gate. This gate consumed the latest runbook execution result-review
artifact and existing audit/status evidence, then materialized a gap-closure
plan for future review. It did not run replay, train CAMP, generate candidates,
modify Diffusion Planner, promote, deploy, activate an online selector, or make
any safety/CAMP-over-DP claim:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; target pytest exit `0`, `210 passed`;
  `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; target pytest exit `0`, `210 passed`;
  `git diff --check` exit `0`
...
The plan records the next audit surface as a static review of this follow-up
plan only. It preserves direct promotion recommendation as false and does not
authorize promotion-decision planning, selector promotion, deployment, online
selector activation, DP modification, replay/candidate generation/training, or
any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_camp_origin_main=dfeb575c78d35249a6ef1ee58549a4fadbc38393
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_authorized_current_work=user_decision_required_before_public_simulator_post_closeout_promotion_readiness_evaluation_followup_or_promotion_authorization
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_followup_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_recommendation=static_review_this_read_only_followup_plan_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_immediate_action=static_review_promotion_readiness_followup_plan_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_local_pytest_passed=210
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_autodl_pytest_passed=210
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_followup_plan_dfeb575c78_20260704T123010CST
...
AutoDL executed the static review of the read-only follow-up plan. This gate
reviewed the already-materialized follow-up plan artifact and did not run
replay, train CAMP, generate candidates, modify Diffusion Planner, promote,
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; target pytest exit `0`, `216 passed`;
  `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; target pytest exit `0`, `216 passed`;
  `git diff --check` exit `0`
...
This static review authorizes only a read-only uncertainty/coverage review
planning gate. It preserves direct promotion recommendation as false and does
not authorize promotion-decision planning, selector promotion, deployment,
online selector activation, DP modification, replay/candidate
generation/training, or any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_camp_origin_main=f6e7122d1d1d198b02da2beb89802852e79f007f
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_followup_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_recommendation=plan_read_only_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_immediate_action=plan_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_local_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_local_pytest_passed=216
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_autodl_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_autodl_pytest_passed=216
v14_public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_followup_plan_static_review_f6e7122d1d_20260704T123957CST
...
AutoDL executed the read-only uncertainty/coverage review planning gate. This
gate consumed the already-materialized follow-up plan static review artifact
and did not run replay, train CAMP, generate candidates, modify Diffusion
Planner, promote, deploy, activate an online selector, or make any
safety/CAMP-over-DP claim:
...
- Planned review items:
  `score_margin_uncertainty_surface,coverage_slice_matrix,candidate_tensor_support_coverage,atom_contribution_stability,default_off_fail_closed_uncertainty_boundary,claim_boundary,promotion_thresholds_tbd`
- Authorized next work:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `152 passed`; v14 audit pytest exit `0`,
  `70 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `152 passed`; v14 audit pytest exit `0`,
  `70 passed`; `git diff --check` exit `0`
...
The plan authorizes only static review of this read-only uncertainty/coverage
review plan. It preserves direct promotion recommendation as false and does
not authorize promotion-decision planning, selector promotion, deployment,
online selector activation, DP modification, replay/candidate
generation/training, or any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_camp_origin_main=b7738a2795c4d123ec87a5ebda832cd8a26842a0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_recommendation=static_review_this_uncertainty_coverage_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_immediate_action=static_review_uncertainty_coverage_review_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_new_pytest_passed=5
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_v14_audit_pytest_passed=70
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_autodl_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_autodl_new_pytest_passed=5
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_autodl_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_autodl_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_b7738a2795_20260704T125644CST
...
plan. This gate consumed the already-materialized uncertainty/coverage plan
artifact and did not run replay, train CAMP, generate candidates, modify
Diffusion Planner, promote, deploy, activate an online selector, or make any
safety/CAMP-over-DP claim:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `157 passed`; v14 audit pytest exit `0`,
  `71 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `157 passed`; v14 audit pytest exit `0`,
  `71 passed`; `git diff --check` exit `0`
...
This static review authorizes only a read-only uncertainty/coverage review
preflight planning gate. It preserves direct promotion recommendation as false
and does not authorize promotion-decision planning, selector promotion,
deployment, online selector activation, DP modification, replay/candidate
generation/training, or any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_camp_origin_main=ffcdeabd52df1416fa1e2329860aede37711b608
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_recommendation=plan_read_only_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_immediate_action=plan_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_local_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_local_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_local_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_autodl_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_autodl_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_autodl_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_plan_static_review_ffcdeabd52_20260704T130813CST
...
gate. This gate consumed the audited static-review artifact and did not run
replay, train CAMP, generate candidates, modify Diffusion Planner, promote,
deploy, activate an online selector, or make any safety/CAMP-over-DP claim:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `162 passed`; v14 audit pytest exit `0`,
  `72 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `162 passed`; v14 audit pytest exit `0`,
  `72 passed`; `git diff --check` exit `0`
...
This preflight plan authorizes only static review of the read-only
uncertainty/coverage review preflight plan. It preserves direct promotion
recommendation as false and does not authorize promotion-decision planning,
selector promotion, deployment, online selector activation, DP modification,
replay/candidate generation/training, or any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_camp_origin_main=5add9915714f54d0a8bcec8e4cde97f80c83f79e
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_recommendation=static_review_this_uncertainty_coverage_preflight_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_immediate_action=static_review_uncertainty_coverage_review_preflight_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_local_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_local_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_local_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_autodl_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_autodl_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_autodl_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_5add991571_20260704T132654CST
...
AutoDL executed the static review of the read-only uncertainty/coverage review
preflight plan. This gate consumed the already-materialized preflight plan
artifact and did not run the review preflight itself, replay, train CAMP,
generate candidates, modify Diffusion Planner, promote, deploy, activate an
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `167 passed`; v14 audit pytest exit `0`,
  `73 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new pytest exit `0`, `5 passed`;
  readiness pytest exit `0`, `167 passed`; v14 audit pytest exit `0`,
  `73 passed`; `git diff --check` exit `0`
...
This static review authorizes only the read-only uncertainty/coverage review
preflight. It preserves direct promotion recommendation as false and does not
authorize promotion-decision planning, selector promotion, deployment, online
selector activation, DP modification, replay/candidate generation/training, or
any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_camp_origin_main=36e691f3e3f12f9679f9975b10cfabe518e24e06
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_recommendation=run_read_only_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_immediate_action=run_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_local_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_local_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_local_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_autodl_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_autodl_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_autodl_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_plan_static_review_36e691f3e3_20260704T134054CST
...
AutoDL executed the read-only uncertainty/coverage review preflight. This gate
consumed the already-audited preflight plan and preflight-plan static review
artifacts and did not run replay, train CAMP, generate candidates, modify
Diffusion Planner, promote, deploy, activate an online selector, or make any
safety/CAMP-over-DP claim:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `173 passed`; v14 audit pytest exit `0`,
  `74 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `173 passed`; v14 audit pytest exit `0`,
  `74 passed`; `git diff --check` exit `0`
...
This preflight authorizes only static review of the uncertainty/coverage
review preflight. It preserves direct promotion recommendation as false and
does not authorize promotion-decision planning, selector promotion, deployment,
online selector activation, DP modification, replay/candidate
generation/training, or any safety/CAMP-over-DP claim.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_camp_origin_main=e3fa0b0aa12e0f4e846f0bfb61bb88f61b0c425c
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_failure_class=None
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_recommendation=static_review_this_uncertainty_coverage_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_immediate_action=static_review_uncertainty_coverage_review_preflight_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_local_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_local_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_local_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_local_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_autodl_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_autodl_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_autodl_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_autodl_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_e3fa0b0aa1_20260704T140146CST
...
uncertainty/coverage review preflight artifact. The attempt failed closed before
authorizing the uncertainty/coverage review because the new review contract did
not match the already-audited EOF authorization key layout:
...
- Source no-go conditions / future review requirements:
  `7 / 5`
- Stdout tail attribution:
  `failed_checks=["audit_preflight_static_review_authorized"]`;
  `failure_class="v14_eof_contract_mismatch"`;
  `authorized_next_work=null`; `uncertainty_coverage_review_authorized=false`
- Stderr tail:
  empty
- Review JSON / MD / review SHA256SUMS SHA256:
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_camp_origin_main=f1b6f46eb62bfcd0abd614430a89c0f3791f8d84
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_passed=False
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_authorized_next_work=None
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_recommendation=run_read_only_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_immediate_action=run_uncertainty_coverage_review_only
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_f1b6f46eb6_20260704T142410CST
...
accept the audited source preflight EOF state
`uncertainty_coverage_review_preflight_static_review_authorized=True`. AutoDL
reran the same read-only static review gate against the same source preflight
artifact. The first authorized rerun failed closed on the contract's
failed-attempt audit key lookup, then a key-only correction was rerun and
passed:
...
- Source no-go conditions / future review requirements:
  `7 / 5`
- Stdout tail attribution:
  `failed_checks=["audit_failed_attempt_failed_checks"]`;
  `failure_class="v14_eof_contract_mismatch"`
- Stderr tail:
  empty
- Review JSON / MD / review SHA256SUMS SHA256:
...
Failed authorized rerun attribution: the contract fix correctly accepted the
audited short preflight-static-review authorization key, but the failed-attempt
check accidentally looked for
`v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_failed_checks`.
The audited failed-attempt key is
`v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_failed_checks`.
The failed artifact is preserved as evidence.
...
- Local verification before passing rerun:
  `py_compile` exit `0`; new pytest exit `0`, `7 passed`;
  readiness pytest exit `0`, `180 passed`; v14 audit pytest exit `0`,
  `76 passed`; `git diff --check` exit `0`
- AutoDL verification before passing rerun:
  `py_compile` exit `0`; new pytest exit `0`, `7 passed`;
  readiness pytest exit `0`, `180 passed`; v14 audit pytest exit `0`,
  `76 passed`; `git diff --check` exit `0`
- Review JSON / MD / review SHA256SUMS SHA256:
...
This passing rerun authorizes only the read-only uncertainty/coverage review.
It did not execute the uncertainty/coverage review, replay, training, candidate
generation, promotion, deployment, online selector activation, DP modification,
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_source_preflight_artifact=/root/autodl-tmp/camp_dp_v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_e3fa0b0aa1_20260704T140146CST
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_camp_head=947199c5fc566af41e2898a0ba21a0acd4c599e7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_camp_origin_main=947199c5fc566af41e2898a0ba21a0acd4c599e7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_dp_head=7a1d33da277a1992ec474b5383a0c963c72e04e4
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_exit=1
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_status=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_rejected
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_passed=False
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_review_check_count=141
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_failed_check_count=1
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_source_preflight_check_count=190
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_source_review_preflight_item_count=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_source_artifact_manifest_requirement_count=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_source_no_go_status_count=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_source_future_review_requirement_count=5
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_report_md_sha256=1a240208559bd96e0a18fa2cf4cdfefb8c3f093419211bfc36a28f4f77775abd
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_report_sha256s_sha256=4b6319f0b1f71bf5469aac269a37e041504413ef6a006e6484c4616ac25ff3de
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_heads_sha256=2d5447627b392b2b7fe539fe9bb248a7c6f42633998d28a143e9fee25092e052
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_command_sha256=b038b2810cf6858728abda67d95c64bb8728405271a66ee73e17a85a156a004c
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_stdout_sha256=16294c4ecadeee2a8e44f06c112a6e1b83b5209b0d06e0d71951f9387efd498e
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_stderr_sha256=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_contract_update_rerun_failed_run_exit_sha256=4355a46b19d348dc2f57c046f8ef63d4538ebb936000f3c9ee954a27460dd865
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_camp_origin_main=61565337174dc697f610b709eb2b50a3f86c0415
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_recommendation=run_read_only_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_immediate_action=run_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_local_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_local_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_local_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_autodl_new_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_autodl_readiness_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_autodl_v14_audit_pytest_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_authorized_rerun_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_6156533717_20260704T170306CST
...
post_closeout_promotion_readiness_uncertainty_coverage_review_preflight_static_review_passed=True
...
AutoDL executed the read-only uncertainty/coverage review. The gate consumed
the already-audited uncertainty/coverage review preflight and its static-review
artifact. It did not run replay, train CAMP, generate candidates, modify
Diffusion Planner, promote, deploy, activate an online selector, or make any
safety/CAMP-over-DP claim:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `186 passed`; v14 audit pytest exit `0`,
  `77 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `186 passed`; v14 audit pytest exit `0`,
  `77 passed`; `git diff --check` exit `0`
...
This review passed as a read-only evidence-gap review. It records that the
current package still lacks the uncertainty input, coverage slice, atom
stability, no-go, and claim-boundary manifests required before any promotion,
deployment, online selector activation, safety-benefit claim, or CAMP-over-DP
Top-1 claim can be considered. The only authorized next work is static review
of this review artifact.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_camp_origin_main=aa52033244edd6932ec6b1ec19f82530415659ac
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_failed_check_count=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_source_static_review_check_count=141
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_source_preflight_check_count=190
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_source_preflight_item_count=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_source_artifact_manifest_requirement_count=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_source_no_go_status_count=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_source_future_review_requirement_count=5
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_direct_promotion_recommendation=False
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_recommendation=static_review_this_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_immediate_action=static_review_uncertainty_coverage_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_readiness_pytest_passed=186
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_v14_audit_pytest_passed=77
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_readiness_pytest_passed=186
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_v14_audit_pytest_passed=77
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_aa52033244_20260704T173104CST
...
AutoDL executed the read-only static review of the uncertainty/coverage review
artifact. The gate consumed only the already-audited review artifact and local
source/test contract surface. It did not run replay, train CAMP, generate
candidates, modify Diffusion Planner, promote, deploy, activate an online
selector, or make any safety/CAMP-over-DP claim:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new static-review pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `192 passed`; v14 audit pytest exit `0`,
  `78 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new static-review pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `192 passed`; v14 audit pytest exit `0`,
  `78 passed`; `git diff --check` exit `0`
...
The static review passed and preserved the review's no-promotion conclusion.
The only authorized next work is a read-only evidence-gap closure plan for the
five missing uncertainty/coverage evidence manifests.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_camp_origin_main=cacedef80aa8c123a205c938da5512cadd0a06c0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_failed_check_count=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_recommendation=plan_uncertainty_coverage_evidence_gap_closure_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_immediate_action=evidence_gap_closure_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_readiness_pytest_passed=192
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_v14_audit_pytest_passed=78
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_readiness_pytest_passed=192
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_v14_audit_pytest_passed=78
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_review_static_review_cacedef80a_20260704T174554CST
...
The gate consumed only the already-audited uncertainty/coverage review
static-review artifact and current audit/status docs. It did not materialize
evidence manifests, run replay, train CAMP, generate candidates, modify
Diffusion Planner, promote, deploy, activate an online selector, or make any
safety/CAMP-over-DP claim:
...
- Closure plan items:
  `future_uncertainty_input_manifest,future_coverage_slice_manifest,future_atom_stability_manifest,future_no_go_summary,future_claim_boundary_summary`
- Source static-review checks / source review evidence gaps:
  `134 / 5`
- Authorized next work:
...
- Local verification before AutoDL run:
  `py_compile` exit `0`; new plan pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `198 passed`; v14 audit pytest exit `0`,
  `79 passed`; `git diff --check` exit `0`
- AutoDL verification before run:
  `py_compile` exit `0`; new plan pytest exit `0`, `6 passed`;
  readiness pytest exit `0`, `198 passed`; v14 audit pytest exit `0`,
  `79 passed`; `git diff --check` exit `0`
...
The plan passed as a read-only planning gate. It defines the five closure items
needed before any evidence materialization can be considered, and it authorizes
only static review of this plan.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_camp_origin_main=63d41f1ce9b548cc3ad981a4950dfd5a7ca29ff8
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_failed_check_count=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_failed_checks=
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_authorized_next_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_recommendation=static_review_this_evidence_gap_closure_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_immediate_action=static_review_evidence_gap_closure_plan_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_readiness_pytest_passed=198
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_v14_audit_pytest_passed=79
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_new_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_new_pytest_passed=6
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_readiness_pytest_passed=198
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_v14_audit_pytest_passed=79
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_autodl_git_diff_check_exit=0
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_63d41f1ce9_20260704T180522CST
...
but the script failed before report construction. The direct script execution
environment did not put the repo root on `sys.path`, so the static-review script
could not import `scripts.integrations...`:
...
No static-review JSON/MD was constructed. No evidence materialization, replay,
training, candidate generation, DP modification, promotion, deployment, online
selector activation, or safety/CAMP-over-DP claim was performed. The same
read-only static-review gate now requires an explicit user decision before an
import-path fix and rerun.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_failed_camp_origin_main=da3f193bfdff11531370f4c0be247ac34a98d219
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_failed_report_json_sha256=None
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_failed_report_md_sha256=None
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_failed_report_sha256s_sha256=None
...
current_v14_artifact_scope=public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_da3f193bfd_20260704T182013CST
...
After explicit user authorization, the read-only evidence-gap closure plan
static-review script was fixed to load its paired plan module by file path under
direct AutoDL script execution. The fix was verified locally, committed, pushed,
and synchronized to AutoDL at:

`a8b480bd4053a15cf33734faaafcbd4cbb79ad69`

AutoDL then reran the same read-only static-review gate against the existing
...
- Source evidence-gap closure plan artifact:
  `/root/autodl-tmp/camp_dp_v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_63d41f1ce9_20260704T180522CST`
- Prior failed import-path artifact:
  `/root/autodl-tmp/camp_dp_v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_da3f193bfd_20260704T182013CST`
- CAMP head and origin/main:
  `a8b480bd4053a15cf33734faaafcbd4cbb79ad69`
- DP head:
...
- Review check count / failed check count:
  `151 / 4`
- Source plan check count / source plan item count:
  `143 / 5`
- Source static-review checks / source review evidence gaps:
  `134 / 5`
- Local verification before AutoDL rerun:
  `py_compile` exit `0`; target static-review pytest exit `0`, `7 passed`;
  readiness pytest exit `0`, `205 passed`; v14 audit pytest exit `0`,
  `81 passed`; `git diff --check` exit `0`
- AutoDL verification before rerun:
  `py_compile` exit `0`; target static-review pytest exit `0`, `7 passed`;
  readiness pytest exit `0`, `205 passed`; v14 audit pytest exit `0`,
  `81 passed`; `git diff --check` exit `0`
...
- Artifact HEADS / COMMAND / stdout / stderr / run.exit / root SHA256SUMS SHA256:
  `e81fa4b0f1c180a4221697282f4b82eb16ef30104544ca6590aa887800c967a3`,
  `75706de9975d3c17e4a55bc23f4a3a3a882763dc40db7bba4a99180b45a233e7`,
  `013b226d87af0e1472c311f4d0e2811b10a4d04d7959d201e89e19d1f650c11d`,
  `e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`,
  `4355a46b19d348dc2f57c046f8ef63d4538ebb936000f3c9ee954a27460dd865`,
  `ff6f4f7cda8f5bed0c7a7e2d9d25f2c82627cf753d5cd051b56ca5c74e1c593f`

The import-path fix worked: the rerun constructed review JSON/MD and failed
closed on the review contract itself. The current contract still expects the
latest audit/status EOF to be the original source plan-ready state, while the
audited EOF is now the prior import-path failure decision boundary. No evidence
materialization, replay, training, candidate generation, DP modification,
promotion, deployment, online selector activation, or safety/CAMP-over-DP claim
was performed. The same read-only static-review gate now requires explicit user
authorization before any contract update or rerun.
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_prior_failed_artifact=/root/autodl-tmp/camp_dp_v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_da3f193bfd_20260704T182013CST
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_passed=False
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_source_plan_check_count=143
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_source_plan_item_count=5
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_source_static_review_check_count=134
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_source_review_gap_count=5
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_authorized_current_work=public_simulator_fixed_dp_candidate_generation_trained_default_off_shadow_replay_evaluation_default_off_shadow_selector_runtime_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_only
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_authorized_next_work=None
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_recommendation=repair_contract_before_rerun
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_immediate_action=inspect_failed_checks
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_target_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_target_pytest_passed=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_readiness_pytest_passed=205
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_v14_audit_pytest_passed=81
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_local_git_diff_check_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_py_compile_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_target_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_target_pytest_passed=7
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_readiness_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_readiness_pytest_passed=205
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_v14_audit_pytest_exit=0
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_v14_audit_pytest_passed=81
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_autodl_git_diff_check_exit=0
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_heads_sha256=e81fa4b0f1c180a4221697282f4b82eb16ef30104544ca6590aa887800c967a3
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_command_sha256=75706de9975d3c17e4a55bc23f4a3a3a882763dc40db7bba4a99180b45a233e7
...
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_stderr_sha256=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
v14_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_authorized_import_path_rerun_failed_run_exit_sha256=4355a46b19d348dc2f57c046f8ef63d4538ebb936000f3c9ee954a27460dd865
