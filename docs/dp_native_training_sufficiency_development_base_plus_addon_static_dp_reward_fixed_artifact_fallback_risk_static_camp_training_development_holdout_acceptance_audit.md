...
## Current HEAD f05e9c9 Development Holdout Acceptance Audit
...
training commit `6ca391d...` and already covered by the nonpromotion artifact
audit executed at `8471380...`. It recomputes `score_k(w)=a_k^T w` over
...
local_related_target_pytest=39 passed
local_git_diff_check_exit=0
autodl_temp_worktree=/root/autodl-tmp/camp_core_holdout_audit_f05e9c9_verify_20260626T201500Z
autodl_py_compile_exit=0
autodl_related_target_pytest=39 passed
...
## Current HEAD 884a3ed Development Holdout Acceptance Audit

Date: 2026-06-26

This current-head audit re-runs the read-only development holdout acceptance
check over the actual fallback-risk static CAMP training artifacts created at
training commit `34bdb4b...` and already covered by the nonpromotion artifact
audit executed at `ecc4a6e...`. It recomputes `score_k(w)=a_k^T w` over
existing fixed candidate atom tensors and records nonformal internal holdout
metrics. It does not run Diffusion Planner, generate or rewrite trajectories,
retrain CAMP, promote a selector or atom, deploy a checkpoint, or claim safety
benefit.
...
autodl_git_diff_check_exit=0
autodl_audit_execution_CAMP_HEAD=884a3edbde3726b8d4cc4558f4dc911de59d0e75
autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4
```
...
## Current HEAD 57b6945 Development Holdout Acceptance Audit

Date: 2026-06-27

This current-head audit re-runs the read-only development holdout acceptance
check over the actual fallback-risk static CAMP training artifacts created at
training commit `75dbff5...` and already covered by the nonpromotion artifact
audit executed at `604ef71...`. It recomputes `score_k(w)=a_k^T w` over
existing fixed candidate atom tensors and records nonformal internal holdout
metrics. It does not run Diffusion Planner, generate or rewrite trajectories,
retrain CAMP, promote a selector or atom, deploy a checkpoint, or claim safety
benefit.
...
autodl_git_diff_check_exit=0
autodl_CAMP_HEAD=57b6945521316cb465fa38f4479a3875e7e78a8e
autodl_CAMP_origin_main=57b6945521316cb465fa38f4479a3875e7e78a8e
autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4
```
