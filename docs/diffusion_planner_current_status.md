...
- Current next work target is
  `user_decision_required_before_public_simulator_post_closeout_promotion_readiness_uncertainty_coverage_evidence_gap_closure_plan_static_review_contract_update_or_rerun`.
...
audited import-path failure decision boundary. No materialization, replay,
training, promotion, deployment, online selector activation, or claim was
performed. The next step requires explicit user authorization before any
contract update or rerun.
