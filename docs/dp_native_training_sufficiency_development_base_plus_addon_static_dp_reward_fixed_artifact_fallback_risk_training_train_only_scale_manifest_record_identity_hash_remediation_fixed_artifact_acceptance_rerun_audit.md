...
## Current HEAD Fixed-Artifact Acceptance Rerun After Split Manifest Acceptance 8fae7e6

Date: 2026-06-27

Re-ran the default-off train-only scale manifest builder on the current
accepted fallback-risk training dataset and split manifest artifacts at CAMP
HEAD `041bc6e48a634c3b66096063cc9ea4e3b9430681`. The builder completed and
produced train-only atom scales using only split-manifest training groups. It
did not execute training, run replay, generate candidates, modify Diffusion
...
scale_manifest_json=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_041bc6e_20260627T083000CST/scale_manifest.json
scale_manifest_md=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_041bc6e_20260627T083000CST/scale_manifest.md
...
## Current HEAD Fixed-Artifact Acceptance Rerun After 094a2b4 Split Manifest Acceptance

Date: 2026-06-27

Re-ran the default-off train-only scale manifest builder on the current
accepted fallback-risk training dataset and split manifest artifacts at CAMP
HEAD `fc3f224050eb8176645b147aab8a5dcae071d443`. The builder completed and
produced train-only atom scales using only split-manifest training groups. It
did not execute training, run replay, generate candidates, modify Diffusion
Planner, promote selectors or atoms, deploy, or make safety/CAMP-over-DP
claims.
...
scale_manifest_json=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_fc3f224_20260626T182842Z/scale_manifest.json
scale_manifest_md=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_fc3f224_20260626T182842Z/scale_manifest.md
...
## AutoDL Sync Verification After Current HEAD Train-Only Scale Manifest Acceptance

Date: 2026-06-26

Verified the pushed train-only scale manifest acceptance checkpoint on AutoDL
after a fast-forward fetch from GitHub. This sync verification did not execute
training, run replay, generate candidates, modify Diffusion Planner, promote
selector or atom state, deploy, or claim safety/CAMP-over-DP benefit.

```text
status=fallback_risk_training_train_only_scale_manifest_current_head_53df201_autodl_sync_verified
passed=True
source_scale_acceptance_tail_status=fallback_risk_training_train_only_scale_manifest_current_head_20fd1a9_tail_authority
pushed_scale_acceptance_commit=53df2012b8ab9dc83ad4f57e7077680d642ff7f1
verified_local_HEAD=53df2012b8ab9dc83ad4f57e7077680d642ff7f1
verified_origin_main=53df2012b8ab9dc83ad4f57e7077680d642ff7f1
verified_github_refs_heads_main=53df2012b8ab9dc83ad4f57e7077680d642ff7f1
verified_autodl_CAMP_HEAD=53df2012b8ab9dc83ad4f57e7077680d642ff7f1
verified_autodl_CAMP_origin_main=53df2012b8ab9dc83ad4f57e7077680d642ff7f1
...
## Current HEAD Fixed-Artifact Acceptance Rerun After Split Manifest Acceptance Sync

Date: 2026-06-26

Re-ran the default-off train-only scale manifest builder on the existing
accepted fallback-risk training dataset and split manifest artifacts at CAMP
HEAD `20fd1a98196e385d249c3d04a85f9b16ddbba70d`. The builder completed and
produced train-only atom scales using only split-manifest training groups. It
did not execute training, run replay, generate candidates, modify Diffusion
Planner, promote selectors or atoms, deploy, or make safety/CAMP-over-DP
claims.
...
scale_manifest_json=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_20fd1a9_20260626T052920Z/scale_manifest.json
scale_manifest_md=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_20fd1a9_20260626T052920Z/scale_manifest.md
...
## Current HEAD Fixed-Artifact Acceptance Rerun After Split Manifest Acceptance ad223a1

Date: 2026-06-26

Re-ran the default-off train-only scale manifest builder on the current
accepted fallback-risk training dataset and split manifest artifacts at CAMP
HEAD `ad223a1eda2f7e7b5a3068fce36a28ec68f8057b`. The builder completed and
produced train-only atom scales using only split-manifest training groups. It
did not execute training, run replay, generate candidates, modify Diffusion
Planner, promote selectors or atoms, deploy, or make safety/CAMP-over-DP
claims.
...
passed=True
acceptance_base_head=ad223a1eda2f7e7b5a3068fce36a28ec68f8057b
source_dataset_json=/root/autodl-tmp/camp_dp_native_fallback_risk_training_data_builder_acceptance_4751222_20260625T213641Z/dataset.json
expected_dataset_sha256=16f74d494ec371f5d888eead946dbd448ad4375107da75f8e3dbcdd57435dc36
...
expected_split_manifest_sha256=b76004575fb79916eb5bbb61492645d37b32797e16c8f28cc8b97cb16dae21f4
validator_output_json_sha256=f8a26e357020022779dc9eb40992b3d1107521e0abd345cd9f498ea988c95114
source_split_manifest_acceptance_status=fallback_risk_training_split_manifest_builder_fixed_artifact_acceptance_head_0e302e1_tail_authority
builder_commit=ad223a1eda2f7e7b5a3068fce36a28ec68f8057b
autodl_CAMP_HEAD=ad223a1eda2f7e7b5a3068fce36a28ec68f8057b
autodl_CAMP_origin_main=ad223a1eda2f7e7b5a3068fce36a28ec68f8057b
autodl_DP_HEAD=7a1d33da277a1992ec474b5383a0c963c72e04e4
```
...
```text
builder_output_dir=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_ad223a1_20260626T130628Z
scale_manifest_json=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_ad223a1_20260626T130628Z/scale_manifest.json
scale_manifest_md=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_ad223a1_20260626T130628Z/scale_manifest.md
...
## Tail Authority After fc3f224 Train-Only Scale Manifest Acceptance

Date: 2026-06-27

The current-head train-only scale manifest acceptance evidence is recorded
above under
`status=fallback_risk_training_train_only_scale_manifest_current_head_fc3f224_fixed_artifact_acceptance_passed`.
This tail-authority entry keeps the acceptance audit tail aligned with the
current admissible next gate. It does not execute training, run replay,
...
passed=True
source_scale_acceptance_status=fallback_risk_training_train_only_scale_manifest_current_head_fc3f224_fixed_artifact_acceptance_passed
source_scale_acceptance_commit=fc3f224050eb8176645b147aab8a5dcae071d443
source_split_manifest_acceptance_status=fallback_risk_training_split_manifest_builder_fixed_artifact_acceptance_head_094a2b4_tail_authority
source_builder_output_dir=/root/autodl-tmp/camp_dp_native_fallback_risk_training_train_only_scale_manifest_acceptance_fc3f224_20260626T182842Z
scale_manifest_json_sha256=6d4f691a6eeae0324406af959ddcff996b36441eb4d839b41143ef48bbc802f5
training_split_manifest_json_sha256=b76004575fb79916eb5bbb61492645d37b32797e16c8f28cc8b97cb16dae21f4
source_fit_records_used=13
source_training_records_seen=13
source_validation_records_seen=2
train_only_scale_manifest_ready_for_preflight=True
fixed_15_record_artifact_training_sufficiency_claim=False
local_target_pytest=9 passed
local_scale_builder_pytest=5 passed
