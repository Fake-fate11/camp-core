...
## Fresh B2 Production Authority Chain and Independent Reviews PASS

Implementation HEAD `a52c1717a471202005c16a0c6777f81ee3bd01e4`
closes the production-entry authority gap without changing maps, scenarios,
models, NI margins, atoms, K8, or the Fresh composition. The controller,
release builder, execution runner, and independent execution reviewer now
consume the independent map and plan reviews as exact roles. Before nonce
consumption they also require the materialized
`signal_complete_suite.json` and `execution_plan.json` byte SHAs to equal the
same payload SHAs independently frozen inside the consolidated pre-open
artifact.

The authoritative AutoDL focused suite passed 35 tests. The static production
chain was then rebuilt from identity zero under the same implementation HEAD:

- map: `/root/autodl-tmp/camp_dp_v25_fresh_b2_signal_maps_a52c1717_20260723TproductionCST`,
  root `186c01ffad95395be053de07f35aa65d2e74e741f110fe220f43a834085c22a7`;
- map review: `/root/autodl-tmp/camp_dp_v25_fresh_b2_signal_maps_review_a52c1717_20260723TproductionCST`,
  root `cede11e2b19edc08dc7fb8d96a94a8d5d2e2968a1c290494a14ae8f720f28441`;
- plan: `/root/autodl-tmp/camp_dp_v25_fresh_b2_signal_plan_a52c1717_20260723TproductionCST`,
  root `60cf5df799a74d947dd0d30aa15ec60c89b5b3da0bfa7277837eb32867423d20`;
- plan review: `/root/autodl-tmp/camp_dp_v25_fresh_b2_signal_plan_review_a52c1717_20260723TproductionCST`,
  root `828f68577b4b02ee09312765613efc68772d7c335e48c62205b0c9ab5f483a19`;
- route/review roots `d2c696ae48c06ca822f0856eb15e7895dba2482d31e08833c57295a68e260b1e`
  and `a3d5fb865ef6e5667a541b33a079c71d990d9d55e1bb062a61766f529f7bfc55`;
- runtime/review roots `08b806ded1cb0f5052ac286ea4409a741609448d63a0baf133fe68051ebd72ca`
  and `3c390a97cb64db186ab5b35429a61b40fc63fe5d29ed0c85687c409306a96076`;
- calibration freeze/review roots
  `295e22adcb6c4840c678f0e1d6ea7725a9786519bf7a856285a008ee0ce4fa80`
  and `8d11c6794925fa99cb24183e0291c4e46f324f5a5ae8460f1bfd8aa8821eb5eb`;
- consolidated pre-open/review roots
  `854883f466835897af2659be04f37b9fa9ad434e1cab223467ccee12f374f7b1`
  and `0f1a5e3eb8e7fb7214ad0344e244165133c84929cade2e7fe74f14b2f2a59bac`.

All roots have `run.exit=0` and exact seals. The external map/plan payload
SHAs equal the pre-open values
`2e238c7d4ea2bac5fd5efd8092de8f1e470941a406c898fcf3e36ac7f5a07f72`
and `6ad99d7dc2cb37a2c33b19af256431e271a2d14b85d6bb228eee0c569400cb5f`.
The critical implementation manifest is
`f9027c014ecfb8555b9bc0b268271bfc80829be24ccb797aefacef4f13070368`.
Candidate0 exact repeatability remains unavailable because all 100 exact-unit
keys are unique; the row SHA remains
`8afeb83f2e1bd5759d645cfabac721f4c3141db60f656e6faac03151d7e187f8`.

Production pre-open free space was `103,446,487,040` bytes. The unchanged
`69,991,287,914`-byte conservative upper bound leaves
`33,455,199,126` bytes projected free and `22,717,780,886` bytes beyond the
10 GiB floor. Fresh remained closed: no nonce, marker, output, model load,
DP/K8 forward, or outcome read occurred. The next action is the real
production-entry zero-data preflight, followed only on PASS by one all-new
nonce and the frozen 1,500-run execution/review/evaluation chain.
...
## Fresh B2 One-Time Opening Failed Closed After Nonce Consumption

The real production-entry zero-data preflight passed before opening. It
strictly reopened all source/review roles, loaded the frozen runtime selector
assets, and returned digest
`d1b7d2681efb68ac62e076250015fa0b701a9a1db58c142aff16c48f03167dac`
without creating a marker, execution output, DP forward, or outcome.

The all-new nonce
`ea744f3d56cff517428a9319dee293d10466c9180a7fb6840eceb7e74426f449`
was then bound to sealed controller root
`e2b7b957a98e0764cb42aea57ed9f6f248bbfde370c060fb547ac69e291a08fc`
and sealed opening release root
`a5a0a8fa119aa76ec7b0c91941346717d898368db04074af98efa1fcf6b0ff10`.
The production entry atomically created the permanent marker before any
outcome-capable operation, as required.

Execution failed closed after exactly one candidate0 native run and before any
complete paired row. `build_fresh_b2_complete_row` rejected the native tick
latency payload with `candidate0 cannot report CAMP-only latency`. The sealed
failure artifact is:

`/root/autodl-tmp/camp_dp_v25_fresh_b2_execution_a52c1717_ea744f3d56cff517`

root
`5d7fe1dc83e1b7e77a006e52f5f8a8b602866aa64ee0a2cdfb882336b0eca50e`,
`run.exit=1`. Its exact manifest has 13 payloads: four top-level control/failure
files and nine run files under the single ordinal
`0000_0_35910aac00fde997_candidate0`. There is no completed paired row,
Static14D or Scene14D arm, independent execution review, evaluation, or
evaluation review.

This is an immutable, evaluation/training/calibration/claim-ineligible failure
diagnostic. The nonce is permanently consumed and
`second_consumption_allowed=false`; no retry, alternate nonce, suffix output,
or result-conditioned continuation is permitted. Worker/GPU are zero, the
shared lock is free, CAMP pointer remains `37a49a3c...`, fixed DP remains
`7a1d33da...`, and live free space is `103,441,956,864` bytes. No safety claim
or Fresh comparison can be made from this incomplete one-arm evidence.
...
## Fresh B3 Generic Production Lifecycle and Replacement Pre-Open Authority

Ultra accepted the preceding B3 package as valid outcome-blind static evidence
but found that its critical implementation did not contain a runnable B3
opening-to-evaluation production chain. The old `45979042...` / `1b6c70b2...`
roots remain immutable static diagnostics and cannot authorize an opening.

Implementation source HEAD
`47886f7e3ea4bc093172d0d59ee238604afc2799` adds the generic/B3 opening
release creator, CAS-consuming executor, independent execution reviewer,
frozen evaluator, and independent evaluation reviewer. The lifecycle preserves
the existing B3 identity, experiment protocol, 500x3x64 denominator, model,
atoms, scales, NI margins, multiplicity, claim/failure rules, fixed DP, K8,
trajectory, and one-time state contract. No real B3 identity CAS, nonce,
marker, output, or outcome was created.

The frozen AutoDL focused suite passed `147` tests. The exact non-Fresh
production-composition lifecycle then exercised one paired unit, all three
arms, 64 ticks per arm, release reserve/consume, execution, independent
execution review, evaluation, and independent evaluation review. It passed and
strictly reopened:

- producer:
  `/root/autodl-tmp/camp_dp_v25_fresh_b3_production_preflight_47886f7e_20260723Tproduction2CST`,
  root
  `b96a41200fab2917723a13cb3bdbb1e26a484163d3c4ae39cf36de6419fcb014`;
- review:
  `/root/autodl-tmp/camp_dp_v25_fresh_b3_production_preflight_review_47886f7e_20260723Tproduction2CST`,
  root
  `9b21d2276b28d1370b9b26bc45beb78b360722502d723a49f3c959813be3b7ce`;
- run.exit:
  `0 / 0`.

From identity0 under the same implementation HEAD, the sole replacement B3
consolidated pre-open authority and independent review passed and strictly
reopened:
...
- holdout identity / experiment protocol:
  `84c3e44f4196e41e0405b72bfc5e5f4883c5dd19e1f522b175c38b1cbe516b2b`
  /
  `686a384da77ff0bd9eaa80411c7f58845225453f2bc84f8b0fd3c40a790da40e`.

Final pre-open control state was CAMP and fixed DP tracked-clean, worker/GPU
zero, shared lock free, and `103,283,118,080` free bytes. Fresh B3 remains
unopened. Only Ultra may issue its one-time opening authority.
...
## 2026-07-23 — Fresh B3 Consumed Engineering Failure Closeout; B4 Recovery

Ultra authorized and opened the one-time Fresh B3 identity
`84c3e44f4196e41e0405b72bfc5e5f4883c5dd19e1f522b175c38b1cbe516b2b`
under protocol
`686a384da77ff0bd9eaa80411c7f58845225453f2bc84f8b0fd3c40a790da40e`.
The CAS reservation was consumed exactly once. Execution then failed
fail-closed at attempted arm 0, candidate0, while projecting the actual native
receipt: `KeyError: candidate_tensor_sha256_before`.

The failure occurred before any arm completed or any paired row formed.
Planned / attempted / complete / unattempted arm counts are
`1500 / 1 / 0 / 1499`; `full_denominator=false`; no outcome field was
consumed. This is a production-composition engineering failure, not a CAMP
scientific result. B3 is permanently ineligible for execution review,
evaluation, pooling, tuning, power, or claims, and its identity, nonce,
directories, maps, routes, semantic blocks, seeds, and protocol cannot be
reused.

The immutable B3 chain strictly reopened:

- controller root:
  `e7b41aac94317d24ef25ab7d5b4c2f82e6b59607c691d4fe7daa28beab78dacb`;
- opening release root:
  `28fd53dd1d04f87b80fc032ebb3c67038c6581c363baafb09a03ab5f64ef7754`;
- sealed fatal execution root:
  `a5250fc1c926973e89c50ebc05dae7e48749940a7cf348f9fcb8404fff034ecf`;
- independent fatal review root:
  `fb4a9ed1869f89a341ad3047dfe0902f7676d17398c9dd86645ef1a42a226e3e`.

The versioned terminal closeout and its independent review were produced
without running DP or reading B3 raw values:
...
`consumed_one_shot_engineering_failure_no_evaluation_no_claim`. AutoDL focused
TDD for the closeout contract passed 11 tests. Local, origin, fresh GitHub
main, and AutoDL were aligned at
`f02f7286621c48cbf257250ae84a147c4b871371`; fixed DP remained
`7a1d33da277a1992ec474b5383a0c963c72e04e4`, tracked clean. Worker/GPU were
zero, the shared lock was free, Fresh B4 remained unopened, and observed free
space was `103,276,781,568` bytes.

B4 engineering recovery is authorized. It must preserve the full scientific
contract while introducing a canonical actual-native candidate0/CAMP receipt
contract, an exact non-Fresh production lifecycle preflight, and a strictly
clone-aware zero-overlap holdout identity and protocol. No B4 CAS, nonce,
marker, opening, execution, outcome, or claim exists at this point.
...
holdout. B4 production RC closed the actual-native receipt ABI and the
production-composition gap without changing fixed DP/K8/trajectory, models,
weights/Theta, atoms/scales, thresholds, NI margins, multiplicity, denominator,
or claim rules.

Per the approved evaluator-only consistency path, the accepted sealed
non-Fresh execution and execution review were reused; no replacement canary,
release, or CAS was created. The deterministic evaluation chain strictly
reopened:
...
The certificate binds role-level dual-HEAD provenance: the execution HEAD,
...
The prospective holdout remains 25 maps, 100
intersections/corridors/routes/semantic blocks, five seeds, 500 paired units,
1,500 arms, and 96,000 ticks. Clone-aware train/calibration/B2/B3/B4
zero-overlap passed with row counts `1500 / 50 / 100 / 100 / 100`.
...
current_v25_b3_claim_authorized=false
...
`7be93df20deee03587b9898e8560909662df972c`; the new critical manifest is
...
`103,398,981,632` bytes; projected free-after is `33,407,693,718` bytes,
`22,670,275,478` bytes above the 10 GiB floor. B4 remains scientifically
...
## 2026-07-25 — Fresh B4 Post-Exposure Evaluation-Control Fatal and Honest-No-Claim Terminal

The accepted one-time execution and independent execution review formed the
full 500-pair, 1,500-arm, 96,000-tick denominator. The frozen evaluation then
failed before artifact creation with
`ValueError: holdout execution/evaluation role HEAD drifted`. The independently
reviewed outcome-blind closeout advanced the scientific CAS exactly once to
`terminal_failure`. No evaluation rerun or review occurred, no raw outcome
value was inspected, and no claim is authorized. The preceding terminal
section, final report, and evidence index contain the complete evidence and
claim boundary.
...
The prior Fresh B4 post-exposure evaluation-control fatal remains sealed and
unchanged. Under the user's prospective correction authority, the dual-HEAD
consumer policy was repaired without inspecting outcomes for policy selection,
without changing the scientific contract, and without rerunning Fresh. The
existing 500-pair/1,500-arm/96,000-tick sealed denominator was reused exactly.

The correction authority, independent authority review, pre-artifact repair
record, corrected evaluation, and its separate-role sealed deterministic
replay using the frozen canonical evaluation core all sealed. The evaluation
review independently binds role, HEAD, provenance, roots, denominator, and
claim equality; it is not a reviewer-local independent statistical
implementation. The separate continuation ledger reached
`independently_reviewed_terminal`; the old scientific ledger remains
`terminal_failure` and was not rewritten.

Frozen corrected results show total SafetyCost improvement for Static14D and
Scene14D, but neither method passes the preregistered conjunction of total,
component-guardrail, and performance/comfort NI gates. Final decision:
`honest_no_claim_under_frozen_preregistered_all_gate`.

current_v25_status=v25_fresh_b4_corrected_evaluation_independently_reviewed_honest_no_claim
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
current_v25_corrected_evaluation_review_head=6e43a625ca0a74dea569926d18fd26f0f7b552c3
fixed_dp_head=7a1d33da277a1992ec474b5383a0c963c72e04e4
current_v25_holdout_identity_sha256=5f2f8e2c2eb90927ec485a8d0baa3935b155e82d90b04fa3d456fc845cd8464a
current_v25_experiment_protocol_sha256=aa79576f8ac487e2ce197c481d57f9c5d350a41d9522096975786207ef76785f
current_v25_execution_plan_sha256=41442dd7d71552972d737d9a9e3d56e9827f864e0c06e11c57487f651206dee0
current_v25_b4_nonce=8680c1b19ce0620b7dc2ec9453ffde0da024d3443e6d6307fc41e87f3dad3b42
current_v25_b4_execution_root_sha256=e1bc886bd4d6d44b9bff703db7bbbfdb5117224bda1c5af5fb6524b0ed759881
current_v25_b4_execution_review_root_sha256=f0afc12a15eba589b5fc63750477b60d0ba9b69cbd22b2e17bd87fadc761d98d
current_v25_b4_correction_authority_root_sha256=b468b5ec04379327db6ca8f736bc2ef249d7b65594891cda1e135bffbbd806f1
current_v25_b4_correction_authority_review_root_sha256=c47ae78fdb7b5df9f050b775c3691b3abe562b7508fad42960c1ea5c9c8afc55
current_v25_b4_correction_repair_root_sha256=f3696e993abd1d28fb2d194234d1b48c3a9b2fef851b7fae6460e2e62b05c027
current_v25_b4_correction_repair_review_root_sha256=e622220157c46ae2a95173ad63699fd0afad03d24a6514edae92c28f746f3583
current_v25_b4_corrected_evaluation_root_sha256=4a817b4bbd17449486e3258c0d4b07102929d5f12d60fa4bb73056eb726afb9f
current_v25_b4_corrected_evaluation_review_root_sha256=94b048ace4a2a539532ccc64fe061afb51bc6b4e23ee2e5a5affd1fc2ef69459
current_v25_b4_old_terminal_closeout_root_sha256=a97af4901ac0627ece1203eaac130f8bf2f10caf6b8bee523555582b2ff3d398
current_v25_b4_old_terminal_closeout_review_root_sha256=86aa7ca12ae8cfa4a655fc55022761a78ac54a3a22ef32a750df9c7eb75d0062
current_v25_b4_old_terminal_reporting_machinery_head=77b735dcb24ed17e5a897f98f430ca1c536d787c
current_v25_b4_old_scientific_ledger_sha256=c3db4fb56f28efda7e3feb762ab0f01954f09983813b442f0a31e7730fbe72e4
current_v25_b4_old_scientific_state=terminal_failure
current_v25_b4_old_scientific_terminal_reason=post_exposure_evaluation_control_fatal
current_v25_b4_old_scientific_diagnostic_preserved=true
current_v25_b4_continuation_cas_key=625fee32ec6600d7d17345ffa5c096f3585ff91537a93f67a66dcda4335f6144
current_v25_b4_continuation_ledger_sha256=727ac337bfbd2bace321d45127c84b5b36d28522750f5e8ba445d1259248c392
current_v25_b4_continuation_state=independently_reviewed_terminal
current_v25_b4_evaluation_review_mode=separate_role_sealed_deterministic_replay_frozen_canonical_evaluation_core
current_v25_b4_reviewer_local_independent_statistical_implementation_claimed=false
current_v25_b4_fresh_execution_reused=true
current_v25_b4_fresh_execution_rerun=false
current_v25_b4_raw_outcome_inspected_before_authority=false
current_v25_b4_pair_count=500
current_v25_b4_complete_arm_count=1500
current_v25_b4_terminal_arm_count=1500
current_v25_b4_tick_count=96000
current_v25_b4_full_denominator_formed=true
current_v25_b4_arm_order_balance_scope=overall_and_per_independent_inference_cluster
current_v25_b4_per_scenario_family_exact_balance_claimed=false
current_v25_b4_latency_summary_source=sealed_corrected_evaluation_summary
current_v25_b4_latency_raw_rows_read_for_reporting=false
current_v25_b4_latency_summary_metrics=mean,median,p95,p99,max
current_v25_b4_latency_summary_stages=dp_operational_default,additional_k8_generation,atoms,context,scene_weight,selector,total_planning
current_v25_b4_candidate0_total_latency_ms=68.800894,68.348749,72.232599,75.897811,518.258393
current_v25_b4_static14d_total_latency_ms=531.782756,518.678487,607.223826,755.545621,993.904560
current_v25_b4_scene14d_total_latency_ms=536.456213,522.531789,613.830395,755.155321,1072.831110
current_v25_b4_latency_checklist_complete=true
current_v25_b4_static14d_total_safetycost_delta=-2.5299346354001058
current_v25_b4_static14d_total_safetycost_ci95=-3.551884242964027,-1.5079850278361844
current_v25_b4_static14d_total_safetycost_btw=280,81,139
current_v25_b4_scene14d_total_safetycost_delta=-1.2135901546149832
current_v25_b4_scene14d_total_safetycost_ci95=-2.132750489352197,-0.29442981987776917
current_v25_b4_scene14d_total_safetycost_btw=227,111,162
current_v25_b4_static14d_component_guardrails_all_passed=false
current_v25_b4_scene14d_component_guardrails_all_passed=false
current_v25_b4_static14d_performance_comfort_ni_all_passed=false
current_v25_b4_scene14d_performance_comfort_ni_all_passed=false
current_v25_b4_static14d_safety_improvement_claim_passed=false
current_v25_b4_scene14d_safety_improvement_claim_passed=false
current_v25_b4_static14d_red_light_claim_passed=false
current_v25_b4_scene14d_red_light_claim_passed=false
current_v25_final_claim_decision=honest_no_claim_under_frozen_preregistered_all_gate
current_v25_final_corrected_report=docs/diffusion_planner_v25_final_corrected_evaluation_report.md
current_v25_final_corrected_report_sha256=f5039098013ea1c2e2e6eb2a1d1ca14c2199b02faf79f3533e5f391b68d745da
current_v25_final_corrected_evidence_index=docs/diffusion_planner_v25_final_corrected_evidence_index.md
current_v25_final_corrected_evidence_index_sha256=e9eff9ecc86078b9672e59bd5b776f8bccdcec1c8e349bedb38db2702846a57b
current_v25_evaluator_reviewer_implementation_focused_test_count=101
current_v25_evaluator_reviewer_implementation_focused_root_sha256=7c01cd9ea5176da889186d3beffec38d6e9ab5d04e40d3fa2b4a47eea8713437
...
## 2026-07-25 - Metric Semantics Amendment Independently Reviewed
...
rewritten; the additive continuation ledger remains
...
current_v25_b4_continuation_ledger_sha256=727ac337bfbd2bace321d45127c84b5b36d28522750f5e8ba445d1259248c392
current_v25_b4_continuation_state=independently_reviewed_terminal
current_v25_metric_semantics_implementation_head=b729ebe4ca34615453a8f7252585bdb5f30d3ac9
current_v25_metric_semantics_schema=camp_dp_v25_metric_semantics_amendment_v1
current_v25_metric_semantics_contract=/root/autodl-tmp/camp_dp_v25_metric_semantics_contract_b729ebe4_8680c1b19ce0620b
current_v25_metric_semantics_contract_root_sha256=318e85f9656a5dd79c9fb0ad6c1dfcd94678b35c4aba455f3909cf3475cca758
current_v25_metric_semantics_contract_review=/root/autodl-tmp/camp_dp_v25_metric_semantics_contract_review_b729ebe4_8680c1b19ce0620b
current_v25_metric_semantics_contract_review_root_sha256=fc04fd6e45487df6c9bf5313b9ee6d633f91303e0a1aa00f0a3114b8134fea95
current_v25_metric_semantics_amendment=/root/autodl-tmp/camp_dp_v25_metric_semantics_amendment_b729ebe4_8680c1b19ce0620b
current_v25_metric_semantics_amendment_root_sha256=99fd5e571160a3ac3d5bb2b6d6f3391c3da5965bf592707ff85c88080ac2dbcf
current_v25_metric_semantics_amendment_review=/root/autodl-tmp/camp_dp_v25_metric_semantics_amendment_review_b729ebe4_8680c1b19ce0620b
current_v25_metric_semantics_amendment_review_root_sha256=88b35ab8ef51807c848200675ceeebe6b26e15a4f4b34da51f131e9303f37898
current_v25_metric_semantics_implementation_focused=/root/autodl-tmp/camp_dp_v25_metric_semantics_focused_b729ebe4_8680c1b19ce0620b
current_v25_metric_semantics_implementation_focused_root_sha256=896fa3858a427462ecd4d3b206208605864fb34f3a4a5dd43ca723ec30445e95
current_v25_metric_semantics_implementation_focused_test_count=31
current_v25_metric_semantics_sealed_execution_read_only=true
current_v25_metric_semantics_sealed_source_artifacts_written=false
current_v25_metric_semantics_scientific_or_continuation_cas_written=false
current_v25_metric_semantics_filtered_samples_per_run=52
current_v25_metric_semantics_per_run_before_pair_and_cluster=true
current_v25_metric_semantics_new_ni_or_claim_gate=false
current_v25_metric_semantics_safetycost_class=benchmark-only
current_v25_metric_semantics_collision_class=benchmark-only
current_v25_metric_semantics_near_miss_class=FAIL-industrial
current_v25_metric_semantics_offroad_class=FAIL-industrial
current_v25_metric_semantics_wrong_way_class=FAIL-industrial
current_v25_metric_semantics_red_light_source_class=PASS
current_v25_metric_semantics_red_light_aggregate_class=benchmark-only
current_v25_metric_semantics_speed_class=benchmark-only
current_v25_metric_semantics_progress_completion_class=benchmark-only
current_v25_metric_semantics_jerk_class=FAIL-industrial
current_v25_metric_semantics_lateral_acceleration_class=FAIL-industrial
current_v25_metric_semantics_maximum_deceleration_class=FAIL-industrial
current_v25_metric_semantics_latency_measurement_class=benchmark-only
current_v25_metric_semantics_online_production_readiness_class=FAIL-industrial
current_v25_metric_semantics_clustered_statistics_class=PASS
current_v25_metric_semantics_full_polygon_offroad_class=evidence-missing
current_v25_metric_semantics_occupant_seat_vertical_comfort_class=evidence-missing
current_v25_metric_semantics_industrial_occupant_comfort_status=evidence_missing_not_assessed
current_v25_metric_semantics_performance_ni_scope=project_benchmark_progress_completion
current_v25_metric_semantics_legacy_comfort_fields_scope=raw_diagnostics_not_industrial_comfort
current_v25_b4_evaluation_review_mode=separate_role_sealed_deterministic_replay_frozen_canonical_evaluation_core
current_v25_b4_reviewer_local_independent_statistical_implementation_claimed=false
current_v25_b4_fresh_execution_reused=true
current_v25_b4_fresh_execution_rerun=false
...
current_v25_final_corrected_evidence_index=docs/diffusion_planner_v25_final_corrected_evidence_index.md
current_v25_final_corrected_evidence_index_sha256=e9eff9ecc86078b9672e59bd5b776f8bccdcec1c8e349bedb38db2702846a57b
current_v25_metric_semantics_report=docs/diffusion_planner_v25_metric_semantics_amendment_report.md
current_v25_metric_semantics_report_sha256=eb1d7da3c1b85ce1d0c158c4c5c57cd7979e7353e178f359a10b1e40c814dcda
current_v25_metric_semantics_evidence_index=docs/diffusion_planner_v25_metric_semantics_amendment_evidence_index.md
current_v25_metric_semantics_evidence_index_sha256=8bb1e87c9b9d13631d6aaeebab149d87426552a5aea003cc88b97869dba9a337
current_v25_evaluator_reviewer_implementation_focused_test_count=101
current_v25_evaluator_reviewer_implementation_focused_root_sha256=7c01cd9ea5176da889186d3beffec38d6e9ab5d04e40d3fa2b4a47eea8713437
current_v25_final_package_focused_test_count=102
current_v25_final_package_focused_root_sha256=58c241ec562a570c72f3d96bc2b85e32079f367e9d9d2e30e2835b20e49f8205
...
## 2026-07-25 - Evaluation v2 Independently Reviewed Exploratory Honest No-Claim
...
## 2026-07-25 - Fair-Pool Adaptation Contract v4 Provenance Fail-Closed, Acquisition Unauthorized

Reader contract: this named section is the only current V25 pointer source in
this file. Its machine tuple must match the EOF tuple in
`docs/diffusion_planner_v25_iteration_audit.md` field for field.

The fixed Diffusion Planner passed a development/nonholdout capability
qualification: one actual `Diffusion_Planner.forward(inputs)` invocation
generated a finite, diverse same-ego K=8 pool. The operational default remains
`batch_size=1`, so this is a newly qualified capability rather than evidence
that the prior operational path already supplied same-invocation K=8.
...
candidate0, Static14D, and Scene14D consumed one shared immutable K=8 pool per
state. All 48 real selector receipts passed the post-pool zero-call gate.

The unique Fresh B4 execution remains fixed at 500 paired units, 1,500
complete arms, and 96,000 ticks. It is additively classified as
`compute_augmented_candidate_expansion_plus_reranking`, because rows 1-7 came
from seven additional sequential calls. Fresh, arms, DP/K8, corrected legacy
evaluation/review, Evaluation v2, sealed diagnostics, and both ledgers were
not rerun or written.
...
The pool-adaptation audit triggered its frozen programmatic hard stop.
Same-ego trajectories were equivalent for 128/128 rows, while neighbor
tensors were equivalent for 114/128 rows across 9/16 affected states. The old
contract classified any neighbor row outside tolerance as a stop, so
compute-matched closed-loop did not start: 0/3 arms and 0/192 ticks.

The additive sealed-preimage summary and its independent literal review
reconstructed all 1,792 atom differences, 128 score differences per CAMP arm,
both K8 validity sets, masks, selection flips, and the exhaustive taxonomy.
Primary and sequential K8 were finite/diverse for 16/16 states; Static and
Scene each had 0/16 selected-index flips. The primary taxonomy is
`neighbor_tolerance=9`, `no_failure=7`, and zero for all other classes.

The scientific classification is
`overconservative_equivalence_contract_triggered; functional adaptation risk
unresolved`. The trigger proves only that the frozen neighbor-tolerance rule
fired, not architecture/model failure, training-distribution/OOD drift, or a
need to retrain. Reverse functional evidence remains 128/128 trajectory rows,
16/16 mask-equal states, and 16/16 selected-index equality for both arms. The
old `possible_training_pool_adaptation_required=true` value is a preserved
legacy overconservative contract field, not a scientific conclusion.

The fail-closed v4 fair-pool adaptation contract and separate-role independent
literal review are now sealed. v4 preserves the v3 deterministic source-scene,
exact manifest, B4 exact-byte inventory, and 83-key phase topology, then closes
the remaining qualification-provenance gap. A future consumer must receive an
out-of-band High trust-anchor root that pins ten exact producer/reviewer
artifacts. It revalidates the full preflight, rebuilds all 64-state calibration
statistics and 73 frozen thresholds before validation, and derives validation
numeric/hard evidence from bound run, pair, candidate-tensor, pool, and
selector receipts. It accepts no package-created authority, free threshold,
naked hard PASS, caller PASS status, or within-mode boolean.

The scope remains explicitly one map, one route and four density tiers.
Actual input/state/latent manifests remain future preflight evidence and their
materialization count is zero. Acquisition is unauthorized and every
calibration, repeat-model, pool, selector, closed-loop, Fresh, holdout and
training run count is zero. The v1-v3 roots remain sealed as superseded
pre-acquisition diagnostics.
...
current_v25_status=v25_fair_pool_adaptation_contract_v4_provenance_fail_closed_acquisition_unauthorized_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_final_package_focused_root_sha256=58c241ec562a570c72f3d96bc2b85e32079f367e9d9d2e30e2835b20e49f8205
local_origin_github_autodl_aligned=true
current_v25_evaluation_v2_contract_schema=camp_dp_v25_evaluation_v2_contract_v3
current_v25_evaluation_v2_result_semantics=exploratory_posthoc_not_claim_authorizing
current_v25_evaluation_v2_producer_head=ee04c1ee3226684ba85f66f6e75566b82e871c77
current_v25_evaluation_v2_reviewer_head=ee04c1ee3226684ba85f66f6e75566b82e871c77
current_v25_evaluation_v2_prefreeze_focused=/root/autodl-tmp/camp_dp_v25_evaluation_v2_second_correction_prefreeze_focused_ee04c1ee_8680c1b19ce0620b
current_v25_evaluation_v2_prefreeze_focused_root_sha256=d87d54009088ad5b60fd299c962950c884bae9ea928d0ba86f0972021936cbd7
current_v25_evaluation_v2_prefreeze_passed=110
current_v25_evaluation_v2_prefreeze_skipped=2
current_v25_evaluation_v2_contract=/root/autodl-tmp/camp_dp_v25_evaluation_v2_corrected_contract_ee04c1ee_8680c1b19ce0620b
current_v25_evaluation_v2_contract_root_sha256=99501763a4a88c9d80fff738054b37593717df0b6d33e3749ad451d9e52a15e0
current_v25_evaluation_v2_contract_review=/root/autodl-tmp/camp_dp_v25_evaluation_v2_corrected_contract_review_ee04c1ee_8680c1b19ce0620b
current_v25_evaluation_v2_contract_review_root_sha256=a7ba686647ccfe64f45a3304a00a392c1a362534833023fe26e0343a374bfac0
current_v25_evaluation_v2_materialization=/root/autodl-tmp/camp_dp_v25_evaluation_v2_corrected_materialization_ee04c1ee_8680c1b19ce0620b
current_v25_evaluation_v2_materialization_root_sha256=4fffc63bbeef6c2f6c0f26d8fb8b5af2842ad6e8c998a0ed04342aff73134941
current_v25_evaluation_v2_reviewer_repair_focused=/root/autodl-tmp/camp_dp_v25_evaluation_v2_reviewer_repair_focused_7c3e67c6_8680c1b19ce0620b
current_v25_evaluation_v2_reviewer_repair_focused_root_sha256=e218de63613459a35a3339080aa296935dcf0c582f284bbcbb6c0d1dea3a9214
current_v25_evaluation_v2_review=/root/autodl-tmp/camp_dp_v25_evaluation_v2_corrected_materialization_review_ee04c1ee_8680c1b19ce0620b
current_v25_evaluation_v2_review_root_sha256=e1df26f72402745aa68041a068b347b6fd1dad1abe9ed173baf05571c666427b
current_v25_evaluation_v2_pair_count=500
current_v25_evaluation_v2_arm_count=1500
current_v25_evaluation_v2_tick_count=96000
current_v25_evaluation_v2_cluster_count=100
...
current_v25_evaluation_v2_speed_available_arms=1500
current_v25_evaluation_v2_route_status=evidence_missing
current_v25_evaluation_v2_route_available_arms=929
current_v25_evaluation_v2_route_missing_arms=571
current_v25_evaluation_v2_route_missing_reason=565_no_unique_feasible_path_and_6_multiple_equal_cost_paths
current_v25_evaluation_v2_body_proxy_status=benchmark_only
current_v25_evaluation_v2_body_proxy_available_arms=1500
current_v25_evaluation_v2_latency_status=benchmark_only
current_v25_evaluation_v2_latency_available_arms=1500
...
current_v25_evaluation_v2_initial_review_artifact_created=false
current_v25_evaluation_v2_aggregate_summary=docs/diffusion_planner_v25_evaluation_v2_aggregate_summary.json
current_v25_evaluation_v2_aggregate_summary_sha256=ca6a911d9d1f98ad5b73eaec43fc23c36ed81edc4003b436e6ca7765401d3680
current_v25_evaluation_v2_report=docs/diffusion_planner_v25_evaluation_v2_report.md
current_v25_evaluation_v2_report_sha256=37d1bae6ee4950c3dbe747ba5b1e91a826a9d8060c3fdd4a6e350ed7a83759ee
current_v25_evaluation_v2_evidence_index=docs/diffusion_planner_v25_evaluation_v2_evidence_index.md
current_v25_evaluation_v2_evidence_index_sha256=5bea094f5fc9021d7f49b111bca90a24cb5a3652d865dcce13671d5ed793a402
current_v25_evaluation_v2_migration_matrix=docs/diffusion_planner_v25_evaluation_v2_migration_matrix.md
...
current_v25_phase=fair_pool_adaptation_contract_v4_provenance_executability_and_independent_literal_review_complete_no_acquisition
...
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
current_v25_evaluation_v2_superseded_review_root_sha256=d1cfb29dbb34e3bb92592f803820a6a0454af89b3b9fc2100b45cbaf8215f91d
current_v25_evaluation_v2_btw_semantics=500_paired_units_better_tie_worse
current_v25_evaluation_v2_btw_tie_rule=exact_zero_delta
current_v25_evaluation_v2_cluster_ci_semantics=100_equal_mass_clusters_student_t
current_v25_evaluation_v2_variance_fields_are_btw=false
current_v25_evaluation_v2_ttc_prediction_horizon_s=5.0
current_v25_evaluation_v2_ttc_requires_centroid_approach=true
current_v25_evaluation_v2_ego_velocity_source=same_tick_scalar_speed_times_heading_kinematic_reconstruction
current_v25_evaluation_v2_goal_status=benchmark_only
current_v25_evaluation_v2_goal_available_arms=1500
current_v25_evaluation_v2_road_signed_boundary_status=benchmark_only
current_v25_evaluation_v2_road_signed_boundary_source=deterministic_external_boundary_of_root_bound_polygon_union
current_v25_evaluation_v2_road_internal_seams_are_boundary=false
current_v25_evaluation_v2_actual_scalar_path_direction_count=180
current_v25_evaluation_v2_scalar_path_direction_coverage=exhaustive_exactly_once_unknown_fail_closed
current_v25_evaluation_v2_superseded_corrected_contract_root_sha256=ab99f6740038136409b9f131c8bd38dd35b1b19c338e85c4df6ba86b25f59306
current_v25_evaluation_v2_superseded_corrected_contract_review_root_sha256=0962b233a2a0391649433233bd4e7fcbd688ddedc28f2d25fa5cf4eda9354628
current_v25_evaluation_v2_superseded_corrected_materialization_root_sha256=3a4575f346188d87c4c3c18e4cc817540eac09aa38cd0cf886628c3013402588
current_v25_evaluation_v2_superseded_corrected_review_root_sha256=372550201df3f62907d7fe247cb9889cecfa2abef91ab7db425613f70c816827
current_v25_target_architecture_classification=compute_augmented_candidate_expansion_plus_reranking
current_v25_target_architecture_operational_default_batch_size=1
current_v25_target_architecture_amendment=/root/autodl-tmp/camp_dp_v25_target_architecture_amendment_2cf030a6_8680c1b19ce0620b
current_v25_target_architecture_amendment_root_sha256=3cfba03b2fd21cfa068610f8989f0c2b1df890cf64f6b1ac4b10eae67e291c7b
current_v25_target_architecture_amendment_review=/root/autodl-tmp/camp_dp_v25_target_architecture_amendment_review_2cf030a6_8680c1b19ce0620b
current_v25_target_architecture_amendment_review_root_sha256=202461e5045bba42cb10ad7bbdb03c36b82c00defce2df60edd6a971d1d2fd8f
current_v25_target_architecture_capability=/root/autodl-tmp/camp_dp_v25_same_ego_k8_capability_2cf030a6_8680c1b19ce0620b
current_v25_target_architecture_capability_root_sha256=fa94808c70ce1953d50b52497f9c4d056dabccd96e3ffdaed84faead5f2ed8e6
current_v25_target_architecture_capability_review=/root/autodl-tmp/camp_dp_v25_same_ego_k8_capability_review_303dbb71_8680c1b19ce0620b
current_v25_target_architecture_capability_review_root_sha256=cb9f4efd5d72962513ea83777a68f3ffa5455fd731bc1cc5859b407cd9d25ac1
current_v25_target_architecture_implementation_focused=/root/autodl-tmp/camp_dp_v25_target_architecture_qualification_focused_303dbb71_8680c1b19ce0620b
current_v25_target_architecture_implementation_focused_root_sha256=47c099f78986b21f0fb116d1989d41fdc96a001859a4e14a860e94f33b533ba1
current_v25_target_architecture_implementation_focused_passed=52
current_v25_target_architecture_implementation_focused_skipped=2
current_v25_target_architecture_capability_status=passed_development_nonholdout_same_ego_single_invocation_k8_capability
current_v25_target_architecture_candidate_axis=same_ego_candidate_batch
current_v25_target_architecture_agent_as_ego_batch=false
current_v25_target_architecture_source_batch_size=1
current_v25_target_architecture_expanded_model_batch_size=8
current_v25_target_architecture_model_call_count=1
current_v25_target_architecture_output_shape=8x80x4
current_v25_target_architecture_output_dtype=float32
current_v25_target_architecture_output_finite=true
current_v25_target_architecture_unique_row_sha_count=8
current_v25_target_architecture_candidate_tensor_sha256=02685eb0edfd0eb89e358bd8d75a7e64465a60b280484cd6c767ab1a084d4d72
current_v25_target_architecture_pool_id=975404af834e18b076a8e1a88c46fdff4ca2d1dfd50f9396907963bb02750e90
current_v25_target_architecture_forward_invocation_id=22b8cec0cb500e2c6cfb6c0ce96a3d483991b3241716a8f21b65bd59ed062223
current_v25_target_architecture_input_sha256=a6f524c6ca381ca89f915dc10f2fbd8427a952137b1dbc06f628670db1640832
current_v25_target_architecture_state_sha256=ccb52028b49d73fede25b3ec3c3b7fb9d848759383628068c84c761d078fabfe
current_v25_target_architecture_latent_sha256=9f40a00d7456c1aed377398d15ffe146116b9883154bfe88b7a45e0cb34bdd5a
current_v25_target_architecture_deterministic_exact=true
current_v25_target_architecture_batch_vs_sequential_within_tolerance=true
current_v25_target_architecture_batch_vs_sequential_atol=1e-5
current_v25_target_architecture_batch_vs_sequential_rtol=1e-5
current_v25_target_architecture_batch_vs_sequential_max_abs_error=3.814697265625e-05
current_v25_target_architecture_selector_model_calls_after_pool=0
current_v25_target_architecture_selector_latent_replacements_after_pool=0
current_v25_target_architecture_selector_trajectory_generations_after_pool=0
current_v25_target_architecture_selector_probe_is_camp_score_evaluation=false
current_v25_target_architecture_fresh_or_holdout_accessed=false
current_v25_target_architecture_closed_loop_executed=false
current_v25_target_architecture_training_executed=false
current_v25_target_architecture_scientific_effect_claim_authorized=false
current_v25_target_architecture_report=docs/diffusion_planner_v25_target_architecture_qualification_report.md
current_v25_target_architecture_report_sha256=63fd201105b828b900588208d89b253cb960e3cd6501b2e661045a1a727f780e
current_v25_target_architecture_evidence_index=docs/diffusion_planner_v25_target_architecture_evidence_index.md
current_v25_target_architecture_evidence_index_sha256=a444277420402979ee2331f071e1d8a5c3c8654346de5d0cde3dac169da49b63
current_v25_target_architecture_fairness_contract_draft=docs/diffusion_planner_v25_layered_fairness_contract_draft.md
current_v25_target_architecture_fairness_contract_draft_sha256=8b78cdc7e9a4b96cddaa8fba76b8619b6a1dc5bd72761d5feaa49f43e6fbe4e7
current_v25_fair_nonholdout_contract_schema=camp_dp_v25_fair_nonholdout_contract_v1
current_v25_fair_nonholdout_generator_name=new_single_invocation_batched_k8_candidate_pool
current_v25_fair_nonholdout_contract=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_contract_b7cd48b3_8680c1b19ce0620b
current_v25_fair_nonholdout_contract_root_sha256=480981070d1a08b1980fdf43d1f7b84eb1030c6e2742e055edff87b8825c5603
current_v25_fair_nonholdout_contract_review=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_contract_review_b7cd48b3_8680c1b19ce0620b
current_v25_fair_nonholdout_contract_review_root_sha256=74d45468aefb483bb73e316557d756c3899257ae35dd743979c48b539d99c93d
current_v25_fair_nonholdout_validation=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_validation_8d84e46c_8680c1b19ce0620b
current_v25_fair_nonholdout_validation_root_sha256=29688aa7ff4eb5edf43ca2379063f45228faedea80a7a3245e07aba297cc9dfd
current_v25_fair_nonholdout_validation_review=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_validation_hard_stop_review_3f440445_8680c1b19ce0620b
current_v25_fair_nonholdout_validation_review_root_sha256=0ea09a3330fbc8eaae74be3f30114d1f0a746cd8b13adee3d839b8ad17f086c8
current_v25_fair_nonholdout_focused=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_hard_stop_focused_3f440445_8680c1b19ce0620b
current_v25_fair_nonholdout_focused_root_sha256=2fc9cd4c5a86ab01afce93f4375c2362cc07b104d7cb1efabbf8a7e1f384a59c
current_v25_fair_nonholdout_focused_test_count=136
current_v25_fair_nonholdout_adaptation_summary_schema=camp_dp_v25_fair_nonholdout_adaptation_summary_v1
current_v25_fair_nonholdout_adaptation_summary=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_adaptation_summary_d74b012e_8680c1b19ce0620b
current_v25_fair_nonholdout_adaptation_summary_root_sha256=d2bf378bb02976490c1527f6cc49e59ac26e521db9fb1b82792ecc04ea3cd228
current_v25_fair_nonholdout_adaptation_summary_review=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_adaptation_summary_review_d74b012e_8680c1b19ce0620b
current_v25_fair_nonholdout_adaptation_summary_review_root_sha256=f54e03e0b3052d37ae9a353cad9182c2e5c85338d48485674a7da1b0c01ee1b9
current_v25_fair_nonholdout_adaptation_summary_focused=/root/autodl-tmp/camp_dp_v25_fair_nonholdout_adaptation_summary_focused_d74b012e_8680c1b19ce0620b
current_v25_fair_nonholdout_adaptation_summary_focused_root_sha256=2c9c6238c8eb26eddd02efd2437a517f657daefad69d358b89cee958e4215ef2
current_v25_fair_nonholdout_adaptation_summary_focused_test_count=143
current_v25_fair_nonholdout_adaptation_summary_implementation_head=d74b012e1dec7df67ba852c482fb3866ed759396
current_v25_fair_nonholdout_contract_implementation_head=b7cd48b3fb2a0c11228403c8804b066e566f8d14
current_v25_fair_nonholdout_validation_head=8d84e46c656b0b1f83f8881cd17540e65d96370a
current_v25_fair_nonholdout_reviewer_head=3f440445c2d56041760b37dfee5cbf01493356df
current_v25_fair_nonholdout_status=overconservative_equivalence_contract_triggered_functional_adaptation_risk_unresolved
current_v25_fair_nonholdout_state_count=16
current_v25_fair_nonholdout_authoritative_pool_count=16
current_v25_fair_nonholdout_real_selector_receipt_count=48
current_v25_fair_nonholdout_trajectory_equivalent_rows=128
current_v25_fair_nonholdout_trajectory_row_denominator=128
current_v25_fair_nonholdout_neighbor_equivalent_rows=114
current_v25_fair_nonholdout_neighbor_row_denominator=128
current_v25_fair_nonholdout_substantive_drift_state_count=9
current_v25_fair_nonholdout_batch8_repeat_exact_states=16
current_v25_fair_nonholdout_masks_equal_states=16
current_v25_fair_nonholdout_static_selected_index_equal_states=16
current_v25_fair_nonholdout_scene_selected_index_equal_states=16
current_v25_fair_nonholdout_post_pool_forbidden_call_count=0
current_v25_fair_nonholdout_candidate_tensor_mutation_count=0
current_v25_fair_nonholdout_closed_loop_entry_conditions_passed=false
current_v25_fair_nonholdout_closed_loop_started=false
current_v25_fair_nonholdout_closed_loop_arm_count=0
current_v25_fair_nonholdout_closed_loop_tick_count=0
current_v25_fair_nonholdout_training_executed=false
current_v25_fair_nonholdout_legacy_possible_training_pool_adaptation_required=true
current_v25_fair_nonholdout_legacy_possible_training_pool_adaptation_field_scope=overconservative_contract_field_not_scientific_conclusion
current_v25_fair_nonholdout_functional_adaptation_risk=unresolved
current_v25_fair_nonholdout_hard_stop_proves_only_neighbor_tolerance_rule_triggered=true
current_v25_fair_nonholdout_batch8_architecture_failure_proven=false
current_v25_fair_nonholdout_model_failure_proven=false
current_v25_fair_nonholdout_training_distribution_or_ood_drift_proven=false
current_v25_fair_nonholdout_retraining_required_proven=false
current_v25_fair_nonholdout_selector_functional_selection_drift_observed=false
current_v25_fair_nonholdout_atom_exact_equal_count=977
current_v25_fair_nonholdout_atom_value_denominator=1792
current_v25_fair_nonholdout_atom_global_max_abs_diff=1.2076380426831292
current_v25_fair_nonholdout_static_score_exact_equal_count=0
current_v25_fair_nonholdout_static_score_value_denominator=128
current_v25_fair_nonholdout_static_score_global_max_abs_diff=3.999504226261032e-06
current_v25_fair_nonholdout_scene_score_exact_equal_count=0
current_v25_fair_nonholdout_scene_score_value_denominator=128
current_v25_fair_nonholdout_scene_score_global_max_abs_diff=3.400720101572746e-05
current_v25_fair_nonholdout_primary_k8_valid_states=16
current_v25_fair_nonholdout_sequential_k8_valid_states=16
current_v25_fair_nonholdout_primary_taxonomy_neighbor_tolerance_states=9
current_v25_fair_nonholdout_primary_taxonomy_no_failure_states=7
current_v25_fair_nonholdout_primary_taxonomy_all_other_states=0
current_v25_fair_nonholdout_retraining_decision_authorized=false
current_v25_fair_nonholdout_fresh_or_holdout_accessed=false
current_v25_fair_nonholdout_old_artifact_or_cas_written=false
current_v25_fair_nonholdout_claim_authorized=false
current_v25_fair_nonholdout_report=docs/diffusion_planner_v25_fair_nonholdout_qualification_report.md
current_v25_fair_nonholdout_report_sha256=2a36298a10227f8c0d558b7529c3f02a304b836b8ae19609cdaedeede12001fa
current_v25_fair_nonholdout_evidence_index=docs/diffusion_planner_v25_fair_nonholdout_evidence_index.md
current_v25_fair_nonholdout_evidence_index_sha256=1d647da4baa67013e20b7f39abf6455e39fb9654838389fa173c575915de2ffd
current_v25_fair_pool_adaptation_contract_schema=camp_dp_v25_fair_pool_adaptation_contract_v4
current_v25_fair_pool_adaptation_contract_implementation_head=726d68343770cab44c8b8bf790c670d7ed1270a6
current_v25_fair_pool_adaptation_contract_payload_sha256=04cc1e685c61b6c1a5fe391b1fd1dbed4af07494a50e485b610389fca453cc6c
current_v25_fair_pool_adaptation_contract=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_contract_v4_726d6834_8680c1b19ce0620b
current_v25_fair_pool_adaptation_contract_root_sha256=69bd196a91cea572484ca28b044966acd3ad85b868409d1907bec99a6ea0af47
current_v25_fair_pool_adaptation_contract_review=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_contract_v4_review_726d6834_8680c1b19ce0620b
current_v25_fair_pool_adaptation_contract_review_root_sha256=2611ac2322f124daa1f1134e662447c5823cef0db88a9e12fb04abdc0561f954
current_v25_fair_pool_adaptation_contract_focused=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_contract_v4_focused_726d6834_8680c1b19ce0620b
current_v25_fair_pool_adaptation_contract_focused_root_sha256=ad7056c6a83ca9098454d301bab1e0ef8e9892cce9c2da061018a345a1a846e8
current_v25_fair_pool_adaptation_contract_focused_test_count=57
current_v25_fair_pool_adaptation_calibration_manifest_sha256=569718077a1c6c7f5193074ba86e646da4a3a40a2fdc573c7bfa51f3cfaa722f
current_v25_fair_pool_adaptation_validation_manifest_sha256=8b502332c14f98feb95df5db6016bb5deab949e1fe1a1d4c3e3671f7f66d5a9b
current_v25_fair_pool_adaptation_calibration_state_count=64
current_v25_fair_pool_adaptation_validation_state_count=64
current_v25_fair_pool_adaptation_independent_statistical_unit=state
current_v25_fair_pool_adaptation_rows_ticks_role=within_state_observations_only
current_v25_fair_pool_adaptation_within_mode_repeat_count=5
current_v25_fair_pool_adaptation_within_mode_pair_count=10
current_v25_fair_pool_adaptation_quantile=0.99
current_v25_fair_pool_adaptation_quantile_method=higher
current_v25_fair_pool_adaptation_confidence_method=deterministic_nonparametric_state_bootstrap_percentile_upper
current_v25_fair_pool_adaptation_confidence_level=0.95
current_v25_fair_pool_adaptation_bootstrap_resamples=10000
current_v25_fair_pool_adaptation_validation_max_exceedance_count=2_of_64
current_v25_fair_pool_adaptation_clopper_pearson_confidence=0.95
current_v25_fair_pool_adaptation_endpoint_count=37
current_v25_fair_pool_adaptation_phase_result_key_count=83
current_v25_fair_pool_adaptation_provenance_numeric_key_count=73
current_v25_fair_pool_adaptation_provenance_trusted_artifact_root_count=10
current_v25_fair_pool_adaptation_provenance_high_control_task=019f92d8-c971-7b13-924e-873ae9f24c14
current_v25_fair_pool_adaptation_provenance_external_anchor_required=true
current_v25_fair_pool_adaptation_provenance_full_preflight_revalidation=true
current_v25_fair_pool_adaptation_provenance_threshold_freeze_before_validation=true
current_v25_fair_pool_adaptation_provenance_thresholds_recomputed=true
current_v25_fair_pool_adaptation_provenance_run_receipts_per_split=640
current_v25_fair_pool_adaptation_provenance_pair_receipts_per_split=1600
current_v25_fair_pool_adaptation_provenance_candidate_tensor_shape=8x80x4
current_v25_fair_pool_adaptation_provenance_package_created_authority_accepted=false
current_v25_fair_pool_adaptation_provenance_naked_hard_or_threshold_accepted=false
current_v25_fair_pool_adaptation_scope=single_route_single_map_bounded_development_nonholdout_four_density_tiers_only
current_v25_fair_pool_adaptation_sampler_sha256=e603e2236ae77f33cb02e9de4b7c8b54f5f9977a2dae49f4574a327004ad7a85
current_v25_fair_pool_adaptation_input_manifest_schema=camp_dp_v25_fair_pool_input_only_manifest_v2
current_v25_fair_pool_adaptation_source_scene_schema=camp_dp_v25_fair_pool_deterministic_source_scene_v1
current_v25_fair_pool_adaptation_preflight_receipt_schema=camp_dp_v25_fair_pool_input_only_preflight_receipt_v2
current_v25_fair_pool_adaptation_b4_rederived_inside_validator=true
current_v25_fair_pool_adaptation_caller_status_or_within_boolean_accepted=false
current_v25_fair_pool_adaptation_b4_prepared_input_sha256=e67fee3309f822c80605b3e9b00009d2ae3e27139e36396d009b9a2b306535a2
current_v25_fair_pool_adaptation_b4_forbidden_clone_key_count_required=100
current_v25_fair_pool_adaptation_actual_input_manifest_materialization_count=0
current_v25_fair_pool_adaptation_unknown_or_omitted_endpoint_policy=fail_closed
current_v25_fair_pool_adaptation_reviewer_local_semantic_oracle=true
current_v25_fair_pool_adaptation_reviewer_payload_pin_additive=true
current_v25_fair_pool_adaptation_single_float_1e_5_veto=false
current_v25_fair_pool_adaptation_legacy_hard_stop_preserved=true
current_v25_fair_pool_adaptation_functional_risk=unresolved
current_v25_fair_pool_adaptation_acquisition_authorized=false
current_v25_fair_pool_adaptation_calibration_run_count=0
current_v25_fair_pool_adaptation_repeat_model_run_count=0
current_v25_fair_pool_adaptation_pool_run_count=0
current_v25_fair_pool_adaptation_selector_run_count=0
current_v25_fair_pool_adaptation_closed_loop_run_count=0
current_v25_fair_pool_adaptation_fresh_run_count=0
current_v25_fair_pool_adaptation_holdout_run_count=0
current_v25_fair_pool_adaptation_training_run_count=0
current_v25_fair_pool_adaptation_claim_authorized=false
current_v25_fair_pool_adaptation_v1_contract_root_sha256=b2de5b71509526407e102b3ba3aec74000290f13ab75918d0008596a6b52f824
current_v25_fair_pool_adaptation_v1_contract_review_root_sha256=a16a523766493826d6b5b3f4e0a8188a1019571e4491a53e3149af2bb408aa37
current_v25_fair_pool_adaptation_v1_scope=superseded_preacquisition_diagnostic
current_v25_fair_pool_adaptation_v2_contract_root_sha256=f2314088f25c601ae80fa022dd0b4a513c29d07a54b7008c17ec0c75fbd1b81e4bc5a7ec
current_v25_fair_pool_adaptation_v2_contract_review_root_sha256=ca0bd63c057f0e58dc88d278c4f45b713f93b408b22ab33c122dfa4567ecab6b
current_v25_fair_pool_adaptation_v2_scope=superseded_preacquisition_diagnostic
current_v25_fair_pool_adaptation_v3_contract_root_sha256=4365d56f0a7faa3bc73035fa731f3985ceff601c17ec0c75fbd1b81e4bc5a7ec
current_v25_fair_pool_adaptation_v3_contract_review_root_sha256=5f64756e952be9b502e4b40f8acf1f40e83cef3219858ab9ea5835e78f05d1e1
current_v25_fair_pool_adaptation_v3_scope=superseded_preacquisition_diagnostic
current_v25_fair_pool_adaptation_report=docs/diffusion_planner_v25_fair_pool_adaptation_contract_v4_report.md
current_v25_fair_pool_adaptation_report_sha256=6bbc075c83f97487f70a7be4a58255fc0f6d570d72090744f9de8ba8c3bd97d7
current_v25_fair_pool_adaptation_evidence_index=docs/diffusion_planner_v25_fair_pool_adaptation_contract_v4_evidence_index.md
current_v25_fair_pool_adaptation_evidence_index_sha256=bcfbdc4962e5234b5198573c1f7433c831c8b672b836e8103614f840848504a6
next_work_target=high_fair_pool_adaptation_contract_v4_provenance_review_before_any_acquisition

## 2026-07-25 - Fair-Pool Adaptation Contract v5 Raw Numeric Semantics Fail-Closed, Acquisition Unauthorized

This additive, outcome-independent v5 contract preserves every v4 and
earlier sealed artifact while making all 73 numeric phase values exact
derived caches of 1,280 future typed raw semantic run receipts. Producer
and separate-role reviewer independently reconstruct array bytes,
forward/pool/selector bindings, endpoint formulas, state q99 values and
thresholds. No acquisition or scientific execution occurred.
...
current_v25_status=v25_fair_pool_adaptation_contract_v5_raw_numeric_semantics_fail_closed_acquisition_unauthorized_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_evaluation_v2_future_plan=docs/diffusion_planner_v25_evaluation_v2_future_nonholdout_acquisition_plan.md
current_v25_evaluation_v2_future_plan_sha256=dde178f9335d02fbe635df76eb9545e403b454d79d2f22d57a73d24cda60dddb
current_v25_phase=fair_pool_adaptation_contract_v5_raw_numeric_semantic_provenance_and_independent_literal_review_complete_no_acquisition
current_v25_evaluation_v2_artifact_schema=camp_dp_v25_evaluation_v2_artifact_v3
current_v25_evaluation_v2_superseded_contract_root_sha256=2a3c39aea959a9e311859f8af2c4ea81e22ac093b4e62ea48cbca6f4808d5795
current_v25_evaluation_v2_superseded_contract_review_root_sha256=a15edb5cad2279991dec2f091e134cd3a711a1b949eb38523a20125578500fed
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
...
current_v25_fair_nonholdout_evidence_index=docs/diffusion_planner_v25_fair_nonholdout_evidence_index.md
current_v25_fair_nonholdout_evidence_index_sha256=1d647da4baa67013e20b7f39abf6455e39fb9654838389fa173c575915de2ffd
current_v25_fair_pool_adaptation_contract_schema=camp_dp_v25_fair_pool_adaptation_contract_v5
current_v25_fair_pool_adaptation_contract_implementation_head=67308ac05e64808edf6f37dd2ad930ccf31899e1
current_v25_fair_pool_adaptation_contract_payload_sha256=2188c208ef144e73e3e9b2596906842bc13709781b8758bb2047fa9fe944f5a6
current_v25_fair_pool_adaptation_contract=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_contract_v5_67308ac0_8680c1b19ce0620b
current_v25_fair_pool_adaptation_contract_root_sha256=78584ecc74a1a4f42e18fe0f4ee81e4fd0f48e98e33fd56c7128954c2ce0e4c6
current_v25_fair_pool_adaptation_contract_review=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_contract_v5_review_67308ac0_8680c1b19ce0620b
current_v25_fair_pool_adaptation_contract_review_root_sha256=3e0f5c5247fc3fc4e877d0c2597022a5b31c2e297023fd39cc0a58060c0491e5
current_v25_fair_pool_adaptation_contract_focused=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_contract_v5_focused_67308ac0_8680c1b19ce0620b
current_v25_fair_pool_adaptation_contract_focused_root_sha256=aaeb20cd5278bc8566c621eb4c654e8250d690559502e5f9debf539477b87388
current_v25_fair_pool_adaptation_contract_focused_test_count=66
current_v25_fair_pool_adaptation_calibration_manifest_sha256=569718077a1c6c7f5193074ba86e646da4a3a40a2fdc573c7bfa51f3cfaa722f
current_v25_fair_pool_adaptation_validation_manifest_sha256=8b502332c14f98feb95df5db6016bb5deab949e1fe1a1d4c3e3671f7f66d5a9b
current_v25_fair_pool_adaptation_calibration_state_count=64
current_v25_fair_pool_adaptation_validation_state_count=64
...
current_v25_fair_pool_adaptation_provenance_package_created_authority_accepted=false
current_v25_fair_pool_adaptation_provenance_naked_hard_or_threshold_accepted=false
current_v25_fair_pool_adaptation_raw_semantic_receipt_schema=camp_dp_v25_fair_pool_mode_repeat_raw_semantic_receipts_v1
current_v25_fair_pool_adaptation_raw_semantic_run_schema=camp_dp_v25_fair_pool_raw_semantic_run_v1
current_v25_fair_pool_adaptation_raw_semantic_array_schema=camp_dp_v25_fair_pool_zlib_array_blob_v1
current_v25_fair_pool_adaptation_raw_semantic_runs_per_split_if_future_authorized=640
current_v25_fair_pool_adaptation_raw_semantic_total_runs_if_future_authorized=1280
current_v25_fair_pool_adaptation_raw_semantic_all_five_repeats_required=true
current_v25_fair_pool_adaptation_raw_semantic_candidate_shape=8x80x4
current_v25_fair_pool_adaptation_raw_semantic_neighbor_shape=8xAx80x4
current_v25_fair_pool_adaptation_raw_semantic_atom_shape=8x14
current_v25_fair_pool_adaptation_raw_semantic_selected_action_shape=80x4
current_v25_fair_pool_adaptation_numeric_cache_is_authority=false
current_v25_fair_pool_adaptation_numeric_cache_equality=exact_float64_hex
current_v25_fair_pool_adaptation_numeric_phase_keys_reconstructed=73
current_v25_fair_pool_adaptation_forward_pool_ids_derived_from_raw_preimages=true
current_v25_fair_pool_adaptation_all_zero_cache_reseal_retrust_blocks=true
current_v25_fair_pool_adaptation_repeat1_through_4_tensor_reseal_retrust_blocks=true
current_v25_fair_pool_adaptation_v5_semantic_artifact_root_count=4
current_v25_fair_pool_adaptation_v5_reviewer_imports_producer_metric_threshold_decision_oracle=false
current_v25_fair_pool_adaptation_scope=single_route_single_map_bounded_development_nonholdout_four_density_tiers_only
current_v25_fair_pool_adaptation_sampler_sha256=e603e2236ae77f33cb02e9de4b7c8b54f5f9977a2dae49f4574a327004ad7a85
current_v25_fair_pool_adaptation_input_manifest_schema=camp_dp_v25_fair_pool_input_only_manifest_v2
current_v25_fair_pool_adaptation_source_scene_schema=camp_dp_v25_fair_pool_deterministic_source_scene_v1
...
current_v25_fair_pool_adaptation_v3_contract_review_root_sha256=5f64756e952be9b502e4b40f8acf1f40e83cef3219858ab9ea5835e78f05d1e1
current_v25_fair_pool_adaptation_v3_scope=superseded_preacquisition_diagnostic
current_v25_fair_pool_adaptation_v4_contract_root_sha256=69bd196a91cea572484ca28b044966acd3ad85b868409d1907bec99a6ea0af47
current_v25_fair_pool_adaptation_v4_contract_review_root_sha256=2611ac2322f124daa1f1134e662447c5823cef0db88a9e12fb04abdc0561f954
current_v25_fair_pool_adaptation_v4_scope=superseded_preacquisition_diagnostic
current_v25_fair_pool_adaptation_report=docs/diffusion_planner_v25_fair_pool_adaptation_contract_v5_report.md
current_v25_fair_pool_adaptation_report_sha256=6ae333296d432d6af19ce4c584f49828f19b5e155cd9e76b62f0ae687bac00a3
current_v25_fair_pool_adaptation_evidence_index=docs/diffusion_planner_v25_fair_pool_adaptation_contract_v5_evidence_index.md
current_v25_fair_pool_adaptation_evidence_index_sha256=3c35b52cb40ade895cddbdc801e3d6b591bd9b9fdbfa26c77d688553eb0bad6f
next_work_target=high_fair_pool_adaptation_contract_v5_raw_numeric_semantics_review_before_any_acquisition

## 2026-07-26 - Fair-Pool Development Calibration Hard Stop

High authorized development calibration only after the v5 contract, authority,
input-only preflight, and independent preflight review sealed PASS. The first
raw run stopped after eight sequential batch-1 model forwards and before any
selector call at the frozen compound K8-validity predicate. Preserved evidence
does not resolve which of the three subconditions triggered. The outcome-blind
closeout and independent literal review sealed PASS; the raw denominator is
0/640, thresholds did not form, and validation plus every downstream run remain
locked.

The preserved corrected-evaluation review remains a separate-role sealed
deterministic replay using the frozen canonical evaluation core.

The exact machine tuple below is the current V25 authority and matches the
named Current V25 section field for field.

current_v25_status=v25_fair_pool_development_calibration_hard_stop_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_evaluation_v2_future_plan=docs/diffusion_planner_v25_evaluation_v2_future_nonholdout_acquisition_plan.md
current_v25_evaluation_v2_future_plan_sha256=dde178f9335d02fbe635df76eb9545e403b454d79d2f22d57a73d24cda60dddb
current_v25_phase=fair_pool_development_calibration_hard_stop_closeout_independently_reviewed
current_v25_evaluation_v2_artifact_schema=camp_dp_v25_evaluation_v2_artifact_v3
current_v25_evaluation_v2_superseded_contract_root_sha256=2a3c39aea959a9e311859f8af2c4ea81e22ac093b4e62ea48cbca6f4808d5795
current_v25_evaluation_v2_superseded_contract_review_root_sha256=a15edb5cad2279991dec2f091e134cd3a711a1b949eb38523a20125578500fed
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
...
current_v25_fair_pool_adaptation_legacy_hard_stop_preserved=true
current_v25_fair_pool_adaptation_functional_risk=unresolved
current_v25_fair_pool_adaptation_acquisition_authorized=true
current_v25_fair_pool_adaptation_calibration_run_count=0
current_v25_fair_pool_adaptation_repeat_model_run_count=8
current_v25_fair_pool_adaptation_pool_run_count=0
current_v25_fair_pool_adaptation_selector_run_count=0
current_v25_fair_pool_adaptation_closed_loop_run_count=0
current_v25_fair_pool_adaptation_fresh_run_count=0
...
current_v25_fair_pool_adaptation_evidence_index=docs/diffusion_planner_v25_fair_pool_adaptation_contract_v5_evidence_index.md
current_v25_fair_pool_adaptation_evidence_index_sha256=3c35b52cb40ade895cddbdc801e3d6b591bd9b9fdbfa26c77d688553eb0bad6f
current_v25_calibration_hard_stop_schema=camp_dp_v25_fair_pool_adaptation_calibration_hard_stop_closeout_v1
current_v25_calibration_hard_stop_status=calibration_hard_stop_scientific_contract_review_required
current_v25_calibration_hard_stop_classification=first_calibration_run_k8_validity_compound_gate_triggered; exact_subcondition_unresolved_from_preserved_evidence
current_v25_calibration_high_decision_sha256=ed0d298cbde0e66d7ed2b0bdd90e6be5f2ebbc49f4d818a6c97ff47440f88f59
current_v25_calibration_authorized_pointer_head=76f484f46ea569430e436b566a26fd863e1ebe31
current_v25_calibration_reporting_implementation_head=2a8a4e0261166b96eabd8710e2a7c066374bd491
current_v25_calibration_fixed_dp_head=7a1d33da277a1992ec474b5383a0c963c72e04e4
current_v25_calibration_authority=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_authority_67308ac0_ed0d298c
current_v25_calibration_authority_root_sha256=bd6fee62418d062266e8f922d2f2dd3672ced115f9c1065e922db4b207054820
current_v25_calibration_preflight=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_preflight_67308ac0_ed0d298c
current_v25_calibration_preflight_root_sha256=5156f98f0172fbd22ed2c21dfd79d236ce53544bf796006e41e29918ec667a22
current_v25_calibration_preflight_review=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_preflight_review_67308ac0_ed0d298c
current_v25_calibration_preflight_review_root_sha256=ece7c80b6e764598ff867606f225a29a40f8ddededc641e7f22032b4b5d49ef3
current_v25_calibration_hard_stop_focused=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_hard_stop_focused_2a8a4e02_ed0d298c
current_v25_calibration_hard_stop_focused_root_sha256=ddeef758461fa9f1b3d5f67bab0ebeea91674dc8fc54b5ee0513dbed490a70a8
current_v25_calibration_hard_stop_focused_test_count=24
current_v25_calibration_hard_stop_closeout=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_calibration_hard_stop_67308ac0_ed0d298c
current_v25_calibration_hard_stop_closeout_root_sha256=50e22c19fab0394992a9b915560ac58c96766ed4ff775a6def83c78ec0f7871e
current_v25_calibration_hard_stop_closeout_content_root_sha256=7e6f17622ca86c76eb3078d7ce24311c4f6e45246f37c116de1fdab981b183e4
current_v25_calibration_hard_stop_review=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_calibration_hard_stop_review_67308ac0_ed0d298c
current_v25_calibration_hard_stop_review_root_sha256=07e1969f05b110eea2f658fc8c9228480a18a0e1f2ab2131cf6e469fac2e08ed
current_v25_calibration_first_state_spec_id=development_calibration:000
current_v25_calibration_first_mode=sequential_batch1_x8
current_v25_calibration_first_repeat_index=0
current_v25_calibration_model_call_count=8
current_v25_calibration_selector_call_count=0
current_v25_calibration_terminal_error=RuntimeError: calibration K8 invalid
current_v25_calibration_resolved_subcondition=unknown
current_v25_calibration_possible_subconditions=candidate_tensor_contains_nonfinite_value|neighbor_tensor_contains_nonfinite_value|candidate_row_sha256_not_unique_across_k8
current_v25_calibration_raw_artifact=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_calibration_raw_67308ac0_ed0d298c
current_v25_calibration_raw_artifact_absent=true
current_v25_calibration_raw_review_artifact=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_calibration_raw_review_67308ac0_ed0d298c
current_v25_calibration_raw_review_artifact_absent=true
current_v25_calibration_threshold_artifact=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_threshold_freeze_67308ac0_ed0d298c
current_v25_calibration_threshold_not_formed=true
current_v25_calibration_threshold_review_artifact=/root/autodl-tmp/camp_dp_v25_fair_pool_adaptation_threshold_freeze_review_67308ac0_ed0d298c
current_v25_calibration_threshold_review_artifact_absent=true
current_v25_calibration_completed_raw_run_count=0
current_v25_calibration_planned_raw_run_count=640
current_v25_calibration_completed_pair_receipt_count=0
current_v25_calibration_planned_pair_receipt_count=1600
current_v25_calibration_validation_execution_count=0
current_v25_calibration_closed_loop_run_count=0
current_v25_calibration_replacement_run_count=0
current_v25_calibration_fresh_holdout_run_count=0
current_v25_calibration_training_retraining_run_count=0
current_v25_calibration_old_artifact_cas_write_count=0
current_v25_calibration_raw_outcome_inspected=false
current_v25_calibration_model_failure_claimed=false
current_v25_calibration_batch8_architecture_failure_claimed=false
current_v25_calibration_ood_drift_claimed=false
current_v25_calibration_retraining_required_claimed=false
current_v25_calibration_raw_producer_sha256=4657750607c80b748c7ee59be96095510ccc73be87a1a4aa77c9f69afff69408
current_v25_calibration_terminal_stderr_sha256=3a727dcb52ef635112c5f249d1ce4c578b239d76f46a6b9ddc758219b829d4af
current_v25_calibration_terminal_stdout_sha256=84d77fc5d8884f8e9b78aec3bc06625865051011c8d510276df8d3c9f192ca1e
current_v25_calibration_control_exit_sha256=4355a46b19d348dc2f57c046f8ef63d4538ebb936000f3c9ee954a27460dd865
current_v25_calibration_control_pid_sha256=afae23733fbfb93b9cca6df951189d007c134fc1c0f5a2ff8d14f58a38473def
current_v25_calibration_run_script_sha256=9234ccfa5eca3bf62bd72f537b3398e88dbfcfda626921d1a1f3f66fe2f08ffd
current_v25_calibration_pre_artifact_diagnostic_count=3
current_v25_calibration_pre_artifact_diagnostics_model_call_count=0
current_v25_calibration_report=docs/diffusion_planner_v25_fair_pool_calibration_hard_stop_report.md
current_v25_calibration_report_sha256=7d161f36a2f0b5ce2bd4c0eddb4b41aedd710867a06d2e956e223da8e79e6708
current_v25_calibration_evidence_index=docs/diffusion_planner_v25_fair_pool_calibration_hard_stop_evidence_index.md
current_v25_calibration_evidence_index_sha256=a1a6e95b197367027d0f5428bd8e0513a2b0c5cb4fb6ad14bc3506914af2321e
next_work_target=high_calibration_hard_stop_closeout_review_before_any_replacement_or_validation

## 2026-07-26 - Failed Calibration Attempt Closed, First-State Diagnostic Complete

The failed 0/640 development-calibration attempt remains immutably closed with
its exact subcondition unresolved. High separately authorized one replay of
the same first state and sequential mode under a versioned tensor-byte
diagnostic contract. Producer and independent reviewer reconstructed finite
candidate and neighbor tensors, two unique candidate-row hashes, and duplicate
group `[1,2,3,4,5,6,7]`. The resolved diagnostic subcondition is
`candidate_row_sha256_not_unique_across_k8`.

The replay stopped before selector. No remaining calibration run, threshold,
validation, closed-loop, Fresh/holdout, training/retraining, or old-artifact
write occurred. This observation is not a model/architecture failure, OOD
finding, or retraining decision. The exact machine tuple below matches the
named Current V25 section field for field.
...
current_v25_fair_pool_adaptation_evidence_index_sha256=3c35b52cb40ade895cddbdc801e3d6b591bd9b9fdbfa26c77d688553eb0bad6f
current_v25_calibration_hard_stop_schema=camp_dp_v25_fair_pool_adaptation_calibration_hard_stop_closeout_v1
current_v25_calibration_hard_stop_status=failed_attempt_closed_immutable
current_v25_calibration_hard_stop_classification=first_calibration_run_k8_validity_compound_gate_triggered; exact_subcondition_unresolved_from_preserved_evidence
current_v25_calibration_high_decision_sha256=ed0d298cbde0e66d7ed2b0bdd90e6be5f2ebbc49f4d818a6c97ff47440f88f59
current_v25_calibration_authorized_pointer_head=76f484f46ea569430e436b566a26fd863e1ebe31
current_v25_calibration_reporting_implementation_head=2a8a4e0261166b96eabd8710e2a7c066374bd491
...
current_v25_calibration_evidence_index=docs/diffusion_planner_v25_fair_pool_calibration_hard_stop_evidence_index.md
current_v25_calibration_evidence_index_sha256=a1a6e95b197367027d0f5428bd8e0513a2b0c5cb4fb6ad14bc3506914af2321e
current_v25_calibration_project_terminal=false
current_v25_calibration_permanent_no_retry_policy=false
current_v25_calibration_full_restart_requires_new_high_authority=true
current_v25_calibration_first_state_diagnostic_schema=camp_dp_v25_fair_pool_calibration_first_state_diagnostic_receipt_v1
current_v25_calibration_first_state_diagnostic_authority_sha256=3a72e639152b3416f7ef769f20dee05a2334d160b866ada4bd609c0c801277c8
current_v25_calibration_first_state_diagnostic_implementation_head=bacc9d2a795c471f1547823528a4c06d5372ea18
current_v25_calibration_first_state_diagnostic_contract=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_first_state_diagnostic_contract_bacc9d2a_3a72e639
current_v25_calibration_first_state_diagnostic_contract_root_sha256=9f70b46f10d915ecfe3fec7830467ddb42efeeec89fac9a6eddfdd43f0305fd7
current_v25_calibration_first_state_diagnostic_contract_review=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_first_state_diagnostic_contract_review_bacc9d2a_3a72e639
current_v25_calibration_first_state_diagnostic_contract_review_root_sha256=64be791bc609fac3b168fcb97096d4dff366fa6b8cc97e52d2c7b0a075bc0e79
current_v25_calibration_first_state_diagnostic_focused=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_first_state_diagnostic_focused_bacc9d2a_3a72e639
current_v25_calibration_first_state_diagnostic_focused_root_sha256=eb1e71f147d9110b86ffd65a5aae9a191a05a92a9c12317c426771f1cd5d5228
current_v25_calibration_first_state_diagnostic_focused_test_count=43
current_v25_calibration_first_state_diagnostic=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_first_state_diagnostic_bacc9d2a_3a72e639
current_v25_calibration_first_state_diagnostic_root_sha256=685c1529a95409f9f92220ac40d02c054d939bc93410e2ce4c0608e0e6dbffb8
current_v25_calibration_first_state_diagnostic_review=/root/autodl-tmp/camp_dp_v25_fair_pool_calibration_first_state_diagnostic_review_bacc9d2a_3a72e639
current_v25_calibration_first_state_diagnostic_review_root_sha256=8767856884b6597668a22c9c3dc1db8aa3dfacce329d29fe5002b26fa77c95ca
current_v25_calibration_first_state_diagnostic_receipt_sha256=d97fc4bbcfdb1ccf8fed517b8c47b89e7401952b1a9b5b5f1766ae50f38f3a45
current_v25_calibration_first_state_diagnostic_state_spec_id=development_calibration:000
current_v25_calibration_first_state_diagnostic_mode=sequential_batch1_x8
current_v25_calibration_first_state_diagnostic_repeat_index=0
current_v25_calibration_first_state_diagnostic_candidate_shape_dtype=8x80x4_<f4
current_v25_calibration_first_state_diagnostic_neighbor_shape_dtype=8x32x80x4_<f4
current_v25_calibration_first_state_diagnostic_candidate_nonfinite_count=0
current_v25_calibration_first_state_diagnostic_neighbor_nonfinite_count=0
current_v25_calibration_first_state_diagnostic_candidate_row_unique_cardinality=2
current_v25_calibration_first_state_diagnostic_duplicate_groups=1,2,3,4,5,6,7
current_v25_calibration_first_state_diagnostic_resolved_subcondition=candidate_row_sha256_not_unique_across_k8
current_v25_calibration_first_state_diagnostic_model_call_count=8
current_v25_calibration_first_state_diagnostic_selector_call_count=0
current_v25_calibration_first_state_diagnostic_remaining_639_run_count=0
current_v25_calibration_first_state_diagnostic_replacement_640_run_count=0
current_v25_calibration_first_state_diagnostic_threshold_materialization_count=0
current_v25_calibration_first_state_diagnostic_validation_run_count=0
current_v25_calibration_first_state_diagnostic_closed_loop_run_count=0
current_v25_calibration_first_state_diagnostic_fresh_holdout_run_count=0
current_v25_calibration_first_state_diagnostic_training_retraining_run_count=0
current_v25_calibration_first_state_diagnostic_old_artifact_cas_write_count=0
current_v25_calibration_first_state_diagnostic_raw_outcome_read=false
current_v25_calibration_first_state_diagnostic_model_failure_claimed=false
current_v25_calibration_first_state_diagnostic_batch8_architecture_failure_claimed=false
...
## 2026-07-26 - First-State Sequential K8 Nondiversity Resolved, New Calibration Authority Withheld

High accepted the immutable failed-attempt closeout and the first-state
tensor-byte diagnostic evidence chain. The diagnostic resolved a real
`candidate_row_sha256_not_unique_across_k8` subcondition: both tensors were
finite, but the eight candidate rows had cardinality two and duplicate group
`[1,2,3,4,5,6,7]`.

Because the automatic replacement policy applied only when K8 was valid and
the old failure was solely a harness/receipt-order defect, High withheld a new
0/640 calibration authority. This is bounded to the exact first state,
sequential mode, and repeat. It does not establish batch-8 failure, failure
across all states, general model failure, OOD, or a need to retrain.

No additional model, pool, selector, threshold, validation, closed-loop,
Fresh/holdout, training/retraining, or old-artifact/CAS operation occurred.
The exact machine tuple below matches the named Current V25 section field for
field.
...
current_v25_status=first_state_sequential_k8_nondiversity_resolved_new_calibration_authority_withheld_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_evaluation_v2_future_plan=docs/diffusion_planner_v25_evaluation_v2_future_nonholdout_acquisition_plan.md
current_v25_evaluation_v2_future_plan_sha256=dde178f9335d02fbe635df76eb9545e403b454d79d2f22d57a73d24cda60dddb
current_v25_phase=first_state_sequential_k8_nondiversity_resolved_new_calibration_authority_withheld
current_v25_evaluation_v2_artifact_schema=camp_dp_v25_evaluation_v2_artifact_v3
current_v25_evaluation_v2_superseded_contract_root_sha256=2a3c39aea959a9e311859f8af2c4ea81e22ac093b4e62ea48cbca6f4808d5795
current_v25_evaluation_v2_superseded_contract_review_root_sha256=a15edb5cad2279991dec2f091e134cd3a711a1b949eb38523a20125578500fed
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
...
current_v25_calibration_first_state_diagnostic_superseded_contract_review_root_sha256=0889d34303d28c263bffbe9470b1b2049a3e125f90a91b4d9de8f5060cb96839
current_v25_calibration_first_state_diagnostic_superseded_focused_root_sha256=ed336c8e8591a9615399a560cfd2a27965fc5b7196448e49241a1c02c908aaac
next_work_target=control_or_user_decision_on_outcome_free_latent_injection_source_audit_or_target_generator_contract

## 2026-07-26 - Batch8-Primary Generator Contract Independently Reviewed

High superseded the proposed sequential diagnostic before any model execution
and authorized an additive, outcome-independent batch8-primary generator
contract and independent literal review. No model, pool, selector, threshold,
validation, closed-loop, Fresh/holdout, training/retraining, or
old-artifact/CAS operation was performed.

The primary generator is frozen as one same-ego model batch `B=8`, one formal
model invocation, eight prefrozen unique latent rows, and one immutable
candidate tensor shared by pool-matched candidate0, Static14D, and Scene14D.
Candidate0 is row0, and all post-pool model, DP, latent-generation, and
candidate-generation call counts must remain zero.

The sealed sequential repeated-row finding remains unchanged, but
`sequential_batch1_x8` is now explicitly a legacy non-gating diagnostic. It
cannot contribute to the formal denominator, hard PASS/BLOCK, primary latency,
or qualification decision. Runtime qualification remains not run and requires
new High authority.

The exact machine tuple below matches the named Current V25 section field for
field. The preserved corrected-evaluation review remains a separate-role
sealed deterministic replay using the frozen canonical evaluation core; it is
not claimed to be a reviewer-local independent statistical implementation.

current_v25_status=single_invocation_batch8_primary_generator_contract_independently_reviewed_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_evaluation_v2_future_plan=docs/diffusion_planner_v25_evaluation_v2_future_nonholdout_acquisition_plan.md
current_v25_evaluation_v2_future_plan_sha256=dde178f9335d02fbe635df76eb9545e403b454d79d2f22d57a73d24cda60dddb
current_v25_phase=outcome_independent_batch8_primary_generator_contract_independently_reviewed
current_v25_evaluation_v2_artifact_schema=camp_dp_v25_evaluation_v2_artifact_v3
current_v25_evaluation_v2_superseded_contract_root_sha256=2a3c39aea959a9e311859f8af2c4ea81e22ac093b4e62ea48cbca6f4808d5795
current_v25_evaluation_v2_superseded_contract_review_root_sha256=a15edb5cad2279991dec2f091e134cd3a711a1b949eb38523a20125578500fed
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
...
current_v25_batch8_primary_contract_schema=camp_dp_v25_single_invocation_batch8_primary_generator_contract_amendment_v1
current_v25_batch8_primary_high_authority_sha256=16f63578b401a2bb5079035f3c047874dde6adc35cb162a71ed4d5016f197690
current_v25_batch8_primary_superseded_authority_sha256=f7d90c476de74f0122bce8ffeeab80260d17ad8cd040035ee97c81040e964aef
current_v25_batch8_primary_superseded_authority_model_execution_allowed=false
current_v25_batch8_primary_implementation_head=bcc847870dacbf986ad5aac66b052660b7197696
current_v25_batch8_primary_fixed_dp_head=7a1d33da277a1992ec474b5383a0c963c72e04e4
current_v25_batch8_primary_contract=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_primary_generator_contract_bcc84787_16f63578
current_v25_batch8_primary_contract_root_sha256=15cf642f5abcb1cd44687e8f4298517f47e8c878633602e9b42fcffe7c30e5d7
current_v25_batch8_primary_contract_review=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_primary_generator_contract_review_bcc84787_16f63578
current_v25_batch8_primary_contract_review_root_sha256=a0cd179311b5ce1fd18b7e764154d92041bfda57216c0be2365aa20100133978
current_v25_batch8_primary_focused=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_primary_generator_focused_bcc84787_16f63578
current_v25_batch8_primary_focused_root_sha256=bb012e5800fbc37e4106a11032f03c166fb793f34366fe5165068f5daa00ba20
current_v25_batch8_primary_focused_test_count=62
current_v25_batch8_primary_generator=new_single_invocation_batched_k8_candidate_pool
current_v25_batch8_primary_candidate_axis=same_ego_expanded_batch_dimension_B_equals_8
current_v25_batch8_primary_formal_model_invocation_count_per_pool=1
current_v25_batch8_primary_candidate_count=8
current_v25_batch8_primary_native_output_independent_k_axis=false
current_v25_batch8_primary_operational_batch1_already_has_k8=false
current_v25_batch8_primary_latent_policy=eight_prefrozen_unique_rows_row0_zero_rows1_7_independent_pcg64_standard_normal_float32
current_v25_batch8_primary_latent_shape_dtype=8x321x81x4_<f4
current_v25_batch8_primary_latent_unique_row_count_required=8
current_v25_batch8_primary_future_runtime_diagnostic_authorized=false
current_v25_batch8_primary_candidate0_rule=candidate_tensor_row0
current_v25_batch8_primary_arms=pool_matched_candidate0,Static14D,Scene14D
current_v25_batch8_primary_same_pool_tensor_required=true
current_v25_batch8_primary_candidate_tensor_immutable=true
current_v25_batch8_primary_post_pool_model_call_count=0
current_v25_batch8_primary_post_pool_dp_call_count=0
current_v25_batch8_primary_post_pool_latent_generation_count=0
current_v25_batch8_primary_post_pool_candidate_generation_count=0
current_v25_batch8_primary_pool_generation_common_cost_all_arms=true
current_v25_batch8_primary_operational_batch1_latency_scope=separate_architecture_reference_only
current_v25_batch8_primary_sequential_scope=legacy_non_gating_diagnostic_reference_only
current_v25_batch8_primary_sequential_exclusions=formal_denominator,hard_pass,primary_latency,qualification_decision
current_v25_batch8_primary_model_pool_selector_run_count=0
current_v25_batch8_primary_calibration_threshold_validation_closed_loop_fresh_holdout_training_run_count=0
current_v25_batch8_primary_outcome_values_read=false
current_v25_batch8_primary_old_artifact_cas_write_count=0
current_v25_batch8_primary_runtime_qualification_status=not_run_not_authorized
current_v25_batch8_primary_formal_denominator=not_formed_not_authorized
current_v25_batch8_primary_hard_pass=not_evaluated_not_authorized
current_v25_batch8_primary_claim_authorized=false
current_v25_batch8_primary_bundle_sha256=ffd38f193a97fb6d3c92f4cd50ec9a08b07495b882f12329db3452b778cace3a
current_v25_batch8_primary_bundle_prerequisite_head=d7457c7d7e8a26ef3729c3d49ef4f3f2ad04f12e
current_v25_batch8_primary_bundle_target_head=bcc847870dacbf986ad5aac66b052660b7197696
current_v25_batch8_primary_bundle_verify_passed=true
current_v25_batch8_primary_bundle_ff_only_passed=true
current_v25_batch8_primary_report=docs/diffusion_planner_v25_batch8_primary_generator_contract_report.md
current_v25_batch8_primary_report_sha256=8be29433029f4f75cfa5f1a3800e2e9ee1aeec31a8569d2e4be31df703ab268f
current_v25_batch8_primary_evidence_index=docs/diffusion_planner_v25_batch8_primary_generator_contract_evidence_index.md
current_v25_batch8_primary_evidence_index_sha256=f65960e756983534b7f79168da6ea40f2a955718821327f39470d3c4be304f4c
next_work_target=high_batch8_primary_contract_review_before_any_runtime_diagnostic_authority

## 2026-07-26 - Batch8-Only Calibration Contract Independently Reviewed
High authorized an outcome-independent batch8-only calibration contract design
and separate-role literal review. The contract freezes 64 development states,
five repeats, one same-ego B=8 invocation per run, 320 planned invocations, 640
unordered repeat pairs, 640 Static/Scene selector receipts, and the state as
the only independent statistical unit.

The sole numeric phase is `batch8_within`, with exactly 22 endpoints. The
reviewer independently rebuilt endpoint formulas, units, resolution floors,
q99-higher and PCG64DXSM bootstrap/UCB mathematics, hard gates, failure
retention, and the zero-contribution sequential/cross boundary.

The accepted training evidence binds 14D normalization scales but no sealed
same-ego batch8 training candidate/selector distribution. Training-support
status is `evidence_missing_prespecified_training_support_reference`;
calibration outcomes cannot set those thresholds and no no-retraining
conclusion is authorized.

No acquisition, threshold materialization, validation, closed-loop, Fresh,
holdout, training, retraining, claim, promotion, deployment, or old
artifact/CAS write was authorized or performed. The d6 contract is retained as
a mechanical JSON-order diagnostic; its review and focused artifacts are
absent.
...
## 2026-07-26 - Industrial-Oriented Evaluation-System Amendment Independently Reviewed

High superseded all pending training-support model authority and authorized a
zero-model, zero-outcome scientific-contract amendment. The sealed additive
contract defines a 56-endpoint, four-domain vector with no weighted total:
26 safety, 17 operations, 7 vehicle-body planar kinematic proxy, and 6
controlled-benchmark realtime endpoints.

The structure-only capability matrix classifies 42 endpoints as
`reconstructable_with_frozen_transform`, 13 as `evidence_missing`, and 1 as
`scientifically_inapplicable`. It binds sealed roots, schemas, units, and
transform feasibility without reading B4/Fresh outcome values. Collision
severity, THW/PET, false-stop context, target batch8 stage timing, and
occupant/seat evidence remain fail-closed gaps.

The independent reviewer uses local literals and does not import the producer
registry, formula, filter, classification, or decision oracle. AutoDL passed
102 zero-model focused tests. SafetyCost remains immutable legacy exploratory
diagnostic evidence and is excluded from primary endpoints, PASS, claim,
training support, and adaptation decisions.

No model, pool, selector, training, calibration, validation, closed-loop,
Fresh, holdout, old evaluation, outcome read, old artifact/CAS write, or claim
was authorized or performed. All prior roots and the legacy
`honest_no_claim_under_frozen_preregistered_all_gate` result remain immutable.

The preserved corrected-evaluation review remains a separate-role sealed
deterministic replay using the frozen canonical evaluation core; it is not
claimed to be a reviewer-local independent statistical implementation.

current_v25_status=industrial_oriented_evaluation_system_amendment_independently_reviewed_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_evaluation_v2_future_plan=docs/diffusion_planner_v25_evaluation_v2_future_nonholdout_acquisition_plan.md
current_v25_evaluation_v2_future_plan_sha256=dde178f9335d02fbe635df76eb9545e403b454d79d2f22d57a73d24cda60dddb
current_v25_phase=industrial_oriented_evaluation_system_amendment_independently_reviewed
current_v25_evaluation_v2_artifact_schema=camp_dp_v25_evaluation_v2_artifact_v3
current_v25_evaluation_v2_superseded_contract_root_sha256=2a3c39aea959a9e311859f8af2c4ea81e22ac093b4e62ea48cbca6f4808d5795
current_v25_evaluation_v2_superseded_contract_review_root_sha256=a15edb5cad2279991dec2f091e134cd3a711a1b949eb38523a20125578500fed
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
...
current_v25_batch8_primary_sequential_scope=legacy_non_gating_diagnostic_reference_only
current_v25_batch8_primary_sequential_exclusions=formal_denominator,hard_pass,primary_latency,qualification_decision
current_v25_batch8_primary_model_pool_selector_run_count=1
current_v25_batch8_primary_calibration_threshold_validation_closed_loop_fresh_holdout_training_run_count=0
current_v25_batch8_primary_outcome_values_read=false
current_v25_batch8_primary_old_artifact_cas_write_count=0
current_v25_batch8_primary_runtime_qualification_status=passed_one_development_first_state_preselector_diagnostic
current_v25_batch8_primary_formal_denominator=not_formed_not_authorized
current_v25_batch8_primary_hard_pass=not_evaluated_not_authorized
current_v25_batch8_primary_claim_authorized=false
current_v25_batch8_primary_bundle_sha256=ffd38f193a97fb6d3c92f4cd50ec9a08b07495b882f12329db3452b778cace3a
...
current_v25_batch8_primary_evidence_index=docs/diffusion_planner_v25_batch8_primary_generator_contract_evidence_index.md
current_v25_batch8_primary_evidence_index_sha256=f65960e756983534b7f79168da6ea40f2a955718821327f39470d3c4be304f4c
current_v25_batch8_first_state_diagnostic_schema=camp_dp_v25_single_invocation_batch8_first_state_diagnostic_receipt_v1
current_v25_batch8_first_state_diagnostic_high_authority_sha256=8b63c3564fa3f0ae1f87c5a97794eb01cc172fc6567814411d739aa0a6e7ed14
current_v25_batch8_first_state_diagnostic_implementation_head=cf0dc3fa6b90611d945ae90119cee0d166f2c6b3
current_v25_batch8_first_state_diagnostic_review_repair_head=c4d34eb1b1df4562f6d73d7cd1a5a1859b55a0ef
current_v25_batch8_first_state_diagnostic_fixed_dp_head=7a1d33da277a1992ec474b5383a0c963c72e04e4
current_v25_batch8_first_state_diagnostic_contract=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_diagnostic_contract_cf0dc3fa_8b63c356
current_v25_batch8_first_state_diagnostic_contract_root_sha256=8b08de216c190d02a85c76e15a9eb565b6528defb11017ff2e3e62c0832ab3d9
current_v25_batch8_first_state_diagnostic_contract_review=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_diagnostic_contract_review_cf0dc3fa_8b63c356
current_v25_batch8_first_state_diagnostic_contract_review_root_sha256=8a4f8a621f9d7c65824e165fde0b31f03cd52684509721f71f366d191f69a6bd
current_v25_batch8_first_state_diagnostic_focused=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_diagnostic_focused_cf0dc3fa_8b63c356
current_v25_batch8_first_state_diagnostic_focused_root_sha256=30fe043a4cd2254ceaf7599d4e523b501bbfb861bf10a2a5bee8e3a45083d35a
current_v25_batch8_first_state_diagnostic_focused_test_count=52
current_v25_batch8_first_state_diagnostic_preflight=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_preflight_cf0dc3fa_8b63c356
current_v25_batch8_first_state_diagnostic_preflight_root_sha256=f65ec544fe7fa9178debbfab97adcfc456e31f3831d2bd5f056694e46fe98a81
current_v25_batch8_first_state_diagnostic_preflight_review=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_preflight_review_cf0dc3fa_8b63c356
current_v25_batch8_first_state_diagnostic_preflight_review_root_sha256=f47aec6587846c7c2a933ae35c171283c10fbc431bb1133b5afb8d58ec45d192
current_v25_batch8_first_state_diagnostic_artifact=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_diagnostic_cf0dc3fa_8b63c356
current_v25_batch8_first_state_diagnostic_root_sha256=6a9e1a364b6d25716a471d34039553b11521c2d911563df0e3ee0edf1ed3eec5
current_v25_batch8_first_state_diagnostic_review_repair_focused=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_diagnostic_review_repair_focused_c4d34eb1_8b63c356
current_v25_batch8_first_state_diagnostic_review_repair_focused_root_sha256=4e84046f56c7729dfe2286909d96fa9bf3e174a897958d6c99f9491e152c8e94
current_v25_batch8_first_state_diagnostic_review_repair_focused_test_count=53
current_v25_batch8_first_state_diagnostic_review=/root/autodl-tmp/camp_dp_v25_single_invocation_batch8_first_state_diagnostic_review_c4d34eb1_8b63c356
current_v25_batch8_first_state_diagnostic_review_root_sha256=92e33a3e1747764a65d6d6b8e38645f7faa9825b2b08c980255025ac840073c3
current_v25_batch8_first_state_diagnostic_review_status=passed_independent_raw_byte_and_source_review
current_v25_batch8_first_state_diagnostic_taxonomy=batch8_pool_valid_diverse
current_v25_batch8_first_state_diagnostic_state_spec_id=development_calibration:000
current_v25_batch8_first_state_diagnostic_mode=single_invocation_batch8
current_v25_batch8_first_state_diagnostic_repeat_index=0
current_v25_batch8_first_state_diagnostic_source_ego_state_count=1
current_v25_batch8_first_state_diagnostic_expanded_model_batch_size=8
current_v25_batch8_first_state_diagnostic_agent_as_ego_batch=false
current_v25_batch8_first_state_diagnostic_formal_model_invocation_count=1
current_v25_batch8_first_state_diagnostic_sequential_model_call_count=0
current_v25_batch8_first_state_diagnostic_selector_call_count=0
current_v25_batch8_first_state_diagnostic_latent_shape_dtype=8x321x81x4_<f4
current_v25_batch8_first_state_diagnostic_latent_unique_row_count=8
current_v25_batch8_first_state_diagnostic_latent_tensor_sha256=7be67d387c045852169e64c88cc11b69e19b17c6d7dd2b3ae143209c7994bf99
current_v25_batch8_first_state_diagnostic_nonlatent_rows_exact_equal=true
current_v25_batch8_first_state_diagnostic_candidate_shape_dtype=8x80x4_<f4
current_v25_batch8_first_state_diagnostic_candidate_unique_row_count=8
current_v25_batch8_first_state_diagnostic_candidate_nonfinite_count=0
current_v25_batch8_first_state_diagnostic_candidate_duplicate_group_count=0
current_v25_batch8_first_state_diagnostic_candidate_tensor_sha256=899a81f7129627ccbe49ad74d3b3295a887f7a50ef7512b77c585de6561b6f3b
current_v25_batch8_first_state_diagnostic_neighbor_shape_dtype=8x32x80x4_<f4
current_v25_batch8_first_state_diagnostic_neighbor_nonfinite_count=0
current_v25_batch8_first_state_diagnostic_neighbor_tensor_sha256=e52ba476477e0cfb8fe77cfabc78df776ebba94f2ccb6df0080ffa2b13d64f46
current_v25_batch8_first_state_diagnostic_formal_forward_id=b4862848f7038983adbd3cc0b7e6cc5934b4e20ef6c1ae34e4b1cfa2b9e45e74
current_v25_batch8_first_state_diagnostic_pool_id=aa8ca514db4855739d8a22af4513b34c66df265c4c0b129a2a7a19d250d0a61d
current_v25_batch8_first_state_diagnostic_receipt_sha256=6cfbc68e8f9408b62710494fc36758bb96f0ed7b7b9411644b300010b457caaf
current_v25_batch8_first_state_diagnostic_row0_candidate0_binding=true
current_v25_batch8_first_state_diagnostic_pool_generation_latency_ns=504901053
current_v25_batch8_first_state_diagnostic_latency_scope=single_controlled_development_sample_not_distribution_or_deadline_qualification
current_v25_batch8_first_state_diagnostic_be2d_import_failure_model_call_count=0
current_v25_batch8_first_state_diagnostic_be2d_artifact_absent=true
current_v25_batch8_first_state_diagnostic_initial_review_artifact_absent=true
current_v25_batch8_first_state_diagnostic_reviewer_mechanical_repair=canonical_json_object_keyset_not_insertion_order
current_v25_batch8_first_state_diagnostic_model_rerun_count_after_artifact=0
current_v25_batch8_first_state_diagnostic_static_scene_selector_run_count=0
current_v25_batch8_first_state_diagnostic_full_calibration_run_count=0
current_v25_batch8_first_state_diagnostic_threshold_materialization_count=0
current_v25_batch8_first_state_diagnostic_validation_run_count=0
current_v25_batch8_first_state_diagnostic_closed_loop_run_count=0
current_v25_batch8_first_state_diagnostic_fresh_holdout_run_count=0
current_v25_batch8_first_state_diagnostic_training_retraining_run_count=0
current_v25_batch8_first_state_diagnostic_outcome_read=false
current_v25_batch8_first_state_diagnostic_old_artifact_cas_write_count=0
current_v25_batch8_first_state_diagnostic_claim_authorized=false
current_v25_batch8_first_state_diagnostic_report=docs/diffusion_planner_v25_batch8_first_state_diagnostic_report.md
current_v25_batch8_first_state_diagnostic_report_sha256=91e0d1524287cb79c9a6d0922a6403967c8ad9fe8f50ce84b74c1192aea46f5d
current_v25_batch8_first_state_diagnostic_evidence_index=docs/diffusion_planner_v25_batch8_first_state_diagnostic_evidence_index.md
current_v25_batch8_first_state_diagnostic_evidence_index_sha256=bd84119ed2ffd833381b003675f26e9ee66540c07f90cccd9fdaab236e3ff42e
current_v25_batch8_calibration_contract_schema=camp_dp_v25_batch8_primary_calibration_contract_v1
current_v25_batch8_calibration_high_authority_sha256=81dbf890717297cebf477ee9192c98c5c4f641bd3b976cab5154d6da872a5f7b
current_v25_batch8_calibration_implementation_head=383d9944ac1bc912880d15ef3c5ed4944c07c9ed
current_v25_batch8_calibration_fixed_dp_head=7a1d33da277a1992ec474b5383a0c963c72e04e4
current_v25_batch8_calibration_contract=/root/autodl-tmp/camp_dp_v25_batch8_primary_calibration_contract_383d9944_81dbf890
current_v25_batch8_calibration_contract_root_sha256=f4216e9e59d7cc81cf8d7ebd69e0bdd38b1399ec11d6fe95866994b309d53c1c
current_v25_batch8_calibration_contract_review=/root/autodl-tmp/camp_dp_v25_batch8_primary_calibration_contract_review_383d9944_81dbf890
current_v25_batch8_calibration_contract_review_root_sha256=8f2b198be18ef01607f4e355e014f3de07f049981ee05c0c18b96017b9237457
current_v25_batch8_calibration_focused=/root/autodl-tmp/camp_dp_v25_batch8_primary_calibration_contract_focused_383d9944_81dbf890
current_v25_batch8_calibration_focused_root_sha256=ec272560f2bb7c31a32cea8e9e5f6d83caad4f041ae5340a3f4881f8db90bdd5
current_v25_batch8_calibration_focused_test_count=84
current_v25_batch8_calibration_superseded_d6_contract=/root/autodl-tmp/camp_dp_v25_batch8_primary_calibration_contract_d6d67d8c_81dbf890
current_v25_batch8_calibration_superseded_d6_contract_root_sha256=2e93f633ec6053200b5bdc32ff2500118ee059db0e8be1415ed7c76b9f2b37a4
current_v25_batch8_calibration_superseded_d6_review_artifact_absent=true
current_v25_batch8_calibration_superseded_d6_focused_artifact_absent=true
current_v25_batch8_calibration_primary_mode=single_invocation_batch8
current_v25_batch8_calibration_generator=new_single_invocation_batched_k8_candidate_pool
current_v25_batch8_calibration_phase_keys=batch8_within
current_v25_batch8_calibration_state_count=64
current_v25_batch8_calibration_repeats_per_state=5
current_v25_batch8_calibration_planned_run_count=320
current_v25_batch8_calibration_planned_model_invocation_count=320
current_v25_batch8_calibration_unordered_pairs_per_state=10
current_v25_batch8_calibration_planned_pair_receipt_count=640
current_v25_batch8_calibration_planned_static_selector_receipt_count=320
current_v25_batch8_calibration_planned_scene_selector_receipt_count=320
current_v25_batch8_calibration_planned_selector_receipt_count=640
current_v25_batch8_calibration_within_numeric_endpoint_count=22
current_v25_batch8_calibration_cross_mode_numeric_endpoint_count=0
current_v25_batch8_calibration_sequential_numeric_endpoint_count=0
current_v25_batch8_calibration_statistical_unit=state
current_v25_batch8_calibration_row_tick_independence_claimed=false
current_v25_batch8_calibration_drop_replace_complete_case_allowed=false
current_v25_batch8_calibration_threshold_within_state=empirical_q99_higher_over_10_unordered_pairs
current_v25_batch8_calibration_threshold_across_states=64_state_pcg64dxsm_10000_bootstrap_q99_ucb95
current_v25_batch8_calibration_threshold_equality_rule=pair_error_le_frozen_threshold_pass
current_v25_batch8_calibration_threshold_materialization_authorized=false
current_v25_batch8_calibration_training_scale_root_sha256=8d2d9ee3ed83fbe4270cb96b7bc6ef6619e5180f11ebc348b9bdea136bac4da9
current_v25_batch8_calibration_training_scale_file_sha256=72694a5f21c0f99d6506ed078b53e75c76f26319005e9a0dd7cbc30ca7f688eb
current_v25_batch8_calibration_training_support_status=evidence_missing_prespecified_training_support_reference
current_v25_batch8_calibration_training_support_field_count=20
current_v25_batch8_calibration_calibration_may_set_training_support_thresholds=false
current_v25_batch8_calibration_no_retraining_conclusion_authorized=false
current_v25_batch8_calibration_actual_acquisition_authorized=false
current_v25_batch8_calibration_model_pool_selector_run_count=0
current_v25_batch8_calibration_threshold_validation_closed_loop_fresh_holdout_training_run_count=0
current_v25_batch8_calibration_outcome_values_read=false
current_v25_batch8_calibration_old_artifact_cas_write_count=0
current_v25_batch8_calibration_claim_authorized=false
current_v25_batch8_calibration_report=docs/diffusion_planner_v25_batch8_calibration_contract_report.md
current_v25_batch8_calibration_report_sha256=18a5db48a40aefb3507427913b2b7e139da0a6b9e446db0321152c9259928a6e
current_v25_batch8_calibration_evidence_index=docs/diffusion_planner_v25_batch8_calibration_contract_evidence_index.md
current_v25_batch8_calibration_evidence_index_sha256=0f7e18a2fb1404b63ee463910a9428f2eb380d3fea8fac61de0df64da6884052
current_v25_industrial_evaluation_high_authority_sha256=720e9293f88de92b08bbfab39100baf46b396ca59a5b1c9a089cde5af0bfeca5
current_v25_industrial_evaluation_schema=camp_dp_v25_industrial_oriented_evaluation_contract_v1
current_v25_industrial_evaluation_capability_schema=camp_dp_v25_industrial_oriented_evaluation_capability_matrix_v1
current_v25_industrial_evaluation_base_head=456aabb70308271f4b7b1dcb30550fe5574fc389
current_v25_industrial_evaluation_implementation_head=5316bb8cc37a0bdc539923991a07709dfd45b2ed
current_v25_industrial_evaluation_contract=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_contract_5316bb8c_720e9293
current_v25_industrial_evaluation_contract_root_sha256=2e04cbfdd386ccb04a0efb0b818a1d481aea7ddfb3ad8ba580ecfbc0b91fb31e
current_v25_industrial_evaluation_contract_review=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_contract_review_5316bb8c_720e9293
current_v25_industrial_evaluation_contract_review_root_sha256=9d82089ad6ce3b41789662c0d232c33c45a86103d1cd5348da54b51d5516335a
current_v25_industrial_evaluation_capability_matrix=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_capability_matrix_5316bb8c_720e9293
current_v25_industrial_evaluation_capability_matrix_root_sha256=7736d35f5a33d47967b83ad3c5a236dd3d9e5d9d0d66450e8bf6dbe4109f9d31
current_v25_industrial_evaluation_capability_matrix_review=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_capability_matrix_review_5316bb8c_720e9293
current_v25_industrial_evaluation_capability_matrix_review_root_sha256=6d252bd2a52eb974e77234ab0ed85104f0dbc068f08bc5d08204bc2c1024136a
current_v25_industrial_evaluation_focused=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_focused_5316bb8c_720e9293
current_v25_industrial_evaluation_focused_root_sha256=0902230a0640622667c0fb79b1c9f8f069070010cf84abe894ac2e6f7afa26d2
current_v25_industrial_evaluation_focused_test_count=102
current_v25_industrial_evaluation_endpoint_count=56
current_v25_industrial_evaluation_safety_endpoint_count=26
current_v25_industrial_evaluation_operations_endpoint_count=17
current_v25_industrial_evaluation_planar_proxy_endpoint_count=7
current_v25_industrial_evaluation_realtime_endpoint_count=6
current_v25_industrial_evaluation_reconstructable_with_frozen_transform_count=42
current_v25_industrial_evaluation_evidence_missing_count=13
current_v25_industrial_evaluation_scientifically_inapplicable_count=1
current_v25_industrial_evaluation_directly_reconstructable_count=0
current_v25_industrial_evaluation_contract_canonical_sha256=b6fcabdf40b035b2bd210db521f2f5fae5e36bbad30a736e78b23710da4b2c7e
current_v25_industrial_evaluation_capability_canonical_sha256=d23ee57e1e9c8411af255ec686b8835124d028ff42c88f6525cdaecd6beaaa4b
current_v25_industrial_evaluation_new_weighted_total=false
current_v25_industrial_evaluation_legacy_safetycost_role=immutable_legacy_exploratory_diagnostic_only
current_v25_industrial_evaluation_legacy_values_or_roots_mutated=false
current_v25_industrial_evaluation_selector_training_final_evaluation_decoupled=true
current_v25_industrial_evaluation_per_run_first=true
current_v25_industrial_evaluation_cluster_unit=preregistered_scenario_or_corridor_intersection_cluster
current_v25_industrial_evaluation_tick_row_arm_seed_independent_n=false
current_v25_industrial_evaluation_cluster_weighting=equal_cluster_weight
current_v25_industrial_evaluation_ci=student_t_two_sided_ci95
current_v25_industrial_evaluation_btw_tie_rule=exact_zero_delta
current_v25_industrial_evaluation_numeric_margin=numeric_margin_not_authorized_until_future_preregistration
current_v25_industrial_evaluation_full_denominator_missing_retention=true
current_v25_industrial_evaluation_complete_case_claim_allowed=false
current_v25_industrial_evaluation_position_interval_acceleration_filtered_jerk_counts=64,63,62,52,51
current_v25_industrial_evaluation_filter=11_point_centered_equal_weight_zero_phase_valid_only_no_padding
current_v25_industrial_evaluation_comfort_scope=vehicle_body_planar_kinematic_proxy_not_occupant_seat_iso_sae_conformity
current_v25_industrial_evaluation_iso2631_status=not_assessed
current_v25_industrial_evaluation_sae_j2834_202504_status=not_assessed
current_v25_industrial_evaluation_model_pool_selector_call_count=0
current_v25_industrial_evaluation_training_calibration_validation_closed_loop_fresh_holdout_count=0
current_v25_industrial_evaluation_outcome_values_read=false
current_v25_industrial_evaluation_old_artifact_or_cas_write_count=0
current_v25_industrial_evaluation_claim_authorized=false
current_v25_industrial_evaluation_local_tracked_clean=false_due_to_preserved_superseded_training_support_draft
current_v25_industrial_evaluation_superseded_diagnostic_tracked_modified_count=2
current_v25_industrial_evaluation_superseded_diagnostic_untracked_file_count=9
current_v25_industrial_evaluation_superseded_diagnostic_test_count=39
current_v25_industrial_evaluation_superseded_diagnostic_inventory_canonical_sha256=6eba8cfa4c232fc7c70ebc85755caf8117917081956302953f6d6173b81fbd13
current_v25_industrial_evaluation_superseded_diagnostic_tracked_diff_sha256=f95ce26ec2658bdbece28f09a5f3b6766fecbfcd0178b21743ee24a4b6a8d3d1
current_v25_industrial_evaluation_superseded_diagnostic_in_accepted_amendment_roots=false
current_v25_industrial_evaluation_superseded_diagnostic_model_pool_selector_call_count=0
current_v25_industrial_evaluation_report=docs/diffusion_planner_v25_industrial_evaluation_amendment_report.md
current_v25_industrial_evaluation_report_sha256=d082f45a8c750800f39aa866d76f8c0f3c7c5debe5177e183a9ccb0bfeebd8cd
current_v25_industrial_evaluation_evidence_index=docs/diffusion_planner_v25_industrial_evaluation_evidence_index.md
current_v25_industrial_evaluation_evidence_index_sha256=442e30f154339bf3952845c1f620d3f881d9ee2ac68ca36707262ed7780fd09c
current_v25_industrial_evaluation_migration_matrix=docs/diffusion_planner_v25_industrial_evaluation_migration_matrix.md
current_v25_industrial_evaluation_migration_matrix_sha256=f0971e58be2dd8261a38abe23d10796bc165471e5565d0d7fbfec31b10e7e57c
current_v25_industrial_evaluation_future_prereg_plan=docs/diffusion_planner_v25_industrial_evaluation_future_prereg_plan.md
current_v25_industrial_evaluation_future_prereg_plan_sha256=0d3f863d472446b8cdb616ba911d9ed0efc48cf99fc04ea950674308d541aeb9
next_work_target=high_control_review_of_industrial_evaluation_amendment_before_any_training_support_or_batch8_calibration_decision

## 2026-07-26 - Industrial-Oriented Evaluation-System Amendment v3 Independently Reviewed

Reader contract: this named section is the only current V25 pointer source in
this file. Its machine tuple must match the EOF tuple in
`docs/diffusion_planner_v25_iteration_audit.md` field for field.

The v3 outcome-independent amendment preserves the exact 56-parent,
161-scalar-leaf vector and the accepted sealed-inventory capability audit.
It closes the remaining collision-onset sign, executable statistics and
independent semantic-review gaps without reading outcomes or running models.

Collision-onset relative closing speed is now nonnegative by construction:
the frozen consecutive-position velocity reconstruction and earliest
continuous-SAT entry fraction feed max(0,-dot(r,v_rel)/norm(r)). Initial
overlap, no preceding interval, nonfinite input, missing SAT entry and
coincident centroids are typed missing. Delta-v and contact severity remain
missing.

Every testable leaf has an exact direction-oriented cluster delta,
noninferiority H0/H1, one-sided Student-t p-value and zero-variance rule.
Holm-Bonferroni uses stable (p,leaf_id) ordering, <= thresholds and
first-non-rejection stopping. Any required missing leaf blocks its complete
family. Ordinary 95% intervals are descriptive only, not familywise evidence.
Numeric margins remain unauthorized, so the current claim gate is false.

The separate-role reviewer imports no v3 producer or decision oracle. It
rebuilds all 161 formulas, units, directions, denominators, roles, families
and test fields from local literals. Synchronized payload and registry-digest
repinning does not bypass that semantic oracle.

Preserved superseded engineering diagnostic: the corrected evaluation
independent review remains a separate-role sealed deterministic replay using
the frozen canonical evaluation core. This historical evidence is not
reinterpreted by v3.

SafetyCost remains immutable legacy exploratory evidence only. The planar
proxy is not occupant/seat comfort or ISO/SAE conformity. No model, pool,
selector, training, calibration, validation, closed-loop, Fresh, holdout,
old evaluation, outcome read or old artifact/CAS write occurred.

v1 and v2 roots remain immutable superseded diagnostics. The historical
scientific result remains
`honest_no_claim_under_frozen_preregistered_all_gate`.

current_v25_status=industrial_oriented_evaluation_system_amendment_v3_independently_reviewed_scientific_contract_review_required
current_v25_execution_source_head=7be93df20deee03587b9898e8560909662df972c
current_v25_execution_pointer_head=06d3a1f3a37061f93f5c9788312ae59d1356d126
current_v25_correction_authority_head=dddca1c64f9e03ca515ffb4e06724b0842e33135
current_v25_corrected_evaluation_head=62079a71920f218f7a5269c6c01e6e3700db3723
...
current_v25_evaluation_v2_future_plan=docs/diffusion_planner_v25_evaluation_v2_future_nonholdout_acquisition_plan.md
current_v25_evaluation_v2_future_plan_sha256=dde178f9335d02fbe635df76eb9545e403b454d79d2f22d57a73d24cda60dddb
current_v25_phase=industrial_oriented_evaluation_system_amendment_v3_independently_reviewed
current_v25_evaluation_v2_artifact_schema=camp_dp_v25_evaluation_v2_artifact_v3
current_v25_evaluation_v2_superseded_contract_root_sha256=2a3c39aea959a9e311859f8af2c4ea81e22ac093b4e62ea48cbca6f4808d5795
current_v25_evaluation_v2_superseded_contract_review_root_sha256=a15edb5cad2279991dec2f091e134cd3a711a1b949eb38523a20125578500fed
current_v25_evaluation_v2_superseded_materialization_root_sha256=0cd17b28553b1ae8b1f23eb8796974e6c06f1d5e1c020998d302526f3b07c72d
...
current_v25_batch8_calibration_evidence_index_sha256=0f7e18a2fb1404b63ee463910a9428f2eb380d3fea8fac61de0df64da6884052
current_v25_industrial_evaluation_high_authority_sha256=720e9293f88de92b08bbfab39100baf46b396ca59a5b1c9a089cde5af0bfeca5
current_v25_industrial_evaluation_schema=camp_dp_v25_industrial_oriented_evaluation_contract_v3
current_v25_industrial_evaluation_capability_schema=camp_dp_v25_industrial_oriented_evaluation_capability_matrix_v3
current_v25_industrial_evaluation_base_head=456aabb70308271f4b7b1dcb30550fe5574fc389
current_v25_industrial_evaluation_implementation_head=c197c1e5c9b8ce1aa17d1b85825c95a5e7237f64
current_v25_industrial_evaluation_contract=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_contract_v3_c197c1e5_720e9293
current_v25_industrial_evaluation_contract_root_sha256=908fe1d57014e4932f71462d6d7e73ec58390f3296b3018df38092e4c0b128cb
current_v25_industrial_evaluation_contract_review=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_contract_v3_review_c197c1e5_720e9293
current_v25_industrial_evaluation_contract_review_root_sha256=23bb07ac537f9d53f7a2860b2314f55da4e2d468590d002c6cf25733f5e48556
current_v25_industrial_evaluation_capability_matrix=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_capability_matrix_v3_c197c1e5_720e9293
current_v25_industrial_evaluation_capability_matrix_root_sha256=fbcc8ab194520534c3b4986cccaf3d9a073b2cf975b6e3f006f61abe7791f20d
current_v25_industrial_evaluation_capability_matrix_review=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_capability_matrix_v3_review_c197c1e5_720e9293
current_v25_industrial_evaluation_capability_matrix_review_root_sha256=f32cb19b2c7bbd64e290f07a270f3e43462d31c86dc130a0c23a8b6eb363eec3
current_v25_industrial_evaluation_focused=/root/autodl-tmp/camp_dp_v25_industrial_evaluation_focused_v3_c197c1e5_720e9293
current_v25_industrial_evaluation_focused_root_sha256=06f221f4cf8fc86ae19f632fcc2fa74080575966224090fc552db89a190abb5b
current_v25_industrial_evaluation_focused_test_count=135
current_v25_industrial_evaluation_safety_endpoint_count=26
current_v25_industrial_evaluation_operations_endpoint_count=17
current_v25_industrial_evaluation_planar_proxy_endpoint_count=7
current_v25_industrial_evaluation_realtime_endpoint_count=6
current_v25_industrial_evaluation_reconstructable_with_frozen_transform_count=119
current_v25_industrial_evaluation_evidence_missing_count=41
current_v25_industrial_evaluation_scientifically_inapplicable_count=1
current_v25_industrial_evaluation_directly_reconstructable_count=0
current_v25_industrial_evaluation_contract_canonical_sha256=d8c7ca0ed4e59b6e3887e78cf1dea4116a1cd863ea5bed061a8e7f3afb1177db
current_v25_industrial_evaluation_capability_canonical_sha256=e3bb1c34e0a89b5d1dee234de88f346b545c962a1a3af1fac4dfbb8a5941deb2
current_v25_industrial_evaluation_new_weighted_total=false
current_v25_industrial_evaluation_legacy_safetycost_role=immutable_legacy_exploratory_diagnostic_only
current_v25_industrial_evaluation_legacy_values_or_roots_mutated=false
current_v25_industrial_evaluation_selector_training_final_evaluation_decoupled=true
...
current_v25_industrial_evaluation_tick_row_arm_seed_independent_n=false
current_v25_industrial_evaluation_cluster_weighting=equal_cluster_weight
current_v25_industrial_evaluation_ci=directed_one_sided_and_descriptive_two_sided_equal_cluster_student_t_ci95
current_v25_industrial_evaluation_btw_tie_rule=exact_zero_paired_delta_only_where_direction_and_full_pairing_defined
current_v25_industrial_evaluation_numeric_margin=numeric_margin_not_authorized_until_future_preregistration
current_v25_industrial_evaluation_full_denominator_missing_retention=true
current_v25_industrial_evaluation_complete_case_claim_allowed=false
current_v25_industrial_evaluation_position_interval_acceleration_filtered_jerk_counts=64,63,62,52,51
...
current_v25_industrial_evaluation_superseded_diagnostic_in_accepted_amendment_roots=false
current_v25_industrial_evaluation_superseded_diagnostic_model_pool_selector_call_count=0
current_v25_industrial_evaluation_report=docs/diffusion_planner_v25_industrial_evaluation_amendment_v3_report.md
current_v25_industrial_evaluation_report_sha256=1a8a79d85a9116d8127ace7e07e64171b38a0ea7df7bc770fe5fd7c04d81f3ca
current_v25_industrial_evaluation_evidence_index=docs/diffusion_planner_v25_industrial_evaluation_evidence_index_v3.md
current_v25_industrial_evaluation_evidence_index_sha256=b959752e8f019871991420f140cfeb64a5e8b96f2dc2196b81efbc6c426115cd
current_v25_industrial_evaluation_migration_matrix=docs/diffusion_planner_v25_industrial_evaluation_migration_matrix_v3.md
current_v25_industrial_evaluation_migration_matrix_sha256=8453d4ffef96a2cd19edf7f8b99c7f9d3c5c8f1a2078612f3d90e7e43bef21d5
current_v25_industrial_evaluation_future_prereg_plan=docs/diffusion_planner_v25_industrial_evaluation_future_prereg_plan_v3.md
current_v25_industrial_evaluation_future_prereg_plan_sha256=17cce38548e7a16054f9790e9a0da287a566759efdf59e56e02b299fdeea1bf9
current_v25_industrial_evaluation_parent_endpoint_count=56
current_v25_industrial_evaluation_scalar_leaf_count=161
current_v25_industrial_evaluation_hard_safety_leaf_count=14
current_v25_industrial_evaluation_guardrail_leaf_count=96
current_v25_industrial_evaluation_descriptive_leaf_count=9
current_v25_industrial_evaluation_not_testable_leaf_count=42
current_v25_industrial_evaluation_capability_audit_mode=complete_seal_exact_inventory_entry_sha_and_canonical_json_pointer
current_v25_industrial_evaluation_capability_glob_or_status_self_report_accepted=false
current_v25_industrial_evaluation_collision_onset_proxy=collision_onset_relative_closing_speed_kinematic_proxy_mps
current_v25_industrial_evaluation_collision_onset_proxy_class=reconstructable_with_frozen_transform
current_v25_industrial_evaluation_collision_delta_v_class=evidence_missing
current_v25_industrial_evaluation_collision_contact_severity_class=evidence_missing
current_v25_industrial_evaluation_familywise_method=holm_bonferroni_step_down_within_exact_family
current_v25_industrial_evaluation_familywise_alpha=0.05
current_v25_industrial_evaluation_directed_ci=one_sided_equal_cluster_weight_student_t_ci95_in_direction
current_v25_industrial_evaluation_descriptive_ci=two_sided_equal_cluster_weight_student_t_ci95
current_v25_industrial_evaluation_hard_safety_combination=intersection_union_all_preregistered_testable_hard_safety_leaves_must_pass
current_v25_industrial_evaluation_guardrail_combination=intersection_union_all_preregistered_testable_guardrail_leaves_must_pass
current_v25_industrial_evaluation_missing_required_leaf_claim_effect=fail_closed_blocks_relevant_future_claim
current_v25_industrial_evaluation_weighted_compensation_allowed=false
current_v25_industrial_evaluation_current_claim_gate_authorized=false
current_v25_industrial_evaluation_superseded_v1_contract_root_sha256=2e04cbfdd386ccb04a0efb0b818a1d481aea7ddfb3ad8ba580ecfbc0b91fb31e
current_v25_industrial_evaluation_superseded_v1_contract_review_root_sha256=9d82089ad6ce3b41789662c0d232c33c45a86103d1cd5348da54b51d5516335a
current_v25_industrial_evaluation_superseded_v1_capability_root_sha256=7736d35f5a33d47967b83ad3c5a236dd3d9e5d9d0d66450e8bf6dbe4109f9d31
current_v25_industrial_evaluation_superseded_v1_capability_review_root_sha256=6d252bd2a52eb974e77234ab0ed85104f0dbc068f08bc5d08204bc2c1024136a
current_v25_industrial_evaluation_superseded_v1_focused_root_sha256=0902230a0640622667c0fb79b1c9f8f069070010cf84abe894ac2e6f7afa26d2
current_v25_industrial_evaluation_superseded_v1_final_docs_root_sha256=704ec35bccb3047c6811570b300052bf7198464d2595ddead5f005038f39de86
current_v25_industrial_evaluation_superseded_v1_final_docs_test_count=140
current_v25_industrial_evaluation_superseded_v2_fixture_contract_root_sha256=2981e63256e677729c7f70393c0b36f26c2cb92d44ed8fc1171f697eceb5d2c8
current_v25_industrial_evaluation_superseded_v2_fixture_review_root_sha256=c9b7925247e4484269c94bb298856e35b66d03f41da103d363bf03eb164a3efc
current_v25_industrial_evaluation_superseded_v2_fixture_capability_formed=false
current_v25_industrial_evaluation_test_type_noninferiority_count=110
current_v25_industrial_evaluation_test_type_superiority_count=0
current_v25_industrial_evaluation_test_type_descriptive_count=9
current_v25_industrial_evaluation_test_type_not_testable_count=42
current_v25_industrial_evaluation_collision_onset_value_range=nonnegative_or_typed_missing
current_v25_industrial_evaluation_collision_onset_velocity_reconstruction=consecutive_centroid_position_difference_over_frozen_dt
current_v25_industrial_evaluation_collision_onset_contact_fraction=earliest_continuous_sat_translation_entry_tau_in_0_1
current_v25_industrial_evaluation_collision_onset_initial_overlap=typed_missing_no_false_to_true_onset_interval
current_v25_industrial_evaluation_collision_onset_zero_norm=typed_missing_coincident_centroids
current_v25_industrial_evaluation_oriented_delta_lower=baseline_cluster_mean_minus_method_cluster_mean
current_v25_industrial_evaluation_oriented_delta_higher=method_cluster_mean_minus_baseline_cluster_mean
current_v25_industrial_evaluation_noninferiority_h0=mu_z_le_negative_M_leaf
current_v25_industrial_evaluation_noninferiority_h1=mu_z_gt_negative_M_leaf
current_v25_industrial_evaluation_student_t_p_value=one_sided_sf_t_mean_z_plus_M_over_sample_sd_over_sqrt_n_df_n_minus_1
current_v25_industrial_evaluation_zero_variance_rule=p0_only_if_oriented_null_bound_numerator_strictly_positive_else_p1
current_v25_industrial_evaluation_holm_order=stable_ascending_p_value_then_leaf_id
current_v25_industrial_evaluation_holm_comparison=p_value_le_alpha_over_m_minus_i_plus_1
current_v25_industrial_evaluation_holm_stop_rule=stop_at_first_non_rejection
current_v25_industrial_evaluation_ordinary_ci_familywise_claim_evidence=false
current_v25_industrial_evaluation_missing_blocks_complete_family=true
current_v25_industrial_evaluation_reviewer_local_complete_leaf_semantics=true
current_v25_industrial_evaluation_registry_sha_role=additional_byte_lock_not_scientific_oracle
current_v25_industrial_evaluation_synchronized_repin_semantic_attacks_rejected=true
current_v25_industrial_evaluation_superseded_v2_contract_root_sha256=663977da1d1fe5d594764478881729f10483d13453c22024329375954b9ba3bb
current_v25_industrial_evaluation_superseded_v2_contract_review_root_sha256=8ed937f521beb0f2163366b6999c8238eef173cdab67df7e5922e0f301a5b5f7
current_v25_industrial_evaluation_superseded_v2_capability_root_sha256=86ab14e231129da7ec72dd7d632dd05336e03772c4af83e3d8e2dbdaec3e3afe
current_v25_industrial_evaluation_superseded_v2_capability_review_root_sha256=0c6f25de790a48fb71001e94be31f0f56c92eb2c5f86c31fedc727f0a0b921cd
current_v25_industrial_evaluation_superseded_v2_focused_root_sha256=0bccb1326860e3c1f74c5012fc6e40160722817a308212c8ec10f75b5209e4ec
current_v25_industrial_evaluation_superseded_v2_final_docs_root_sha256=16162cac21ddbe060eae6bdc035d34c34fb78494133da5122fbe7d82bffb559b
next_work_target=high_control_review_of_industrial_evaluation_amendment_v3_before_any_training_support_or_batch8_calibration_decision

## V25 Batch8 Generator-Only Calibration Full Denominator and Threshold Review

This EOF tuple records the accepted generator-only development calibration. It adds no selector, effect, Fresh, training-support, claim or deployment authority. The corrected evaluation review remains a separate-role sealed deterministic replay using the frozen canonical evaluation core.
...
current_v25_batch8_generator_calibration_report_sha256=96f27d51e9845342877c755773c1b8474358904a26e9d75682391e72e235d9e9
...
current_v25_batch8_generator_calibration_evidence_index_sha256=a2c1e14172bb3161aab149f91f5b102541dad1f6562ac5ffb884d9679f79094a
