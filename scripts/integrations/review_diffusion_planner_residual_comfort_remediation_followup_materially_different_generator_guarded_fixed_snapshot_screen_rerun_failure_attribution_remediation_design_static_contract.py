...
DEFAULT_PLAN_ROOT = (
    "/root/autodl-tmp/"
    "camp_dp_material_generator_failure_attribution_remediation_design_bff8f8b"
)
DEFAULT_AUDIT_PATH = ROOT / "docs" / "diffusion_planner_v8_iteration_audit.md"
PLAN_JSON = "remediation_design_plan.json"
PLAN_MD = "remediation_design_plan.md"
...
REQUIRED_TRACKS = (
    ...
    "jerk_limited_stop_and_creep_profiles",
    "lateral_heading_continuity_projection",
    "progress_retention_without_gate_relaxation",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Static contract review of the material generator failure "
    ...
    return {
        "analysis": {
            "name": (
                ...
                "design_static_contract_review_v1"
            ),
            "label": label,
            "role": "static contract review of remediation design plan",
            ...
            "math_boundary": (
                "This static review reads only the remediation design plan "
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# Material Generator Remediation Design Static Contract Review",
        "",
...
def _static_contract(source: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "hard_plus_comfort_target_contract": (
            source["residual_family"] == RESIDUAL_FAMILY
        ...
        "positive_support_before_training_contract": (
            ...
            and "positive offline support" in text
        ),
        "blocked_boundaries": [
...
def _artifact_checks(artifact: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        _check(
            ...
            and "Material Generator Failure Remediation Design Plan"
...
def _contract_checks(contract: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        _check("contract_hard_plus_comfort_target", contract["hard_plus_comfort_target_contract"]),
