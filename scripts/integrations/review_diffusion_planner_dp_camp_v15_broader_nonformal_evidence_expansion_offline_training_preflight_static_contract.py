#!/usr/bin/env python3
"""Static-review the v15 offline training preflight artifact."""
...
def _load_preflight_module():
    ...
    spec = importlib.util.spec_from_file_location("v15_offline_training_preflight", path)
...
SCHEMA_VERSION = "dp_camp_v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review_v1"
AUTHORIZED_CURRENT_WORK = PREFLIGHT_MODULE.AUTHORIZED_NEXT_WORK
READY_STATUS = "v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review_passed"
REJECT_STATUS = "v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review_rejected"
AUTHORIZED_NEXT_WORK = "v15_broader_nonformal_evidence_expansion_offline_training_execution_only"
REVIEW_JSON_NAME = "v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review.json"
REVIEW_MD_NAME = "v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review.md"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable_v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review",
        action="store_true",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        ...
        enabled=args.enable_v15_broader_nonformal_evidence_expansion_offline_training_preflight_static_review,
    )
...
def build_report(
    *,
    ...
    checks = [
        ...
        _expect("source_preflight_executed", decision.get("offline_training_preflight_executed"), True),
...
def _render_markdown(report: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            "# V15 Offline Training Preflight Static Review",
            "",
