...
def _materializer_source_checks(source: str) -> list[dict[str, Any]]:
    return [
        ...
        _contains("materializer_artifact_hash_checks", source, "atom_scales_sha256_matches"),
        _contains("materializer_static_weights_hash_checks", source, "static_weights_sha256_matches"),
