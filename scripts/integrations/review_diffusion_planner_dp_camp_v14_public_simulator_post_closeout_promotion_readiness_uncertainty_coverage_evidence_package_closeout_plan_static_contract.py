#!/usr/bin/env python3
"""Static review for the v14 uncertainty/coverage evidence package closeout plan."""
...
SCHEMA_VERSION = (
    ...
    "uncertainty_coverage_evidence_package_closeout_plan_static_review_v1"
)
AUTHORIZED_CURRENT_WORK = SOURCE_PLAN_MODULE.AUTHORIZED_NEXT_WORK
READY_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review_passed"
)
REJECT_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review_rejected"
)
AUTHORIZED_NEXT_WORK = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record_only"
)
SOURCE_PLAN_JSON_NAME = SOURCE_PLAN_MODULE.PLAN_JSON_NAME
SOURCE_PLAN_MD_NAME = SOURCE_PLAN_MODULE.PLAN_MD_NAME
REVIEW_JSON_NAME = (
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review.json"
)
REVIEW_MD_NAME = (
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review.md"
)
...
EXPECTED_CLOSEOUT_ITEMS = SOURCE_PLAN_MODULE.EXPECTED_CLOSEOUT_ITEMS
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--closeout_plan_artifact_dir", type=Path, required=True)
    parser.add_argument("--closeout_plan_json", type=Path, required=True)
    parser.add_argument("--closeout_plan_md", type=Path, required=True)
    parser.add_argument("--closeout_plan_sha256s", type=Path, required=True)
    ...
    parser.add_argument(
        "--enable_v14_post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review",
        action="store_true",
        help="Explicit opt-in for static review of the uncertainty/coverage evidence package closeout plan.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        closeout_plan_artifact_dir=args.closeout_plan_artifact_dir,
        closeout_plan_json=args.closeout_plan_json,
        closeout_plan_md=args.closeout_plan_md,
        closeout_plan_sha256s=args.closeout_plan_sha256s,
        ...
        label=args.label,
        enabled=args.enable_v14_post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review,
    )
...
def build_report(
    *,
    closeout_plan_artifact_dir: Path,
    closeout_plan_json: Path,
    closeout_plan_md: Path,
    closeout_plan_sha256s: Path,
    plan_script_py: Path,
    plan_test_py: Path,
    v14_audit_md: Path,
    ...
    artifact_dir = closeout_plan_artifact_dir.resolve()
    paths = {
        "closeout_plan_json": closeout_plan_json.resolve(),
        "closeout_plan_md": closeout_plan_md.resolve(),
        "closeout_plan_sha256s": closeout_plan_sha256s.resolve(),
    ...
    source_plan = PLAN_MODULE._read_json_dict(paths["closeout_plan_json"])
    root_sha256s = PLAN_MODULE._read_sha256sums(artifact_files["root_sha256s"])
    plan_sha256s = PLAN_MODULE._read_sha256sums(paths["closeout_plan_sha256s"])
    ...
    checks: list[dict[str, Any]] = [
        ...
        PLAN_MODULE._check("closeout_plan_artifact_dir_exists", artifact_dir.is_dir(), str(artifact_dir), "directory"),
    ]
    ...
    checks.extend(
        [
            PLAN_MODULE._expect("plan_json_matches_artifact_layout", paths["closeout_plan_json"], artifact_files["plan_json"]),
            PLAN_MODULE._expect("plan_md_matches_artifact_layout", paths["closeout_plan_md"], artifact_files["plan_md"]),
            PLAN_MODULE._expect("plan_sha256s_matches_artifact_layout", paths["closeout_plan_sha256s"], artifact_files["plan_sha256s"]),
        ]
    )
    ...
    return {
        ...
        "analysis": {
            ...
            "read_only": True,
            "source_closeout_plan_artifact_dir": str(artifact_dir),
            "source_closeout_plan_json": str(paths["closeout_plan_json"]),
        ...
        "package_summary": _package_summary(source_plan),
        "closeout_plan_summary": _closeout_plan_summary(source_plan),
...
def _markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# Post-Closeout Promotion-Readiness Uncertainty/Coverage Evidence Package Closeout Plan Static Review",
        "",
...
def _source_plan_contract_checks(source_plan: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    package_summary = PLAN_MODULE._dict(source_plan.get("package_summary"))
    source_review = PLAN_MODULE._dict(source_plan.get("source_static_review_summary"))
    closeout_plan = [PLAN_MODULE._dict(item) for item in PLAN_MODULE._list(source_plan.get("closeout_plan"))]
    checks = [
        ...
        PLAN_MODULE._expect("source_plan_ready_flag", decision.get("uncertainty_coverage_evidence_package_closeout_plan_ready"), True),
        PLAN_MODULE._expect("source_plan_static_review_authorized", decision.get("uncertainty_coverage_evidence_package_closeout_plan_static_review_authorized"), True),
        PLAN_MODULE._expect("source_plan_no_package_constructed", decision.get("evidence_package_constructed_by_this_gate"), False),
        PLAN_MODULE._expect("source_plan_no_closeout_recorded", decision.get("evidence_package_closed_by_this_gate"), False),
        ...
        PLAN_MODULE._expect("source_static_review_check_count", source_review.get("review_check_count"), EXPECTED_SOURCE_REVIEW_CHECK_COUNT),
        PLAN_MODULE._expect("source_static_review_failed_check_count", source_review.get("failed_check_count"), 0),
        ...
        PLAN_MODULE._expect("source_closeout_plan_item_names", [item.get("item_name") for item in closeout_plan], list(EXPECTED_CLOSEOUT_ITEMS)),
        PLAN_MODULE._expect("source_closeout_plan_item_count", len(closeout_plan), len(EXPECTED_CLOSEOUT_ITEMS)),
        PLAN_MODULE._expect("source_closeout_plan_no_closeout_record", [item.get("closeout_recorded_by_this_gate") for item in closeout_plan], [False] * len(EXPECTED_CLOSEOUT_ITEMS)),
        PLAN_MODULE._expect("source_closeout_plan_no_execution", [item.get("authorizes_execution") for item in closeout_plan], [False] * len(EXPECTED_CLOSEOUT_ITEMS)),
        PLAN_MODULE._expect("source_closeout_plan_no_claim", [item.get("authorizes_claim") for item in closeout_plan], [False] * len(EXPECTED_CLOSEOUT_ITEMS)),
        PLAN_MODULE._expect("source_closeout_plan_no_promotion", [item.get("authorizes_promotion") for item in closeout_plan], [False] * len(EXPECTED_CLOSEOUT_ITEMS)),
        PLAN_MODULE._expect("source_closeout_plan_no_deployment", [item.get("authorizes_deployment") for item in closeout_plan], [False] * len(EXPECTED_CLOSEOUT_ITEMS)),
    ]
...
def _source_surface_checks(script_text: str, test_text: str) -> list[dict[str, Any]]:
    return [
        PLAN_MODULE._check("plan_script_schema_token", "evidence_package_closeout_plan_v1" in script_text, "evidence_package_closeout_plan_v1", "present"),
        PLAN_MODULE._check("plan_script_static_review_next", "evidence_package_closeout_plan_static_review_only" in script_text, "evidence_package_closeout_plan_static_review_only", "present"),
        PLAN_MODULE._check("plan_script_no_closeout_record_check", "closeout_plan_no_closeout_record" in script_text, "closeout_plan_no_closeout_record", "present"),
        PLAN_MODULE._check("plan_script_no_execution_check", "closeout_plan_no_execution" in script_text, "closeout_plan_no_execution", "present"),
        PLAN_MODULE._check("plan_script_no_claim_check", "closeout_plan_no_claim" in script_text, "closeout_plan_no_claim", "present"),
        PLAN_MODULE._check("plan_script_no_deployment_check", "closeout_plan_no_deployment" in script_text, "closeout_plan_no_deployment", "present"),
        ...
        PLAN_MODULE._check("plan_test_rejects_package_summary_claim_leak", "rejects_package_summary_claim_leak" in test_text, "rejects_package_summary_claim_leak", "present"),
        PLAN_MODULE._check("plan_test_rejects_artifact_hash_drift", "rejects_artifact_hash_drift" in test_text, "rejects_artifact_hash_drift", "present"),
    ]


def _audit_checks(v14_text: str, status_text: str) -> list[dict[str, Any]]:
    return [
        PLAN_MODULE._expect("audit_latest_status_is_closeout_plan_ready", PLAN_MODULE._latest_value(v14_text, "current_v14_status"), SOURCE_PLAN_STATUS),
        ...
        PLAN_MODULE._expect("audit_plan_ready_flag", PLAN_MODULE._latest_value(v14_text, "uncertainty_coverage_evidence_package_closeout_plan_ready"), "True"),
        PLAN_MODULE._expect("audit_static_review_authorized_flag", PLAN_MODULE._latest_value(v14_text, "uncertainty_coverage_evidence_package_closeout_plan_static_review_authorized"), "True"),
        PLAN_MODULE._expect("audit_no_closeout_recorded", PLAN_MODULE._latest_value(v14_text, "evidence_package_closed_by_this_gate"), "False"),
        ...
        PLAN_MODULE._expect("status_doc_latest_status_is_closeout_plan_ready", PLAN_MODULE._latest_value(status_text, "current_v14_status"), SOURCE_PLAN_STATUS),
...
def _package_summary(source_plan: dict[str, Any]) -> dict[str, Any]:
    summary = PLAN_MODULE._dict(source_plan.get("package_summary"))
    return {
...
def _closeout_plan_summary(source_plan: dict[str, Any]) -> dict[str, Any]:
    closeout_plan = [PLAN_MODULE._dict(item) for item in PLAN_MODULE._list(source_plan.get("closeout_plan"))]
    return {
        "closeout_item_count": len(closeout_plan),
        "closeout_plan_items": [item.get("item_name") for item in closeout_plan],
        "all_no_closeout_record": all(item.get("closeout_recorded_by_this_gate") is False for item in closeout_plan),
        "all_no_execution": all(item.get("authorizes_execution") is False for item in closeout_plan),
        "all_no_claim": all(item.get("authorizes_claim") is False for item in closeout_plan),
        "all_no_promotion": all(item.get("authorizes_promotion") is False for item in closeout_plan),
        "all_no_deployment": all(item.get("authorizes_deployment") is False for item in closeout_plan),
    }
...
def _decision(passed: bool, checks: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    if passed:
        ...
        failure_class = "explicit_uncertainty_coverage_evidence_package_closeout_plan_static_review_authorization_missing"
        ...
        failure_class = "source_evidence_package_closeout_plan_static_review_contract_failure"
    ...
    decision: dict[str, Any] = {
        ...
        "uncertainty_coverage_evidence_package_closeout_plan_static_review_passed": passed,
        "uncertainty_coverage_evidence_package_closeout_record_authorized": passed,
        ...
        "score_expression": SCORE_EXPRESSION,
        "recommendation": "record_uncertainty_coverage_evidence_package_closeout_only" if passed else "repair_contract_before_rerun",
        "immediate_action": "evidence_package_closeout_record_only" if passed else "inspect_failed_checks",
    }
    for action in BLOCKED_ACTIONS:
