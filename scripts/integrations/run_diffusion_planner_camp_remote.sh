...
CAMP_MICROBENCHMARK_SNAPSHOT_DIR="${CAMP_MICROBENCHMARK_SNAPSHOT_DIR:-}"
CAMP_MICROBENCHMARK_SNAPSHOT_STEPS="${CAMP_MICROBENCHMARK_SNAPSHOT_STEPS:-}"
...
if [[ -n "$CAMP_MICROBENCHMARK_SNAPSHOT_DIR" ]]; then
  RUN_ARGS+=(--camp_microbenchmark_snapshot_dir "$CAMP_MICROBENCHMARK_SNAPSHOT_DIR")
fi
if [[ -n "$CAMP_MICROBENCHMARK_SNAPSHOT_STEPS" ]]; then
  RUN_ARGS+=(--camp_microbenchmark_snapshot_steps "$CAMP_MICROBENCHMARK_SNAPSHOT_STEPS")
fi
