#!/usr/bin/env python3
"""Review the v16 fixed-DP scale-up training execution result."""
...
SOURCE_SCHEMA_VERSION = "dp_camp_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution_v1"
SOURCE_READY_STATUS = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution_passed"
AUTHORIZED_CURRENT_WORK = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review_only"
READY_STATUS = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review_passed"
REJECT_STATUS = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review_rejected"
AUTHORIZED_NEXT_WORK = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight_plan_only"
SOURCE_JSON_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution.json"
SOURCE_MD_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution.md"
REVIEW_JSON_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review.json"
REVIEW_MD_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review.md"
SCHEMA_VERSION = "dp_camp_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review_v1"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review",
        action="store_true",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        ...
        enabled=args.enable_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_result_review,
    )
...
def build_report(
    *,
    ...
    checks = [
        ...
        _expect("train_records_6263", review["train_records"], EXPECTED_COUNTS["train"]),
        _expect("calibration_records_2156", review["calibration_records"], EXPECTED_COUNTS["calibration"]),
        _expect("holdout_records_1581", review["holdout_records"], EXPECTED_COUNTS["holdout"]),
...
def _training_result_review(source: dict[str, Any]) -> dict[str, Any]:
    training = source.get("scaleup_training_execution", {})
...
def _render_markdown(report: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            "# V16 nuScenes Fixed-DP Scale-Up Training Result Review",
            "",
