"""Seal the outcome-independent fair-pool adaptation contract v5."""
...
from camp_core.integrations.diffusion_planner_v25_fair_pool_adaptation_contract_v5 import (  # noqa: E402
    V4_CONTRACT_ROOT,
    V4_REVIEW_ROOT,
    adaptation_contract_v5,
    validate_contract_v5,
)
...
def freeze(*, output: Path, fixed_dp_repo: Path) -> str:
    ...
    contract = validate_contract_v5(adaptation_contract_v5())
    ...
    try:
        report = {
            "schema_version": (
                "camp_dp_v25_fair_pool_adaptation_contract_artifact_v5"
            ),
            "status": (
                "sealed_raw_semantic_provenance_design_only_"
                "acquisition_unauthorized"
            ),
            "contract": contract,
            "implementation_head": _git_head(ROOT),
            "fixed_dp_head": FIXED_DP_HEAD,
            "superseded_v4_contract_root_sha256": V4_CONTRACT_ROOT,
            "superseded_v4_review_root_sha256": V4_REVIEW_ROOT,
            "raw_semantic_run_count_per_split_if_future_authorized": 640,
            "raw_semantic_total_run_count_if_future_authorized": 1280,
        ...
        root = seal_artifact(
            staging,
            label="V25 fair-pool adaptation contract v5",
        )
