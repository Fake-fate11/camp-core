#!/usr/bin/env python3
"""Static review for the v14 promotion-readiness evaluation preflight.
...
REJECT_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_evaluation_preflight_static_review_rejected"
)
...
REVIEW_JSON_NAME = "post_closeout_promotion_readiness_evaluation_preflight_static_review.json"
REVIEW_MD_NAME = "post_closeout_promotion_readiness_evaluation_preflight_static_review.md"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable_v14_post_closeout_promotion_readiness_evaluation_preflight_static_review",
        action="store_true",
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        ...
        label=args.label,
        enabled=args.enable_v14_post_closeout_promotion_readiness_evaluation_preflight_static_review,
    )
...
def _heads_checks(heads: dict[str, str], source_preflight: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _check("artifact_heads_source_plan_static_review_present", bool(heads.get("source_preflight_plan_static_review_artifact")), heads.get("source_preflight_plan_static_review_artifact"), "path"),
        _check("artifact_heads_source_plan_present", bool(heads.get("source_preflight_plan_artifact")), heads.get("source_preflight_plan_artifact"), "path"),
...
def _source_surface_checks(script: str, test: str) -> list[dict[str, Any]]:
    return [
        _contains("source_surface_script_schema", script, "promotion_readiness_evaluation_preflight_v1"),
        _contains("source_surface_script_static_review_next", script, "promotion_readiness_evaluation_preflight_static_review_only"),
        _contains("source_surface_script_static_review_flag", script, "preflight_static_review_authorized"),
        ...
        _contains("source_surface_test_pass_case", test, "test_promotion_readiness_evaluation_preflight_passes"),
        _contains("source_surface_test_requires_enable", test, "test_promotion_readiness_evaluation_preflight_requires_enable"),
        _contains("source_surface_test_rejects_wrong_eof", test, "test_promotion_readiness_evaluation_preflight_rejects_wrong_eof"),
    ]
...
def _audit_checks(v14_text: str, status_text: str) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _expect("audit_preflight_ready", _latest_value(v14_text, "post_closeout_promotion_readiness_evaluation_preflight_ready"), "True"),
        _expect("audit_preflight_static_review_authorized", _latest_value(v14_text, "post_closeout_promotion_readiness_evaluation_preflight_static_review_authorized"), "True"),
...
def _decision(passed: bool, checks: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    decision = {
        ...
        "post_closeout_promotion_readiness_evaluation_preflight_static_review_passed": bool(passed),
        "promotion_readiness_evaluation_plan_authorized": bool(passed),
        "recommendation": "plan_promotion_readiness_evaluation_only",
        "immediate_action": "plan_read_only_promotion_readiness_evaluation_only",
...
def _failure_class(failed: list[str]) -> str:
    ...
    return "promotion_readiness_evaluation_preflight_static_review_failure"
