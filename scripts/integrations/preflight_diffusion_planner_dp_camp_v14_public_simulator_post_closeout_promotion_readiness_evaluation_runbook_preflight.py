#!/usr/bin/env python3
"""Read-only v14 promotion-readiness evaluation runbook preflight.

This gate consumes the audited runbook/preflight plan static review and its
...
evaluation runbook discussion. It does not run evaluation, replay, training,
...
SOURCE_STATIC_REVIEW_SCHEMA = (
    ...
    "promotion_readiness_evaluation_runbook_preflight_plan_static_review_v1"
)
SOURCE_PLAN_SCHEMA = (
    "dp_camp_v14_public_simulator_post_closeout_"
...
SOURCE_STATIC_REVIEW_STATUS = (
    ...
    "post_closeout_promotion_readiness_evaluation_runbook_preflight_plan_static_review_passed"
)
SOURCE_PLAN_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
...
AUTHORIZED_CURRENT_WORK = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_evaluation_runbook_preflight_only"
)
READY_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
...
REJECT_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_evaluation_runbook_preflight_rejected"
)
...
STATIC_REVIEW_JSON_NAME = (
    "post_closeout_promotion_readiness_evaluation_runbook_preflight_plan_static_review.json"
)
STATIC_REVIEW_MD_NAME = (
    "post_closeout_promotion_readiness_evaluation_runbook_preflight_plan_static_review.md"
)
PLAN_JSON_NAME = "post_closeout_promotion_readiness_evaluation_runbook_preflight_plan.json"
PLAN_MD_NAME = "post_closeout_promotion_readiness_evaluation_runbook_preflight_plan.md"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--runbook_preflight_plan_static_review_artifact_dir", type=Path, required=True)
    parser.add_argument("--runbook_preflight_plan_static_review_json", type=Path, required=True)
    parser.add_argument("--runbook_preflight_plan_static_review_md", type=Path, required=True)
    parser.add_argument("--runbook_preflight_plan_static_review_sha256s", type=Path, required=True)
    parser.add_argument("--source_runbook_preflight_plan_artifact_dir", type=Path, required=True)
    parser.add_argument("--source_runbook_preflight_plan_json", type=Path, required=True)
    parser.add_argument("--source_runbook_preflight_plan_md", type=Path, required=True)
    parser.add_argument("--source_runbook_preflight_plan_sha256s", type=Path, required=True)
    ...
    parser.add_argument(
        "--enable_v14_post_closeout_promotion_readiness_evaluation_runbook_preflight",
        action="store_true",
        help="Explicit opt-in for read-only promotion-readiness evaluation runbook preflight.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        runbook_preflight_plan_static_review_artifact_dir=args.runbook_preflight_plan_static_review_artifact_dir,
        runbook_preflight_plan_static_review_json=args.runbook_preflight_plan_static_review_json,
        runbook_preflight_plan_static_review_md=args.runbook_preflight_plan_static_review_md,
        runbook_preflight_plan_static_review_sha256s=args.runbook_preflight_plan_static_review_sha256s,
        source_runbook_preflight_plan_artifact_dir=args.source_runbook_preflight_plan_artifact_dir,
        source_runbook_preflight_plan_json=args.source_runbook_preflight_plan_json,
        source_runbook_preflight_plan_md=args.source_runbook_preflight_plan_md,
        source_runbook_preflight_plan_sha256s=args.source_runbook_preflight_plan_sha256s,
        ...
        label=args.label,
        enabled=args.enable_v14_post_closeout_promotion_readiness_evaluation_runbook_preflight,
    )
...
def build_report(
    *,
    runbook_preflight_plan_static_review_artifact_dir: Path,
    runbook_preflight_plan_static_review_json: Path,
    runbook_preflight_plan_static_review_md: Path,
    runbook_preflight_plan_static_review_sha256s: Path,
    source_runbook_preflight_plan_artifact_dir: Path,
    source_runbook_preflight_plan_json: Path,
    source_runbook_preflight_plan_md: Path,
    source_runbook_preflight_plan_sha256s: Path,
    v14_audit_md: Path,
    ...
    static_artifact = runbook_preflight_plan_static_review_artifact_dir.resolve()
    plan_artifact = source_runbook_preflight_plan_artifact_dir.resolve()
    paths = {
        "runbook_preflight_plan_static_review_json": runbook_preflight_plan_static_review_json.resolve(),
        "runbook_preflight_plan_static_review_md": runbook_preflight_plan_static_review_md.resolve(),
        "runbook_preflight_plan_static_review_sha256s": runbook_preflight_plan_static_review_sha256s.resolve(),
        "source_runbook_preflight_plan_json": source_runbook_preflight_plan_json.resolve(),
        "source_runbook_preflight_plan_md": source_runbook_preflight_plan_md.resolve(),
        "source_runbook_preflight_plan_sha256s": source_runbook_preflight_plan_sha256s.resolve(),
    ...
    static_review = _read_json_dict(paths["runbook_preflight_plan_static_review_json"])
    source_plan = _read_json_dict(paths["source_runbook_preflight_plan_json"])
    static_root_sha256s = _read_sha256sums(static_artifact_files["root_sha256s"])
    static_review_sha256s = _read_sha256sums(paths["runbook_preflight_plan_static_review_sha256s"])
    plan_root_sha256s = _read_sha256sums(plan_artifact_files["root_sha256s"])
    source_plan_sha256s = _read_sha256sums(paths["source_runbook_preflight_plan_sha256s"])
    ...
    checks: list[dict[str, Any]] = [
        _expect("runbook_preflight_enabled", enabled, True),
    ...
    checks.extend(
        [
            _expect("static_review_json_matches_artifact_layout", paths["runbook_preflight_plan_static_review_json"], static_artifact_files["review_json"]),
            _expect("static_review_md_matches_artifact_layout", paths["runbook_preflight_plan_static_review_md"], static_artifact_files["review_md"]),
            _expect("static_review_sha256s_matches_artifact_layout", paths["runbook_preflight_plan_static_review_sha256s"], static_artifact_files["review_sha256s"]),
            _expect("source_plan_json_matches_artifact_layout", paths["source_runbook_preflight_plan_json"], plan_artifact_files["plan_json"]),
            _expect("source_plan_md_matches_artifact_layout", paths["source_runbook_preflight_plan_md"], plan_artifact_files["plan_md"]),
            _expect("source_plan_sha256s_matches_artifact_layout", paths["source_runbook_preflight_plan_sha256s"], plan_artifact_files["plan_sha256s"]),
        ]
    )
    ...
    return {
        ...
        "analysis": {
            ...
            "preflight_only": True,
            "read_only": True,
            "runbook_preflight_plan_static_review_artifact_dir": str(static_artifact),
            "source_runbook_preflight_plan_artifact_dir": str(plan_artifact),
            "runbook_preflight_plan_static_review_json": str(paths["runbook_preflight_plan_static_review_json"]),
            "source_runbook_preflight_plan_json": str(paths["source_runbook_preflight_plan_json"]),
        ...
        "source_runbook_preflight_plan_summary": _source_plan_summary(source_plan),
        "runbook_preflight": _runbook_preflight(),
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Runbook preflight checks: `{len(report['runbook_preflight'])}`",
    ...
    for item in report["runbook_preflight"]:
...
def _static_heads_checks(
    ...
    return [
        ...
        _expect("static_review_heads_source_plan_artifact", heads.get("source_runbook_preflight_plan_artifact"), str(source_plan_artifact)),
        _expect("static_review_analysis_source_plan_artifact", analysis.get("runbook_preflight_plan_artifact_dir"), str(source_plan_artifact)),
    ]
...
def _source_plan_heads_checks(heads: dict[str, str], source_plan: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    return [
        ...
        _check("source_plan_heads_plan_static_review_present", bool(heads.get("source_plan_static_review_artifact")), heads.get("source_plan_static_review_artifact"), "path"),
        _check("source_plan_heads_evaluation_plan_present", bool(heads.get("source_evaluation_plan_artifact")), heads.get("source_evaluation_plan_artifact"), "path"),
...
def _static_review_contract_checks(static_review: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    checks = [
        ...
        _expect("source_static_review_runbook_preflight_authorized", decision.get("evaluation_runbook_preflight_authorized"), True),
...
def _source_plan_contract_checks(source_plan: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    checks = [
        ...
        _expect("source_plan_static_review_authorized", decision.get("evaluation_runbook_preflight_plan_static_review_authorized"), True),
        ...
        _expect("source_plan_runbook_preflight_steps", _names(source_plan.get("runbook_preflight_plan")), list(EXPECTED_RUNBOOK_PREFLIGHT_STEPS)),
        _expect("source_plan_no_go_count", len(_list(source_plan.get("no_go_conditions"))), 8),
        _expect("source_plan_forbidden_action_count", len(_list(source_plan.get("forbidden_actions"))), 6),
...
def _audit_checks(v14_text: str, status_text: str) -> list[dict[str, Any]]:
    ...
    return [
        _expect("audit_latest_eof_authorizes_runbook_preflight", (_latest_value(v14_text, "current_v14_status"), _latest_value(v14_text, "next_work_target")), expected_pair),
        _expect("status_doc_latest_eof_authorizes_runbook_preflight", (_latest_value(status_text, "current_v14_status"), _latest_value(status_text, "next_work_target")), expected_pair),
        _expect("audit_runbook_plan_static_review_passed", _latest_value(v14_text, "post_closeout_promotion_readiness_evaluation_runbook_preflight_plan_static_review_passed"), "True"),
        _expect("audit_runbook_preflight_authorized", _latest_value(v14_text, "post_closeout_promotion_readiness_evaluation_runbook_preflight_authorized"), "True"),
...
def _runbook_preflight() -> list[dict[str, str]]:
    return [
        {"name": "source_artifact_inventory", "status": "ready_for_static_review_only"},
        {"name": "fixed_dp_candidate_boundary", "status": "ready_for_static_review_only"},
        {"name": "split_seed_zero_overlap_boundary", "status": "ready_for_static_review_only"},
        {"name": "default_off_shadow_selector_boundary", "status": "ready_for_static_review_only"},
        {"name": "metric_uncertainty_boundary", "status": "ready_for_static_review_only"},
        {"name": "claim_and_promotion_boundary", "status": "ready_for_static_review_only"},
    ]
...
def _future_review_requirements() -> list[dict[str, str]]:
    return [
        {"name": "runbook_preflight_static_review", "status": "required_before_any_evaluation_runbook_execution"},
...
def _source_plan_summary(source_plan: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "runbook_preflight_step_count": len(_list(source_plan.get("runbook_preflight_plan"))),
...
def _decision(passed: bool, checks: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    decision = {
        ...
        "post_closeout_promotion_readiness_evaluation_runbook_preflight_ready": bool(passed),
        "evaluation_runbook_preflight_static_review_authorized": bool(passed),
        "recommendation": "static_review_this_runbook_preflight_only",
        "immediate_action": "static_review_promotion_readiness_evaluation_runbook_preflight_only",
...
def _failure_class(failed: list[str]) -> str:
    ...
    if "runbook_preflight_enabled" in failed_set:
        return "explicit_runbook_preflight_authorization_missing"
    ...
    if any(name.startswith("source_plan_") for name in failed):
        return "source_runbook_preflight_plan_contract_failure"
    ...
    return "promotion_readiness_evaluation_runbook_preflight_failure"
