#!/usr/bin/env python3
"""Record-only closeout for the v14 uncertainty/coverage evidence package."""
...
def _load_static_review_module():
    review_path = Path(__file__).resolve().with_name(
        ...
        "uncertainty_coverage_evidence_package_closeout_plan_static_contract.py"
    )
    spec = importlib.util.spec_from_file_location(
        "v14_post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_plan_static_review",
        review_path,
    )
...
SCHEMA_VERSION = (
    ...
    "uncertainty_coverage_evidence_package_closeout_record_v1"
)
AUTHORIZED_CURRENT_WORK = SOURCE_REVIEW_MODULE.AUTHORIZED_NEXT_WORK
READY_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_recorded"
)
REJECT_STATUS = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record_rejected"
)
AUTHORIZED_NEXT_WORK = (
    "public_simulator_fixed_dp_candidate_generation_trained_default_off_"
    "shadow_replay_evaluation_default_off_shadow_selector_runtime_"
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record_static_review_only"
)
SOURCE_REVIEW_JSON_NAME = SOURCE_REVIEW_MODULE.REVIEW_JSON_NAME
SOURCE_REVIEW_MD_NAME = SOURCE_REVIEW_MODULE.REVIEW_MD_NAME
RECORD_JSON_NAME = (
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record.json"
)
RECORD_MD_NAME = (
    "post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record.md"
)
EXPECTED_REVIEW_CHECK_COUNT = 145
...
EXPECTED_CLOSEOUT_ITEM_COUNT = 5
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable_v14_post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record",
        action="store_true",
        help="Explicit opt-in for record-only uncertainty/coverage evidence package closeout.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        ...
        label=args.label,
        enabled=args.enable_v14_post_closeout_promotion_readiness_uncertainty_coverage_evidence_package_closeout_record,
    )
...
def build_report(
    *,
    ...
    checks: list[dict[str, Any]] = [
        PLAN_MODULE._expect("closeout_record_enabled", enabled, True),
...
def write_outputs(output_dir: Path, report: dict[str, Any]) -> None:
    ...
    PLAN_MODULE._write_json(output_dir / RECORD_JSON_NAME, report)
...
def _markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# Post-Closeout Promotion-Readiness Uncertainty/Coverage Evidence Package Closeout Record",
        "",
        ...
        f"- final_package_state: `{record['final_package_state']}`",
...
def _source_review_contract_checks(source_review: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    source_plan = PLAN_MODULE._dict(source_review.get("source_plan_summary"))
    package_summary = PLAN_MODULE._dict(source_review.get("package_summary"))
    closeout_summary = PLAN_MODULE._dict(source_review.get("closeout_plan_summary"))
    checks = [
        ...
        PLAN_MODULE._expect("source_review_record_authorized", decision.get("uncertainty_coverage_evidence_package_closeout_record_authorized"), True),
        ...
        PLAN_MODULE._expect("source_plan_check_count", source_plan.get("plan_check_count"), EXPECTED_SOURCE_PLAN_CHECK_COUNT),
        ...
        PLAN_MODULE._expect("source_closeout_item_count", closeout_summary.get("closeout_item_count"), EXPECTED_CLOSEOUT_ITEM_COUNT),
        PLAN_MODULE._expect("source_closeout_all_no_record", closeout_summary.get("all_no_closeout_record"), True),
        PLAN_MODULE._expect("source_closeout_all_no_execution", closeout_summary.get("all_no_execution"), True),
        PLAN_MODULE._expect("source_closeout_all_no_claim", closeout_summary.get("all_no_claim"), True),
        PLAN_MODULE._expect("source_closeout_all_no_promotion", closeout_summary.get("all_no_promotion"), True),
        PLAN_MODULE._expect("source_closeout_all_no_deployment", closeout_summary.get("all_no_deployment"), True),
    ]
...
def _audit_checks(v14_text: str, status_text: str) -> list[dict[str, Any]]:
    return [
        ...
        PLAN_MODULE._expect("audit_latest_eof_authorizes_closeout_record", PLAN_MODULE._latest_value(v14_text, "next_work_target"), AUTHORIZED_CURRENT_WORK),
        PLAN_MODULE._expect("audit_record_authorized", PLAN_MODULE._latest_value(v14_text, "uncertainty_coverage_evidence_package_closeout_record_authorized"), "True"),
        PLAN_MODULE._expect("audit_no_closeout_recorded_yet", PLAN_MODULE._latest_value(v14_text, "evidence_package_closed_by_this_gate"), "False"),
        ...
        PLAN_MODULE._expect("status_doc_latest_eof_authorizes_closeout_record", PLAN_MODULE._latest_value(status_text, "next_work_target"), AUTHORIZED_CURRENT_WORK),
    ]
...
def _closeout_record(
    *,
    ...
    return {
        "label": label,
        "record_decision": "close_uncertainty_coverage_evidence_package_stage_without_promotion",
...
def _closeout_record_checks(record: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        PLAN_MODULE._expect("record_promotion_recommended_false", record.get("promotion_recommended"), False),
        PLAN_MODULE._expect("record_selector_promotion_false", record.get("selector_promotion_authorized"), False),
        PLAN_MODULE._expect("record_deployment_false", record.get("deployment_authorized"), False),
        PLAN_MODULE._expect("record_safety_claim_false", record.get("safety_benefit_claim_authorized"), False),
        PLAN_MODULE._expect("record_camp_over_dp_false", record.get("camp_over_dp_top1_claim_authorized"), False),
        PLAN_MODULE._expect("record_training_executed_false", record.get("training_executed"), False),
        PLAN_MODULE._expect("record_replay_executed_false", record.get("replay_executed"), False),
        PLAN_MODULE._expect("record_candidate_generation_false", record.get("candidate_generation_executed"), False),
        PLAN_MODULE._expect("record_dp_modified_false", record.get("dp_modified"), False),
        PLAN_MODULE._expect("record_online_selector_changed_false", record.get("online_selector_changed"), False),
        PLAN_MODULE._expect("record_score_expression", record.get("score_expression"), SCORE_EXPRESSION),
    ]
...
def _decision(passed: bool, checks: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    if passed:
        ...
        failure_class = "explicit_uncertainty_coverage_evidence_package_closeout_record_authorization_missing"
        ...
        failure_class = "source_evidence_package_closeout_record_contract_failure"
    ...
    decision: dict[str, Any] = {
        ...
        "uncertainty_coverage_evidence_package_closeout_recorded": passed,
        "uncertainty_coverage_evidence_package_closeout_record_static_review_authorized": passed,
        "evidence_package_closed_by_this_gate": passed,
        "evidence_package_constructed_by_this_gate": False,
        "direct_promotion_recommendation": False,
        "promotion_decision_plan_authorized_next": False,
        "score_expression": SCORE_EXPRESSION,
        "recommendation": "static_review_uncertainty_coverage_evidence_package_closeout_record_only" if passed else "repair_contract_before_rerun",
        "immediate_action": "evidence_package_closeout_record_static_review_only" if passed else "inspect_failed_checks",
    }
    for action in BLOCKED_ACTIONS:
