...
READY_STATUS = "progress_lane_hard_context_separability_bottleneck_diagnosed"
SOURCE_BLOCKED_STATUS = (
    "progress_lane_hard_context_separability_bottleneck_source_not_ready"
)

SOURCE_PRIMARY_GAP = "progress_lane_hard_context_descriptors_do_not_separate_candidates"
SOURCE_NEXT_WORK = "diagnose_progress_lane_hard_context_descriptor_bottleneck_before_retraining"
NEXT_WORK = "predeclare_revised_context_atom_schema_or_reject_context_route"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "context descriptor separability screen. It reuses existing "
            "matched nonformal logs and does not train CAMP, run DP, or "
    ...
    *,
    ...
    final = {
        ...
        "authorized_next_work": (
            ...
            else "fix_context_separability_source_before_bottleneck_diagnosis"
        ),
        **{key: False for key in BLOCKED_ACTIONS},
    }
    return {
        "analysis": {
            "name": "dp_camp_progress_lane_hard_context_separability_bottleneck_v1",
            "label": label,
            "training": False,
            ...
            "math_boundary": (
                "The diagnosis reuses fixed current-tick progress+lane/hard "
                "context descriptors and the rejected offline screen. "
                "Candidate outcomes explain offline error modes only; they "
                "are not runtime selector inputs. If revised descriptors are "
                "later atomized, they must remain fixed coefficients in an "
...
def _diagnosis(
    ...
    if strict_overblocks and high_retain_allows_harmful:
        ...
        primary = "context_descriptor_overlap_requires_revised_atom_schema"
    return {
        "primary_gap": primary,
        ...
        "current_context_route_recommended": False,
        "revised_context_atom_schema_design_only_recommended": True,
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# Progress + Lane/Hard Context Separability Bottleneck Diagnosis",
        "",
