"""Seal the outcome-independent fair-pool adaptation contract v4."""
...
from camp_core.integrations.diffusion_planner_v25_fair_pool_adaptation_contract_v4 import (  # noqa: E402
    FIXED_DP_HEAD,
    V3_CONTRACT_ROOT,
    V3_REVIEW_ROOT,
    adaptation_contract_v4,
...
def freeze(*, output: Path, fixed_dp_repo: Path) -> str:
    ...
    contract = validate_contract_v4(adaptation_contract_v4())
    ...
    try:
        report = {
            "schema_version": (
                "camp_dp_v25_fair_pool_adaptation_contract_artifact_v4"
            ),
            "status": (
            ...
            "superseded_v3_contract_root_sha256": V3_CONTRACT_ROOT,
            "superseded_v3_review_root_sha256": V3_REVIEW_ROOT,
        ...
        root = seal_artifact(
            staging,
            label="V25 fair-pool adaptation contract v4",
        )
