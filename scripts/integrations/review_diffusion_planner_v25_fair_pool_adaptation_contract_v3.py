"""Seal a separate-role literal review of fair-pool contract v3."""
...
from camp_core.integrations.diffusion_planner_v25_fair_pool_adaptation_review_v3 import (  # noqa: E402
...
def review(
    *,
    ...
    verify_complete_seal(source, source_root, label="fair-pool contract v3")
    ...
    literal = review_contract_literal_v3(contract)
    if (
    ...
    try:
        report = {
            ...
            "reviewer_local_exact_source_scene_and_preflight_oracle": True,
            "reviewer_local_phase_endpoint_and_decision_oracle": True,
            "caller_status_or_within_boolean_used": False,
        ...
        root = seal_artifact(
            staging,
            label="V25 fair-pool adaptation contract review v3",
        )
