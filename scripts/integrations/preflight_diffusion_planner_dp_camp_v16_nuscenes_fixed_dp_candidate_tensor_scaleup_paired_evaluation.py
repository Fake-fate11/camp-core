#!/usr/bin/env python3
"""Preflight the v16 fixed-DP scale-up paired-evaluation gate."""
...
def _load_source_review_module():
    ...
    spec = importlib.util.spec_from_file_location("v16_scaleup_paired_eval_plan_static_review", path)
...
TRAINING_SCHEMA_VERSION = "dp_camp_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution_v1"
TRAINING_READY_STATUS = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution_passed"
TRAINING_JSON_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution.json"
TRAINING_MD_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_training_execution.md"
READY_STATUS = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight_ready"
REJECT_STATUS = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight_rejected"
AUTHORIZED_NEXT_WORK = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_execution_only"
SCHEMA_VERSION = "dp_camp_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight_v1"
PREFLIGHT_JSON_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight.json"
PREFLIGHT_MD_NAME = "v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight.md"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight",
        action="store_true",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        ...
        enabled=args.enable_v16_nuscenes_fixed_dp_candidate_tensor_scaleup_paired_evaluation_preflight,
    )
...
def build_report(
    *,
    ...
    checks = [
        ...
        _expect("primary_eval_rows_3737", record_summary["primary_eval_rows"], 3737),
        _expect("plan_primary_eval_rows_3737", plan_body.get("paired_rows_by_split", {}).get("primary_eval_total"), 3737),
        _expect("train_reporting_only_rows_6263", record_summary["counts"]["train"], PLAN_MODULE.EXPECTED_COUNTS["train"]),
        _expect("calibration_rows_2156", record_summary["counts"]["calibration"], PLAN_MODULE.EXPECTED_COUNTS["calibration"]),
        _expect("holdout_rows_1581", record_summary["counts"]["holdout"], PLAN_MODULE.EXPECTED_COUNTS["holdout"]),
    ...
    return _stable(
        {
            ...
            "scaleup_paired_evaluation_preflight": preflight,
            "checks": checks,
            "final_decision": {
                "passed": passed,
                "status": READY_STATUS if passed else REJECT_STATUS,
...
def _preflight_summary(
    *,
    ...
    return {
        ...
        "scaleup_evidence_only": static_body.get("scaleup_evidence_only"),
...
def _render_markdown(report: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            "# V16 nuScenes Fixed-DP Scale-Up Paired-Evaluation Preflight",
            "",
