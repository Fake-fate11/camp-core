#!/usr/bin/env python3
"""Static-review the v15 matrix execution preflight artifact."""
...
def _load_preflight_module():
    path = Path(__file__).resolve().with_name(
        "preflight_diffusion_planner_dp_camp_v15_broader_nonformal_evidence_expansion_matrix_execution.py"
    )
    spec = importlib.util.spec_from_file_location("v15_matrix_execution_preflight", path)
...
SCHEMA_VERSION = "dp_camp_v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review_v1"
AUTHORIZED_CURRENT_WORK = PREFLIGHT_MODULE.AUTHORIZED_NEXT_WORK
READY_STATUS = "v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review_passed"
REJECT_STATUS = "v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review_rejected"
AUTHORIZED_NEXT_WORK = "v15_broader_nonformal_evidence_expansion_matrix_execution_only"
REVIEW_JSON_NAME = "v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review.json"
REVIEW_MD_NAME = "v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review.md"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--enable_v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review",
        action="store_true",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_report(
        ...
        enabled=args.enable_v15_broader_nonformal_evidence_expansion_matrix_execution_preflight_static_review,
    )
...
def build_report(
    *,
    ...
    checks = [
        ...
        _expect("source_matrix_preflight_executed", decision.get("matrix_execution_preflight_executed"), True),
        ...
        _expect("preflight_combination_count", preflight["matrix_execution_preflight"].get("combination_count"), 576),
...
def _render_markdown(report: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            "# V15 Matrix Execution Preflight Static Review",
            "",
