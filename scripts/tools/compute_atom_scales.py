...
def main():
    ...
    parser.add_argument("--num_candidates", type=int, default=12, help="Number of Trajectron++ candidates per sampled scene")
    parser.add_argument("--num_workers", type=int, default=0, help="Number of data loader workers")
    parser.add_argument(
        "--rebuild_trajdata_cache",
        action="store_true",
        help="force trajdata to rebuild scene metadata/agent cache before computing scales",
    )
    ...
    print(f"[Scale] num_candidates={args.num_candidates}", flush=True)
    ...
    for batch in loader:
        ...
        try:
             # Generate Candidates.
             cands_batch = get_candidates(adapter, batch, k=args.num_candidates) # List of [K, H, 2]
